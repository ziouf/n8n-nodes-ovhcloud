...
- **API Spec**: https://eu.api.ovh.com/v1/metrics.json
- **Base Path**: /metrics
...
├── list.operation.ts      # GET /metrics
├── get.operation.ts       # GET /metrics/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getMetricsServices'`)
