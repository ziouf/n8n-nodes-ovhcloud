...
export class OvhCloudPack extends BaseNode implements INodeType {
		...
		return executeTemplate.call(this, execute, {
			perItemConcurrency: {
				classify: (ctx, itemIndex) =>
					classifyOperation(
						String(ctx.getNodeParameter('packOperation', itemIndex, { extractValue: true })),
					),
			},
			errorContext: { resource: 'pack', operationParam: 'packOperation' },
		});
	}
}
