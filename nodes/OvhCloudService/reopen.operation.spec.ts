...
import { description, execute } from './reopen.operation';
...
describe('reopen.operation', () => {
	...
	describe('execute', () => {
		...
		it('should reopen a suspended service', async () => {
			...
			expect(mockClient.httpPost).toHaveBeenCalledWith('/service/123456/reopen', {
				body: {},
			});
		});
	});
