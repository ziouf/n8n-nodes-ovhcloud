...
import { description, execute } from './createRenew.operation';
...
describe('createRenew.operation', () => {
	...
	describe('execute', () => {
		...
		it('should create a renew order for a service', async () => {
			const mockData = { id: 123456, status: 'RENEWED' };
			...
			expect(mockClient.httpPost).toHaveBeenCalledWith('/service/123456/renew', {
				body: {},
			});
		});
	});
