...
- **API Spec**: https://eu.api.ovh.com/v1/service.json
- **Base Path**: /service
...
├── list.operation.ts      # GET /service
├── get.operation.ts       # GET /service/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getServiceServices'`)
