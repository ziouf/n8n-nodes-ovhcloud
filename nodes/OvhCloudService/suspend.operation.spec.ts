...
import { description, execute } from './suspend.operation';
...
describe('suspend.operation', () => {
	...
	describe('execute', () => {
		...
		it('should suspend a service', async () => {
			const mockData = { id: 123456, status: 'SUSPENDED' };
			...
			expect(mockClient.httpPost).toHaveBeenCalledWith('/service/123456/suspend', {
				body: {},
			});
		});
	});
