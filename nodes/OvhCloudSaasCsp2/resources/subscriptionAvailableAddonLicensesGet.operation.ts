...
/**
 * List orderable add-on licenses for an Office subscription.
 *
 * HTTP method: GET
 * Endpoint: /saas/csp2/{serviceName}/subscription/{id}/availableAddonLicenses
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(
		`/saas/csp2/${encodeURIComponent(serviceName)}/subscription/${encodeURIComponent(id)}/availableAddonLicenses`,
	)) as unknown[];
