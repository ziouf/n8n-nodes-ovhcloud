...
describe('get.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via GET', async () => {
			const mockData = { serviceName: 'csp2-12345', status: 'ok' };
			...
			expect(client.httpGet).toHaveBeenCalledWith('/saas/csp2/csp2-12345');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/saas/csp2/csp%202');
		});
	});
});
