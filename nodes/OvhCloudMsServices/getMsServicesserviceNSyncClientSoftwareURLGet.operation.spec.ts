...
import { description, execute } from './getMsServicesserviceNSyncClientSoftwareURLGet.operation';
...
describe('getMsServicesserviceNSyncClientSoftwareURLGet operation', () => {
