# MS Services Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v1/msServices.json
- **Base Path**: /msServices
...
├── list.operation.ts      # GET /msServices
├── get.operation.ts       # GET /msServices/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getMsServicesServices'`)
