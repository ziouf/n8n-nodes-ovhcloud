...
import { description, execute } from './postMsServicesserviceNSharepointRestoreAdminRightsPost.operation';
...
describe('postMsServicesserviceNSharepointRestoreAdminRightsPost operation', () => {
