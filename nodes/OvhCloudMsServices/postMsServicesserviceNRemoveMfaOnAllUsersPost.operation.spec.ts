...
import { description, execute } from './postMsServicesserviceNRemoveMfaOnAllUsersPost.operation';
...
describe('postMsServicesserviceNRemoveMfaOnAllUsersPost operation', () => {
