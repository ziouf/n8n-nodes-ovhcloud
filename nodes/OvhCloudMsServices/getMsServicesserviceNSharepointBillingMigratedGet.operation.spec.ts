...
import { description, execute } from './getMsServicesserviceNSharepointBillingMigratedGet.operation';
...
describe('getMsServicesserviceNSharepointBillingMigratedGet operation', () => {
