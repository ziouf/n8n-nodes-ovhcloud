...
import { description, execute } from './postMsServicesserviceNCreateMfaOnAllUsersPost.operation';
...
describe('postMsServicesserviceNCreateMfaOnAllUsersPost operation', () => {
