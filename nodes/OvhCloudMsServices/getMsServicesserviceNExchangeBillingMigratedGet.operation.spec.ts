...
import { description, execute } from './getMsServicesserviceNExchangeBillingMigratedGet.operation';
...
describe('getMsServicesserviceNExchangeBillingMigratedGet operation', () => {
