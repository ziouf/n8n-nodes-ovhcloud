...
import { description, execute } from './postMsServicesserviceNSyncClientSoftwareURLPost.operation';
...
describe('postMsServicesserviceNSyncClientSoftwareURLPost operation', () => {
