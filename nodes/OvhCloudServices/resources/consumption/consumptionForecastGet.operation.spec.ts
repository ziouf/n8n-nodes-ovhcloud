...
import { description, execute } from './consumptionForecastGet.operation';
...
describe('consumptionForecastGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/consumption/forecast');
