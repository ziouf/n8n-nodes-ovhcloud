 ...
 *
 * HTTP method: GET
 * Endpoint: /services/{serviceName}/consumption/history
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/services/${encodeURIComponent(serviceName)}/consumption/history`, qs)) as IDataObject;
