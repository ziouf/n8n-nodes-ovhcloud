...
import { description, execute } from './consumptionHistoryIdGet.operation';
...
describe('consumptionHistoryIdGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/consumption/history/42');
