...
import { description, execute } from './technicalDetailsGet.operation';
...
describe('technicalDetailsGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/technicalDetails');
