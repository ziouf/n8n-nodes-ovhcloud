...
import { description, execute } from './engagementGet.operation';
...
describe('engagementGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/billing/engagement');
