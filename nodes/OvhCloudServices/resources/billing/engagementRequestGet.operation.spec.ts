...
import { description, execute } from './engagementRequestGet.operation';
...
describe('engagementRequestGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/billing/engagement/request');
