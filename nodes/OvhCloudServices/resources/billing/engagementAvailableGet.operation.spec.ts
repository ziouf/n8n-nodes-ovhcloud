...
import { description, execute } from './engagementAvailableGet.operation';
...
describe('engagementAvailableGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/billing/engagement/available');
