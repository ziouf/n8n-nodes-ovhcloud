...
import { description, execute } from './savingsPlansContractsGet.operation';
...
describe('savingsPlansContractsGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/savingsPlans/contracts');
