...
import { description, execute } from './savingsPlansSubscribedGet.operation';
...
describe('savingsPlansSubscribedGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/savingsPlans/subscribed');
