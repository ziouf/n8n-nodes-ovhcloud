...
import { description, execute } from './upgradePlanCodeSimulatePost.operation';
...
describe('upgradePlanCodeSimulatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/services/test-service-id/upgrade/plan-code-1/simulate', { duration: 'P1M', pricingMode: 'default', quantity: 1, autoPayWithPreferredPaymentMethod: true });
