...
import { description, execute } from './detachPlanCodeGet.operation';
...
describe('detachPlanCodeGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/detach/plan-code-1');
