...
/**
 * Executes the Post DetachSimulate operation.
 *
 * HTTP method: POST
 * Endpoint: /services/{serviceName}/detach/{planCode}/simulate
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/services/${encodeURIComponent(serviceName)}/detach/${encodeURIComponent(planCode)}/simulate`, body)) as IDataObject;
