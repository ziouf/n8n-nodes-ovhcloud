...
import { description, execute } from './detachPlanCodeSimulatePost.operation';
...
describe('detachPlanCodeSimulatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/services/test-service-id/detach/plan-code-1/simulate', { duration: 'P1M', pricingMode: 'default', quantity: 1, autoPayWithPreferredPaymentMethod: true });
