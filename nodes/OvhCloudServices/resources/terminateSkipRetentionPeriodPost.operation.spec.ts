...
import { description, execute } from './terminateSkipRetentionPeriodPost.operation';
...
describe('terminateSkipRetentionPeriodPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/services/test-service-id/terminate/skipRetentionPeriod', {});
