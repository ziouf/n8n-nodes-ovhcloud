...
import { description, execute } from './renewPeriodCapacitiesGet.operation';
...
describe('renewPeriodCapacitiesGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/services/test-service-id/renewPeriodCapacities');
