...
- **API Spec**: https://eu.api.ovh.com/v1/services.json
- **Base Path**: /services
...
├── list.operation.ts      # GET /services
├── get.operation.ts       # GET /services/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getServicesServices'`)
