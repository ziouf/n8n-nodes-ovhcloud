...
describe('changeContactPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/changeContact', {  contactAdmin: 'test-contactAdmin' ,  contactBilling: 'test-contactBilling' ,  contactTech: 'test-contactTech'  });
