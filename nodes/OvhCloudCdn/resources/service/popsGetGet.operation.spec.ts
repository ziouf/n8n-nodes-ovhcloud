...
import { description, execute } from './popsGetGet.operation';
...
describe('popsGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/cdn/dedicated/pops/test-name');
