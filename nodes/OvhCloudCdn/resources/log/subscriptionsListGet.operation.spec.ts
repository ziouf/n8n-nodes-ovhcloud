...
import { description, execute } from './subscriptionsListGet.operation';
...
describe('subscriptionsListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/log/subscription', { kind: 'test-kind' });
