...
/**
 * @brief Update CDN Service Infos operation
 *
 * Updates service information for a specific CDN Dedicated service.
 *
 * HTTP method: PUT
...
/**
 * Executes the Update CDN Service Infos operation.
 *
