...
import { description, execute } from './sslTaskGetGet.operation';
...
describe('sslTaskGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/ssl/tasks/42');
