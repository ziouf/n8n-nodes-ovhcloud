...
import { description, execute } from './sslGetGet.operation';
...
describe('sslGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/ssl');
