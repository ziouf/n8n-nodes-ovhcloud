...
import { description, execute } from './sslUpdatePost.operation';
...
describe('sslUpdatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/ssl/update', {  certificate: 'test-certificate' ,  chain: 'test-chain' ,  key: 'test-key'  });
