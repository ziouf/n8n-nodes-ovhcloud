...
import { description, execute } from './backendDeleteDelete.operation';
...
describe('backendDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains/test-domain/backends/test-ip');
