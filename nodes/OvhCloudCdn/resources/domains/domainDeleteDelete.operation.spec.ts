...
import { description, execute } from './domainDeleteDelete.operation';
...
describe('domainDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains/test-domain');
