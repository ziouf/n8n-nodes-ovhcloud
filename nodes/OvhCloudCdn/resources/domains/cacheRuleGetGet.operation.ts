...
/**
 * Executes the Get GetCacheRule operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/cdn/dedicated/${encodeURIComponent(serviceName)}/domains/${encodeURIComponent(domain)}/cacheRules/${encodeURIComponent(cacheRuleId)}`)) as IDataObject;
