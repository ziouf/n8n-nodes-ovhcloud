...
import { description, execute } from './domainFlushPost.operation';
...
describe('domainFlushPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains/test-domain/flush', undefined);
