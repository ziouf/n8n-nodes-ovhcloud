...
import { description, execute } from './cacheRuleDeleteDelete.operation';
...
describe('cacheRuleDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains/test-domain/cacheRules/42');
