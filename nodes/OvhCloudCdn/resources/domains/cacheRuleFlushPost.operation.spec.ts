...
import { description, execute } from './cacheRuleFlushPost.operation';
...
describe('cacheRuleFlushPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains/test-domain/cacheRules/42/flush', undefined);
