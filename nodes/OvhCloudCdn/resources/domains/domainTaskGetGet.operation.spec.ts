...
import { description, execute } from './domainTaskGetGet.operation';
...
describe('domainTaskGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains/test-domain/tasks/42');
