...
import { description, execute } from './domainGetGet.operation';
...
describe('domainGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains/test-domain');
