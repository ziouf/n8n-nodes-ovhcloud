...
import { description, execute } from './domainLogsPost.operation';
...
describe('domainLogsPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains/test-domain/logs', undefined);
