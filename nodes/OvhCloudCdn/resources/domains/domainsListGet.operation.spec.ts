...
import { description, execute } from './domainsListGet.operation';
...
describe('domainsListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains');
