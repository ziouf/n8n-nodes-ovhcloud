...
import { description, execute } from './domainsCreatePost.operation';
...
describe('domainsCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cdn/dedicated/test-serviceName/domains', {  domain: 'test-domain'  });
