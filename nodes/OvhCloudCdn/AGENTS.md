...
- **API Spec**: https://eu.api.ovh.com/v1/cdn/dedicated.json
- **Base Path**: /cdn/dedicated
...
├── list.operation.ts      # GET /cdn/dedicated
├── get.operation.ts       # GET /cdn/dedicated/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getCdnServices'`)
