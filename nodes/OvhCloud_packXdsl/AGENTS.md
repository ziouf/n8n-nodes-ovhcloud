...
- **API Spec**: https://eu.api.ovh.com/v1/pack/xdsl.json
- **Base Path**: /pack/xdsl
...
├── list.operation.ts      # GET /pack/xdsl
├── get.operation.ts       # GET /pack/xdsl/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getPackXdslServices'`)
