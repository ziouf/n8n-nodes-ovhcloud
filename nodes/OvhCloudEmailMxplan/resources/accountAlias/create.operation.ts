...
/**
 * Create an alias for an account in an Email Mxplan service.
 *
 * HTTP method: POST
...
/**
 * Executes the Create Account Alias operation.
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/email/mxplan/${service}/account/${email}/alias`, {
		body,
	})) as IDataObject;
	return [{ json: data }];
}
