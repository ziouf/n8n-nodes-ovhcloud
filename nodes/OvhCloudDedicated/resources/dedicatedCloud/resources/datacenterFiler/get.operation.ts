...
/**
 * Description for Get Datacenter Filer operation.
 */
...
/**
 * Executes the Get Datacenter Filer operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const filerId = this.getNodeParameter('filerId', 0) as string;
