...
/**
 * @brief Get BIOS Settings operation for Dedicated Server
 *
 * Retrieves BIOS settings for a dedicated server.
 *
 * HTTP method: GET
 * Endpoint: /dedicated/server/{serviceName}/biosSettings
 */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicated/server/${serviceName}/biosSettings`)) as IDataObject;
	return [{ json: data }];
}
