...
/**
 * @brief List Virtual MACs operation for Dedicated Server
 *
 * Lists all virtual MACs for a dedicated server.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicated/server/${serviceName}/virtualMac`)) as IDataObject[];
