...
This node provides **110 operations** covering the `/domain` API v1 endpoints, grouped by resource family (root, service and zone). Each operation has a dedicated unit test.
