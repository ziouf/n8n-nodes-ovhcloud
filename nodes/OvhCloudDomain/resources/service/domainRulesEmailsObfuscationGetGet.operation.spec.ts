...
import { description, execute } from './domainRulesEmailsObfuscationGetGet.operation';
...
describe('domainRulesEmailsObfuscationGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/rules/emailsObfuscation');
