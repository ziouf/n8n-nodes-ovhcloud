...
import { description, execute } from './domainAuthInfoGetGet.operation';
...
describe('domainAuthInfoGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/authInfo');
