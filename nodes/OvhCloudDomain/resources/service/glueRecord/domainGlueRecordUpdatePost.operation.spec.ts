...
import { description, execute } from './domainGlueRecordUpdatePost.operation';
...
describe('domainGlueRecordUpdatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/domain/test-serviceName/glueRecord/test-host/update', expect.anything());
