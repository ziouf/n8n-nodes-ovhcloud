...
import { description, execute } from './domainGlueRecordGetGet.operation';
...
describe('domainGlueRecordGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/glueRecord/test-host');
