...
import { description, execute } from './domainGlueRecordListGet.operation';
...
describe('domainGlueRecordListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/glueRecord', expect.anything());
