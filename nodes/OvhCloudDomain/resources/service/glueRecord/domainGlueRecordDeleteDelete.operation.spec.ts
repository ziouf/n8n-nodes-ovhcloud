...
import { description, execute } from './domainGlueRecordDeleteDelete.operation';
...
describe('domainGlueRecordDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/domain/test-serviceName/glueRecord/test-host');
