...
import { description, execute } from './domainUkOutgoingTransferPost.operation';
...
describe('domainUkOutgoingTransferPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/domain/test-serviceName/ukOutgoingTransfer', expect.anything());
