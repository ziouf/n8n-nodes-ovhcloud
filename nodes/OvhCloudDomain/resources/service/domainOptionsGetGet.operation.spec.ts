...
import { description, execute } from './domainOptionsGetGet.operation';
...
describe('domainOptionsGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/options');
