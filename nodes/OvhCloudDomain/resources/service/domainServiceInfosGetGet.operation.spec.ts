...
import { description, execute } from './domainServiceInfosGetGet.operation';
...
describe('domainServiceInfosGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/serviceInfos');
