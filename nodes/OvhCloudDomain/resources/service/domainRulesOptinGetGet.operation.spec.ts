...
import { description, execute } from './domainRulesOptinGetGet.operation';
...
describe('domainRulesOptinGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/rules/optin');
