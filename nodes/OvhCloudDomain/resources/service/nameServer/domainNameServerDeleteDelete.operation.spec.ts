...
import { description, execute } from './domainNameServerDeleteDelete.operation';
...
describe('domainNameServerDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/domain/test-serviceName/nameServer/test-id');
