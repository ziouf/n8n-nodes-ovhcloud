...
import { description, execute } from './domainNameServerGetGet.operation';
...
describe('domainNameServerGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/nameServer/test-id');
