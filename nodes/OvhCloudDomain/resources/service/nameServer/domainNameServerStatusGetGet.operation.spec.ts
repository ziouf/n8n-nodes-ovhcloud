...
import { description, execute } from './domainNameServerStatusGetGet.operation';
...
describe('domainNameServerStatusGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/nameServer/test-id/status');
