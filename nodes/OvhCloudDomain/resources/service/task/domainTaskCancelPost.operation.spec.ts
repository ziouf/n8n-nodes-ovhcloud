...
import { description, execute } from './domainTaskCancelPost.operation';
...
describe('domainTaskCancelPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/domain/test-serviceName/task/test-id/cancel');
