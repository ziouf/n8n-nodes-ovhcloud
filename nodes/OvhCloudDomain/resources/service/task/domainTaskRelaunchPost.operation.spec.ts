...
import { description, execute } from './domainTaskRelaunchPost.operation';
...
describe('domainTaskRelaunchPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/domain/test-serviceName/task/test-id/relaunch');
