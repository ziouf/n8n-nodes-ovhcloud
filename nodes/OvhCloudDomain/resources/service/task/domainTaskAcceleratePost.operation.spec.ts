...
import { description, execute } from './domainTaskAcceleratePost.operation';
...
describe('domainTaskAcceleratePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/domain/test-serviceName/task/test-id/accelerate');
