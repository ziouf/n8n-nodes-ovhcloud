...
import { description, execute } from './domainDsRecordCreatePost.operation';
...
describe('domainDsRecordCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/domain/test-serviceName/dsRecord', expect.anything());
