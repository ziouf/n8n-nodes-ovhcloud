...
import { description, execute } from './domainDsRecordGetGet.operation';
...
describe('domainDsRecordGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/dsRecord/test-id');
