...
import { description, execute } from './domainUkRegistrarsListGet.operation';
...
describe('domainUkRegistrarsListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/ukRegistrars');
