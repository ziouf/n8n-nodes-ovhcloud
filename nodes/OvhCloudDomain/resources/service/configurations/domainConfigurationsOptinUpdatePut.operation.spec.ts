...
import { description, execute } from './domainConfigurationsOptinUpdatePut.operation';
...
describe('domainConfigurationsOptinUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/domain/test-serviceName/configurations/optin', expect.anything());
