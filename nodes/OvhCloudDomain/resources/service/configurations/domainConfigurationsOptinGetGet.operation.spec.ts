...
import { description, execute } from './domainConfigurationsOptinGetGet.operation';
...
describe('domainConfigurationsOptinGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/test-serviceName/configurations/optin');
