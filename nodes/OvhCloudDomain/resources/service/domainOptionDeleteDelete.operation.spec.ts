...
import { description, execute } from './domainOptionDeleteDelete.operation';
...
describe('domainOptionDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				switch (param) {
					case 'option': return 'test-option';
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/domain/test-serviceName/option/test-option');
