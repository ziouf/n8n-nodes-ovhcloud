...
import { description, execute } from './domainContactCreatePost.operation';
...
describe('domainContactCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/domain/contact', expect.anything());
