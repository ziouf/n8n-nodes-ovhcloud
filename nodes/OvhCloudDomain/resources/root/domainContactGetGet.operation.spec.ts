...
import { description, execute } from './domainContactGetGet.operation';
...
describe('domainContactGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/contact/test-contactId');
