...
import { description, execute } from './domainExtensionsGetGet.operation';
...
describe('domainExtensionsGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/domain/extensions/test-name');
