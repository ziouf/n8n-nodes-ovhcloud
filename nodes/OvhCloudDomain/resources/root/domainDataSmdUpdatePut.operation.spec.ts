...
import { description, execute } from './domainDataSmdUpdatePut.operation';
...
describe('domainDataSmdUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/domain/data/smd/test-smdId', expect.anything());
