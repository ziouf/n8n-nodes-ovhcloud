...
- **API Spec**: https://eu.api.ovh.com/v1/domain.json
- **Base Path**: /domain
...
├── list.operation.ts      # GET /domain
├── get.operation.ts       # GET /domain/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getDomainServices'`)
