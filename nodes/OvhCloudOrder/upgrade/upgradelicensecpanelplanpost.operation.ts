...
/**
 * Executes the Upgrade Licensecpanel operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/licensecPanel/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/licensecPanel/{serviceName}/{planCode}`, body)) as IDataObject;
