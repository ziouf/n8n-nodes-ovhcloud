...
/**
 * Executes the Upgrade Ceph AAS operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/cephaas/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/cephaas/{serviceName}/{planCode}`, body)) as IDataObject;
