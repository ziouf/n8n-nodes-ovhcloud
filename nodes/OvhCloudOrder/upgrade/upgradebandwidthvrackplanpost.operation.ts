...
/**
 * Executes the Upgrade Bandwidth Vrack operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/bandwidthVrack/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/bandwidthVrack/{serviceName}/{planCode}`, body)) as IDataObject;
