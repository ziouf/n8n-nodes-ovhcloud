...
/**
 * Executes the Upgrade VPS operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/vps/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/vps/{serviceName}/{planCode}`, body)) as IDataObject;
