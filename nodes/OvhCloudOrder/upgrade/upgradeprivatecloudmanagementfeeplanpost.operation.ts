...
/**
 * Executes the Upgrade Private Cloud Management Fee operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/privateCloudManagementFee/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/privateCloudManagementFee/{serviceName}/{planCode}`, body)) as IDataObject;
