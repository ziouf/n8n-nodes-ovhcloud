...
/**
 * Executes the Upgrade Webhosting operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/webHosting/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/webHosting/{serviceName}/{planCode}`, body)) as IDataObject;
