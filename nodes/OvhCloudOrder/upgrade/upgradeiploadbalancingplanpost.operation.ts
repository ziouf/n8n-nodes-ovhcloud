...
/**
 * Executes the Upgrade IP Load Balancing operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/ipLoadbalancing/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/ipLoadbalancing/{serviceName}/{planCode}`, body)) as IDataObject;
