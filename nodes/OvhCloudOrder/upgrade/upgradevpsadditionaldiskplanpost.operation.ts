...
/**
 * Executes the Upgrade Vpsadditionaldisk operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/vpsAdditionalDisk/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/vpsAdditionalDisk/{serviceName}/{planCode}`, body)) as IDataObject;
