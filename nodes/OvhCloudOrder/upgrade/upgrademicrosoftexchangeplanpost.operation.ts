...
/**
 * Executes the Upgrade Microsoftexchange operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/microsoftExchange/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/microsoftExchange/{serviceName}/{planCode}`, body)) as IDataObject;
