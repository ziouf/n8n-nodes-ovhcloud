...
/**
 * Executes the Upgrade Emaildomain operation.
 *
 * HTTP method: POST
 * Endpoint: /order/upgrade/emailDomain/{serviceName}/{planCode}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/upgrade/emailDomain/{serviceName}/{planCode}`, body)) as IDataObject;
