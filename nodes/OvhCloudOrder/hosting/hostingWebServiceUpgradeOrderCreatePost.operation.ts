...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const body = {offer: offer, startTime: startTime, waiveRetractationPeriod: waiveRetractationPeriod};

	const data = (await client.httpPost(`/order/hosting/web/${serviceName}/upgrade/${duration}`, body)) as IDataObject;
