...
import { description, execute } from './telephonyLinesUpdateSimultaneousChannelsCreatePost.operation';
...
describe('telephonyLinesUpdateSimultaneousChannelsCreatePost operation', () => {
