...
import { description, execute } from './telephonyTrunksAddSimultaneousLinesCreatePost.operation';
...
describe('telephonyTrunksAddSimultaneousLinesCreatePost operation', () => {
