...
import { description, execute } from './telephonyTrunksUpdateSimultaneousChannelsListGet.operation';
...
describe('telephonyTrunksUpdateSimultaneousChannelsListGet operation', () => {
