...
import { description, execute } from './telephonyTrunksUpdateSimultaneousChannelsCreatePost.operation';
...
describe('telephonyTrunksUpdateSimultaneousChannelsCreatePost operation', () => {
