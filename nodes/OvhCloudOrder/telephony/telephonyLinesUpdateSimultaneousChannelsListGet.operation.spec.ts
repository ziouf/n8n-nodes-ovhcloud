...
import { description, execute } from './telephonyLinesUpdateSimultaneousChannelsListGet.operation';
...
describe('telephonyLinesUpdateSimultaneousChannelsListGet operation', () => {
