...
import { description, execute } from './cartServiceOptionVmwareCloudDirectorCreatePost.operation';
...
describe('cartServiceOptionVmwareCloudDirectorCreatePost operation', () => {
