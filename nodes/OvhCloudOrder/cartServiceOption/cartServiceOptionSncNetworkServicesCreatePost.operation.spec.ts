...
import { description, execute } from './cartServiceOptionSncNetworkServicesCreatePost.operation';
...
describe('cartServiceOptionSncNetworkServicesCreatePost operation', () => {
