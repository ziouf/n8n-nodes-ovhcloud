...
import { description, execute } from './cartServiceOptionPrivateCloudResellerEnterpriseCreatePost.operation';
...
describe('cartServiceOptionPrivateCloudResellerEnterpriseCreatePost operation', () => {
