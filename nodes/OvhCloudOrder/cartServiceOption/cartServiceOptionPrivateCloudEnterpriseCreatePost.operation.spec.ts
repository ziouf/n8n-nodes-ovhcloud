...
import { description, execute } from './cartServiceOptionPrivateCloudEnterpriseCreatePost.operation';
...
describe('cartServiceOptionPrivateCloudEnterpriseCreatePost operation', () => {
