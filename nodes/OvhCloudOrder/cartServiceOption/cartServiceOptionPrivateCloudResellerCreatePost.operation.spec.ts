...
import { description, execute } from './cartServiceOptionPrivateCloudResellerCreatePost.operation';
...
describe('cartServiceOptionPrivateCloudResellerCreatePost operation', () => {
