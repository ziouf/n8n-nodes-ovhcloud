...
/**
 * Executes the Add Ssl Gateway option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/sslGateway/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/sslGateway/options`, body)) as IDataObject;
