...
/**
 * Executes the Create Ssl Gateway operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/sslGateway
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/sslGateway`, body)) as IDataObject;
