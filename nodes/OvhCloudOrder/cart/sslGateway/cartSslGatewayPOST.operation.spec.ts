...
import { description, execute } from './cartSslGatewayPOST.operation';
...
describe('cartSslGatewayPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/sslGateway', {
