...
import { description, execute } from './cartPaasmonPOST.operation';
...
describe('cartPaasmonPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/paasmon', {
