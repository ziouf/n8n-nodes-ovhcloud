...
import { description, execute } from './cartLicenseWindowsPOST.operation';
...
describe('cartLicenseWindowsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/licenseWindows', {
