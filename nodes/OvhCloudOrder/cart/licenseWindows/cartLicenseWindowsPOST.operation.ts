...
/**
 * Executes the Create License Windows operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/licenseWindows
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/licenseWindows`, body)) as IDataObject;
