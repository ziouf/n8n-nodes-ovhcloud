...
import { description, execute } from './cartSmsPOST.operation';
...
describe('cartSmsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/sms', {
