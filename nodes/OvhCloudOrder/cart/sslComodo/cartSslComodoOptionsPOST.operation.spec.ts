...
import { description, execute } from './cartSslComodoOptionsPOST.operation';
...
describe('cartSslComodoOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/sslComodo/options', {
