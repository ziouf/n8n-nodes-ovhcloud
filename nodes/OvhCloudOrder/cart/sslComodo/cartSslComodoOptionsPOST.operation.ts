...
/**
 * Executes the Add Ssl Comodo option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/sslComodo/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/sslComodo/options`, body)) as IDataObject;
