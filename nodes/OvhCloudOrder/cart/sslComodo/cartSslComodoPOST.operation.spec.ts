...
import { description, execute } from './cartSslComodoPOST.operation';
...
describe('cartSslComodoPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/sslComodo', {
