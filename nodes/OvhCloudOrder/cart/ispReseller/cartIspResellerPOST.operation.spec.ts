...
import { description, execute } from './cartIspResellerPOST.operation';
...
describe('cartIspResellerPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/ispReseller', {
