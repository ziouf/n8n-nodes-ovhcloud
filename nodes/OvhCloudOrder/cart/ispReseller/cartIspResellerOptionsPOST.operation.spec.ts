...
import { description, execute } from './cartIspResellerOptionsPOST.operation';
...
describe('cartIspResellerOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/ispReseller/options', {
