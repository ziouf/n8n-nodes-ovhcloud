...
/**
 * Executes the Add Isp Reseller option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/ispReseller/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/ispReseller/options`, body)) as IDataObject;
