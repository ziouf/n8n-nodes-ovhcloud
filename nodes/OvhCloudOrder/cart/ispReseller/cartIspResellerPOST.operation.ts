...
/**
 * Executes the Create Isp Reseller operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/ispReseller
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/ispReseller`, body)) as IDataObject;
