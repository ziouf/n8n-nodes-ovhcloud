...
/**
 * Executes the Add Discover option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/discover/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/discover/options`, body)) as IDataObject;
