...
import { description, execute } from './cartDiscoverOptionsPOST.operation';
...
describe('cartDiscoverOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/discover/options', {
