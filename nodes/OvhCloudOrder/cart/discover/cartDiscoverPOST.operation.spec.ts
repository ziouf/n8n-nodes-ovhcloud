...
import { description, execute } from './cartDiscoverPOST.operation';
...
describe('cartDiscoverPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/discover', {
