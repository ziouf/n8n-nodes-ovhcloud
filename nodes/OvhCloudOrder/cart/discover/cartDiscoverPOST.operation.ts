...
/**
 * Executes the Create Discover operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/discover
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/discover`, body)) as IDataObject;
