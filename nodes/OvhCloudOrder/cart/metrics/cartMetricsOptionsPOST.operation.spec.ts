...
import { description, execute } from './cartMetricsOptionsPOST.operation';
...
describe('cartMetricsOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/metrics/options', {
