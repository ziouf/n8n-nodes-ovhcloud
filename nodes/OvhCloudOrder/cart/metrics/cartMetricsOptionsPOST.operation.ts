...
/**
 * Executes the Add Metrics option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/metrics/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/metrics/options`, body)) as IDataObject;
