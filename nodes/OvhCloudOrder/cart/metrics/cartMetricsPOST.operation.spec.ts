...
import { description, execute } from './cartMetricsPOST.operation';
...
describe('cartMetricsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/metrics', {
