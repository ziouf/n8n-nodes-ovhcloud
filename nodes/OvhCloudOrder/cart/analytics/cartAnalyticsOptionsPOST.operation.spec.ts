...
import { description, execute } from './cartAnalyticsOptionsPOST.operation';
...
describe('cartAnalyticsOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/analytics/options', {
