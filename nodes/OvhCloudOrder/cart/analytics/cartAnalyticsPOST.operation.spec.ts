...
import { description, execute } from './cartAnalyticsPOST.operation';
...
describe('cartAnalyticsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/analytics', {
