...
/**
 * Executes the Create Analytics operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/analytics
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/analytics`, body)) as IDataObject;
