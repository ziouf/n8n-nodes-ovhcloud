...
import { description, execute } from './cartWebHostingOptionsPOST.operation';
...
describe('cartWebHostingOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/webHosting/options', {
