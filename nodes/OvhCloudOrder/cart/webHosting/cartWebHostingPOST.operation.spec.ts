...
import { description, execute } from './cartWebHostingPOST.operation';
...
describe('cartWebHostingPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/webHosting', {
