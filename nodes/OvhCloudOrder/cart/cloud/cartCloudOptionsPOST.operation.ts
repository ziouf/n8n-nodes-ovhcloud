...
/**
 * Executes the Add Cloud option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/cloud/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/cloud/options`, body)) as IDataObject;
