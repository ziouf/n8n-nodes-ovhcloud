...
import { description, execute } from './cartCloudPOST.operation';
...
describe('cartCloudPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/cloud', {
