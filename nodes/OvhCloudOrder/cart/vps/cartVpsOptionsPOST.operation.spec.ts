...
import { description, execute } from './cartVpsOptionsPOST.operation';
...
describe('cartVpsOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/vps/options', {
