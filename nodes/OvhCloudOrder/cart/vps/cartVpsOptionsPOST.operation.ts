...
/**
 * Executes the Add Vps option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/vps/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/vps/options`, body)) as IDataObject;
