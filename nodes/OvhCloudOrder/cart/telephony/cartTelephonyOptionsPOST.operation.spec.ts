...
import { description, execute } from './cartTelephonyOptionsPOST.operation';
...
describe('cartTelephonyOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/telephony/options', {
