...
import { description, execute } from './cartTelephonyPOST.operation';
...
describe('cartTelephonyPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/telephony', {
