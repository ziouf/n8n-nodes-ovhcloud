...
/**
 * Executes the Add Telephony option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/telephony/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/telephony/options`, body)) as IDataObject;
