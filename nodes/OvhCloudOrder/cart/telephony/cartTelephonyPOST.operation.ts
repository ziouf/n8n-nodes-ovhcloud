...
/**
 * Executes the Create Telephony operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/telephony
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/telephony`, body)) as IDataObject;
