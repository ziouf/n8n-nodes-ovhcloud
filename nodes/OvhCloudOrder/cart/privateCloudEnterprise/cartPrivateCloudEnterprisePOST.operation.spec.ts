...
import { description, execute } from './cartPrivateCloudEnterprisePOST.operation';
...
describe('cartPrivateCloudEnterprisePOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudEnterprise', {
