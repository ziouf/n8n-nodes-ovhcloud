...
import { description, execute } from './cartPrivateCloudEnterpriseOptionsPOST.operation';
...
describe('cartPrivateCloudEnterpriseOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudEnterprise/options', {
