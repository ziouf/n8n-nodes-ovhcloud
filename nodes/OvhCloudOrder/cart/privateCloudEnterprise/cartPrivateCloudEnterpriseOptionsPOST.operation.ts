...
/**
 * Executes the Add Private Cloud Enterprise option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/privateCloudEnterprise/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/privateCloudEnterprise/options`, body)) as IDataObject;
