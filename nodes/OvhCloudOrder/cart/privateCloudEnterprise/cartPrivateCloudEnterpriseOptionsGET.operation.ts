...
/**
 * Executes the Get Private Cloud Enterprise options operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/order/cart/${cartId}/privateCloudEnterprise/options`, qs)) as IDataObject;
