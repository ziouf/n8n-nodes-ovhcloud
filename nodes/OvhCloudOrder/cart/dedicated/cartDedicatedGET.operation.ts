...
/**
 * Executes the List Dedicated offers operation.
 *
 * HTTP method: GET
 * Endpoint: /order/cart/{cartId}/dedicated
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/order/cart/${cartId}/dedicated`, qs)) as IDataObject;
