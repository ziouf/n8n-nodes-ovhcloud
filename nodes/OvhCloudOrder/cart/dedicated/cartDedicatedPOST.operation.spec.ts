...
import { description, execute } from './cartDedicatedPOST.operation';
...
describe('cartDedicatedPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicated', {
