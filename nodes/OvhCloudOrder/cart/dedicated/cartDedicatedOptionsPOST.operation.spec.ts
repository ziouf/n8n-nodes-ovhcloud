...
import { description, execute } from './cartDedicatedOptionsPOST.operation';
...
describe('cartDedicatedOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicated/options', {
