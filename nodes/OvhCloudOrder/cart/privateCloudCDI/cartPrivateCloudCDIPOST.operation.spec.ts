...
import { description, execute } from './cartPrivateCloudCDIPOST.operation';
...
describe('cartPrivateCloudCDIPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudCDI', {
