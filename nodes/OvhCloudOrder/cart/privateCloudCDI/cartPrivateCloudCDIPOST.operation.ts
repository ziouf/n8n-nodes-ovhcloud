...
/**
 * Executes the Create Private Cloud C D I operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/privateCloudCDI
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/privateCloudCDI`, body)) as IDataObject;
