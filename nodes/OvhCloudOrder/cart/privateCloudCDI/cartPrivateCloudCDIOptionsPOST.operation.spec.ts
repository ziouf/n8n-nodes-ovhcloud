...
import { description, execute } from './cartPrivateCloudCDIOptionsPOST.operation';
...
describe('cartPrivateCloudCDIOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudCDI/options', {
