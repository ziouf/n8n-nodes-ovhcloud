...
/**
 * Executes the Add Private Cloud C D I option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/privateCloudCDI/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/privateCloudCDI/options`, body)) as IDataObject;
