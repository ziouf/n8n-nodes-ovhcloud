...
import { description, execute } from './cartOtbPOST.operation';
...
describe('cartOtbPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/otb', {
