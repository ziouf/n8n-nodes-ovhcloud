...
/**
 * Executes the Add Otb option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/otb/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/otb/options`, body)) as IDataObject;
