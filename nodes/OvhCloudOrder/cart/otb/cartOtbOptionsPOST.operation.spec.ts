...
import { description, execute } from './cartOtbOptionsPOST.operation';
...
describe('cartOtbOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/otb/options', {
