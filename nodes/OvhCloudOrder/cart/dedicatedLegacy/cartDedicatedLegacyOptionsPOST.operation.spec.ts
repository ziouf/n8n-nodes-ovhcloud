...
import { description, execute } from './cartDedicatedLegacyOptionsPOST.operation';
...
describe('cartDedicatedLegacyOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedLegacy/options', {
