...
/**
 * Executes the Add Dedicated Legacy option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/dedicatedLegacy/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/dedicatedLegacy/options`, body)) as IDataObject;
