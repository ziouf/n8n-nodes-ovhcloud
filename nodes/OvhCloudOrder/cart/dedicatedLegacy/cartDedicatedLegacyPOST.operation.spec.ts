...
import { description, execute } from './cartDedicatedLegacyPOST.operation';
...
describe('cartDedicatedLegacyPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedLegacy', {
