...
import { description, execute } from './cartPrivateCloudSDDCOptionsPOST.operation';
...
describe('cartPrivateCloudSDDCOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudSDDC/options', {
