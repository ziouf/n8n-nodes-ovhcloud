...
import { description, execute } from './cartPrivateCloudSDDCPOST.operation';
...
describe('cartPrivateCloudSDDCPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudSDDC', {
