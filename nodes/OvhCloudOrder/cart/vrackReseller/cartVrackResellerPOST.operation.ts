...
/**
 * Executes the Create Vrack Reseller operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/vrackReseller
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/vrackReseller`, body)) as IDataObject;
