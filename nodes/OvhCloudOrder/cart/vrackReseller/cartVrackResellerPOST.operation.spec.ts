...
import { description, execute } from './cartVrackResellerPOST.operation';
...
describe('cartVrackResellerPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/vrackReseller', {
