...
/**
 * Executes the Create Dbaas Timeseries operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/dbaasTimeseries
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/dbaasTimeseries`, body)) as IDataObject;
