...
import { description, execute } from './cartDbaasTimeseriesPOST.operation';
...
describe('cartDbaasTimeseriesPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dbaasTimeseries', {
