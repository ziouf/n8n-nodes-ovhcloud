...
import { description, execute } from './cartDeskaasPOST.operation';
...
describe('cartDeskaasPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/deskaas', {
