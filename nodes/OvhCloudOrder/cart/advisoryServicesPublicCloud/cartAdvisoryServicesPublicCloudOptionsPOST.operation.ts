...
/**
 * Executes the Add Advisory Services Public Cloud option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/advisoryServicesPublicCloud/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/advisoryServicesPublicCloud/options`, body)) as IDataObject;
