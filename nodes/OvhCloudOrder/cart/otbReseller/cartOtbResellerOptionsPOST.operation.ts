...
/**
 * Executes the Add Otb Reseller option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/otbReseller/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/otbReseller/options`, body)) as IDataObject;
