...
import { description, execute } from './cartOtbResellerPOST.operation';
...
describe('cartOtbResellerPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/otbReseller', {
