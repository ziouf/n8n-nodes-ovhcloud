...
/**
 * Executes the Create Otb Reseller operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/otbReseller
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/otbReseller`, body)) as IDataObject;
