...
import { description, execute } from './cartOtbResellerOptionsPOST.operation';
...
describe('cartOtbResellerOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/otbReseller/options', {
