...
/**
 * Executes the Create Licensec Panel operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/licensecPanel
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/licensecPanel`, body)) as IDataObject;
