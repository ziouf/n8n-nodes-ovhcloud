...
import { description, execute } from './cartLicensecPanelPOST.operation';
...
describe('cartLicensecPanelPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/licensecPanel', {
