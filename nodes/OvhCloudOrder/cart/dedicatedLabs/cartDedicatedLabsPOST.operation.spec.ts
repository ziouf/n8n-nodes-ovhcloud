...
import { description, execute } from './cartDedicatedLabsPOST.operation';
...
describe('cartDedicatedLabsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedLabs', {
