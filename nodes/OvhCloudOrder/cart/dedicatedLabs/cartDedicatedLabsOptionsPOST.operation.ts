...
/**
 * Executes the Add Dedicated Labs option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/dedicatedLabs/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/dedicatedLabs/options`, body)) as IDataObject;
