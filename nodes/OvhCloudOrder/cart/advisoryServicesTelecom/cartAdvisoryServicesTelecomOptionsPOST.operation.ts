...
/**
 * Executes the Add Advisory Services Telecom option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/advisoryServicesTelecom/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/advisoryServicesTelecom/options`, body)) as IDataObject;
