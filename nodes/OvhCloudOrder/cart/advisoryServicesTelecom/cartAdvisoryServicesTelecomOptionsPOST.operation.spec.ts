...
import { description, execute } from './cartAdvisoryServicesTelecomOptionsPOST.operation';
...
describe('cartAdvisoryServicesTelecomOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/advisoryServicesTelecom/options', {
