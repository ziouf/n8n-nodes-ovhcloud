...
/**
 * Executes the Create Advisory Services Telecom operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/advisoryServicesTelecom
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/advisoryServicesTelecom`, body)) as IDataObject;
