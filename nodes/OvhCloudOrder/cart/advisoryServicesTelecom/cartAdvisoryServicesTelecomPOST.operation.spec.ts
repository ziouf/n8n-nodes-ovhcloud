...
import { description, execute } from './cartAdvisoryServicesTelecomPOST.operation';
...
describe('cartAdvisoryServicesTelecomPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/advisoryServicesTelecom', {
