...
import { description, execute } from './cartNutanixPOST.operation';
...
describe('cartNutanixPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/nutanix', {
