...
/**
 * Executes the Add Nutanix option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/nutanix/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/nutanix/options`, body)) as IDataObject;
