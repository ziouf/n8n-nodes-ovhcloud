...
import { description, execute } from './cartNutanixOptionsPOST.operation';
...
describe('cartNutanixOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/nutanix/options', {
