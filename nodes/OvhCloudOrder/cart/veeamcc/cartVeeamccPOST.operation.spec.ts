...
import { description, execute } from './cartVeeamccPOST.operation';
...
describe('cartVeeamccPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/veeamcc', {
