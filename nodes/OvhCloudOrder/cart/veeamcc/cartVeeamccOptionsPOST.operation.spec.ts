...
import { description, execute } from './cartVeeamccOptionsPOST.operation';
...
describe('cartVeeamccOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/veeamcc/options', {
