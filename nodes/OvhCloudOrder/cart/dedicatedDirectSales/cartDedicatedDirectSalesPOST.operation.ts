...
/**
 * Executes the Create Dedicated Direct Sales operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/dedicatedDirectSales
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/dedicatedDirectSales`, body)) as IDataObject;
