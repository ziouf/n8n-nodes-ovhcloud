...
import { description, execute } from './cartDedicatedDirectSalesOptionsPOST.operation';
...
describe('cartDedicatedDirectSalesOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedDirectSales/options', {
