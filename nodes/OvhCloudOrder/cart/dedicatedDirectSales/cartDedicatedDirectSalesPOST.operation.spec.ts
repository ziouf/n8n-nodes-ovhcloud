...
import { description, execute } from './cartDedicatedDirectSalesPOST.operation';
...
describe('cartDedicatedDirectSalesPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedDirectSales', {
