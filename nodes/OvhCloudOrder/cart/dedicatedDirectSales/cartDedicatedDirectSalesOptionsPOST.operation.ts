...
/**
 * Executes the Add Dedicated Direct Sales option to cart operation.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/dedicatedDirectSales/options`, body)) as IDataObject;
