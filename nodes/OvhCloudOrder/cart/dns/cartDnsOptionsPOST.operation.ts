...
/**
 * Executes the Add Dns option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/dns/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/dns/options`, body)) as IDataObject;
