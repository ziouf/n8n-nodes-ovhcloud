...
import { description, execute } from './cartDnsOptionsPOST.operation';
...
describe('cartDnsOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dns/options', {
