...
import { description, execute } from './cartDnsPOST.operation';
...
describe('cartDnsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dns', {
