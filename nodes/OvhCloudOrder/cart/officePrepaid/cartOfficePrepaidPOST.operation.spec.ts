...
import { description, execute } from './cartOfficePrepaidPOST.operation';
...
describe('cartOfficePrepaidPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/officePrepaid', {
