...
/**
 * Executes the Create Office Prepaid operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/officePrepaid
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/officePrepaid`, body)) as IDataObject;
