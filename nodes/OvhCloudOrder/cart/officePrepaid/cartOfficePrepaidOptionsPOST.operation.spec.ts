...
import { description, execute } from './cartOfficePrepaidOptionsPOST.operation';
...
describe('cartOfficePrepaidOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/officePrepaid/options', {
