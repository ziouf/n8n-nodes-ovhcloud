...
/**
 * Executes the Add Office Prepaid option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/officePrepaid/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/officePrepaid/options`, body)) as IDataObject;
