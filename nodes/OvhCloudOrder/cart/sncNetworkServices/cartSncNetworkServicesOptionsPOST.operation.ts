...
/**
 * Executes the Add Snc Network Services option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/sncNetworkServices/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/sncNetworkServices/options`, body)) as IDataObject;
