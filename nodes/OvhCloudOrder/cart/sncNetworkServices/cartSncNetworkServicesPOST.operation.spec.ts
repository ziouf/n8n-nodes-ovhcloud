...
import { description, execute } from './cartSncNetworkServicesPOST.operation';
...
describe('cartSncNetworkServicesPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/sncNetworkServices', {
