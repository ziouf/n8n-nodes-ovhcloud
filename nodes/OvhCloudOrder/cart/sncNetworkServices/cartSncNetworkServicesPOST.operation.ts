...
/**
 * Executes the Create Snc Network Services operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/sncNetworkServices
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/sncNetworkServices`, body)) as IDataObject;
