...
import { description, execute } from './cartSncNetworkServicesOptionsPOST.operation';
...
describe('cartSncNetworkServicesOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/sncNetworkServices/options', {
