...
import { description, execute } from './cartOvhCloudConnectPOST.operation';
...
describe('cartOvhCloudConnectPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/ovhCloudConnect', {
