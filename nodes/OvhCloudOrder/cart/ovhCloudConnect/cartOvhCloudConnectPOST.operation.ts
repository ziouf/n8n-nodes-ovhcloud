...
/**
 * Executes the Create Ovh Cloud Connect operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/ovhCloudConnect
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/ovhCloudConnect`, body)) as IDataObject;
