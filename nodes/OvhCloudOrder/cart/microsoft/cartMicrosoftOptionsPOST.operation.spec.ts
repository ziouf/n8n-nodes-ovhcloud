...
import { description, execute } from './cartMicrosoftOptionsPOST.operation';
...
describe('cartMicrosoftOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/microsoft/options', {
