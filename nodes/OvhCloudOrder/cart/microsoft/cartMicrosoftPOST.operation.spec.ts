...
import { description, execute } from './cartMicrosoftPOST.operation';
...
describe('cartMicrosoftPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/microsoft', {
