...
/**
 * Executes the Add Microsoft option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/microsoft/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/microsoft/options`, body)) as IDataObject;
