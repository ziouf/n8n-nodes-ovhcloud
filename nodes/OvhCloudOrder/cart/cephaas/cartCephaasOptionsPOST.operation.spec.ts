...
import { description, execute } from './cartCephaasOptionsPOST.operation';
...
describe('cartCephaasOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/cephaas/options', {
