...
import { description, execute } from './cartXdslOptionsPOST.operation';
...
describe('cartXdslOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/xdsl/options', {
