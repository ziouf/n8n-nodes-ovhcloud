...
import { description, execute } from './cartXdslPOST.operation';
...
describe('cartXdslPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/xdsl', {
