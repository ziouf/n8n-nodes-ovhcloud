...
/**
 * Executes the Add Xdsl option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/xdsl/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/xdsl/options`, body)) as IDataObject;
