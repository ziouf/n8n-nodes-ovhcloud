...
import { description, execute } from './cartNashaOptionsPOST.operation';
...
describe('cartNashaOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/nasha/options', {
