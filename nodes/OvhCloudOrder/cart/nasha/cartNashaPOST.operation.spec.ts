...
import { description, execute } from './cartNashaPOST.operation';
...
describe('cartNashaPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/nasha', {
