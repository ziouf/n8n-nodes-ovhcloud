...
/**
 * Executes the Add Logs option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/logs/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/logs/options`, body)) as IDataObject;
