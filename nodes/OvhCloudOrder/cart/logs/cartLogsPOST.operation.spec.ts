...
import { description, execute } from './cartLogsPOST.operation';
...
describe('cartLogsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/logs', {
