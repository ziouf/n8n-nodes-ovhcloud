...
/**
 * Executes the Add Private Cloud Reseller Enterprise option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/privateCloudResellerEnterprise/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const itemId = this.getNodeParameter('itemId', itemIndex ?? 0, 0) as number;
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/privateCloudResellerEnterprise/options`, body)) as IDataObject;
