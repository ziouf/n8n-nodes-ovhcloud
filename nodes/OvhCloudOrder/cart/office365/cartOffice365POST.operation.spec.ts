...
import { description, execute } from './cartOffice365POST.operation';
...
describe('cartOffice365POST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/office365', {
