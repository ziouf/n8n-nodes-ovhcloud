...
/**
 * Executes the Add Office365 option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/office365/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/office365/options`, body)) as IDataObject;
