...
import { description, execute } from './cartOffice365OptionsPOST.operation';
...
describe('cartOffice365OptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/office365/options', {
