...
/**
 * Executes the Create Bring Your Own Ip operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/bringYourOwnIp
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/bringYourOwnIp`, body)) as IDataObject;
