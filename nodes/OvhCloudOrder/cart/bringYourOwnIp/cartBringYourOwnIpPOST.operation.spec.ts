...
import { description, execute } from './cartBringYourOwnIpPOST.operation';
...
describe('cartBringYourOwnIpPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/bringYourOwnIp', {
