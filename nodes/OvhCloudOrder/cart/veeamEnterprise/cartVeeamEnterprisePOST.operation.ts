...
/**
 * Executes the Create Veeam Enterprise operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/veeamEnterprise
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/veeamEnterprise`, body)) as IDataObject;
