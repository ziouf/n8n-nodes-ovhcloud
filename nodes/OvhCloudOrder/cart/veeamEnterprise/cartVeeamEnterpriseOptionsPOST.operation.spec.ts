...
import { description, execute } from './cartVeeamEnterpriseOptionsPOST.operation';
...
describe('cartVeeamEnterpriseOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/veeamEnterprise/options', {
