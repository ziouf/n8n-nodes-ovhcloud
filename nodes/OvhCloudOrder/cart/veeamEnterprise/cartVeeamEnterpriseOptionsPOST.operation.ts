...
/**
 * Executes the Add Veeam Enterprise option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/veeamEnterprise/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/veeamEnterprise/options`, body)) as IDataObject;
