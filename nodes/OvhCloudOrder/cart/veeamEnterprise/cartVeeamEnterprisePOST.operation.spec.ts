...
import { description, execute } from './cartVeeamEnterprisePOST.operation';
...
describe('cartVeeamEnterprisePOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/veeamEnterprise', {
