...
import { description, execute } from './cartBackupServicesOptionsPOST.operation';
...
describe('cartBackupServicesOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/backupServices/options', {
