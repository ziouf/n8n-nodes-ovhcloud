...
import { description, execute } from './cartBackupServicesPOST.operation';
...
describe('cartBackupServicesPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/backupServices', {
