...
import { description, execute } from './cartResellerPOST.operation';
...
describe('cartResellerPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/reseller', {
