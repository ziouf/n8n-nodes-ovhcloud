...
/**
 * Executes the Create Reseller operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/reseller
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/reseller`, body)) as IDataObject;
