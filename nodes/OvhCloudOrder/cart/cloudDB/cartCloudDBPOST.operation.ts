...
/**
 * Executes the Create Cloud D B operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/cloudDB
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/cloudDB`, body)) as IDataObject;
