...
import { description, execute } from './cartCloudDBPOST.operation';
...
describe('cartCloudDBPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/cloudDB', {
