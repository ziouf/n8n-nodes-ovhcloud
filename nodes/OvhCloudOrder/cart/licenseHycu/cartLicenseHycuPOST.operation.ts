...
/**
 * Executes the Create License Hycu operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/licenseHycu
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/licenseHycu`, body)) as IDataObject;
