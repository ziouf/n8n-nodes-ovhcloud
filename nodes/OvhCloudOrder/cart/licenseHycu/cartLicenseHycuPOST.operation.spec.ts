...
import { description, execute } from './cartLicenseHycuPOST.operation';
...
describe('cartLicenseHycuPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/licenseHycu', {
