...
/**
 * Executes the Create Kubernetes operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/kubernetes
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/kubernetes`, body)) as IDataObject;
