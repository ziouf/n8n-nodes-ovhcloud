...
import { description, execute } from './cartKubernetesPOST.operation';
...
describe('cartKubernetesPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/kubernetes', {
