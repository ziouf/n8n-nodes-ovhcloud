...
import { description, execute } from './cartKubernetesOptionsPOST.operation';
...
describe('cartKubernetesOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/kubernetes/options', {
