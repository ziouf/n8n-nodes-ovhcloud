...
/**
 * Executes the Add Kubernetes option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/kubernetes/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/kubernetes/options`, body)) as IDataObject;
