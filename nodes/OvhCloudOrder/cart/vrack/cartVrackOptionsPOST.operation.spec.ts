...
import { description, execute } from './cartVrackOptionsPOST.operation';
...
describe('cartVrackOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/vrack/options', {
