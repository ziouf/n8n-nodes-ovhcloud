...
import { description, execute } from './cartVrackPOST.operation';
...
describe('cartVrackPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/vrack', {
