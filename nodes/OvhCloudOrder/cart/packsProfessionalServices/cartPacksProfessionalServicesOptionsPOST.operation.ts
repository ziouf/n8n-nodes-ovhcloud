...
/**
 * Executes the Add Packs Professional Services option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/packsProfessionalServices/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/packsProfessionalServices/options`, body)) as IDataObject;
