...
import { description, execute } from './cartPacksProfessionalServicesOptionsPOST.operation';
...
describe('cartPacksProfessionalServicesOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/packsProfessionalServices/options', {
