...
/**
 * Executes the Create Packs Professional Services operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/packsProfessionalServices
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/packsProfessionalServices`, body)) as IDataObject;
