...
/**
 * Executes the Create Exchange operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/exchange
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/exchange`, body)) as IDataObject;
