...
/**
 * Executes the Add Exchange option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/exchange/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/exchange/options`, body)) as IDataObject;
