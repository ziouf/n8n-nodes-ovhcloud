...
import { description, execute } from './cartExchangeOptionsPOST.operation';
...
describe('cartExchangeOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/exchange/options', {
