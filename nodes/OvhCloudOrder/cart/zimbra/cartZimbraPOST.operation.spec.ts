...
import { description, execute } from './cartZimbraPOST.operation';
...
describe('cartZimbraPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/zimbra', {
