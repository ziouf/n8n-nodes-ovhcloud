...
/**
 * Executes the Add Zimbra option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/zimbra/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/zimbra/options`, body)) as IDataObject;
