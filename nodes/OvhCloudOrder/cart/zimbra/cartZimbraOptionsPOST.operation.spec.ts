...
import { description, execute } from './cartZimbraOptionsPOST.operation';
...
describe('cartZimbraOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/zimbra/options', {
