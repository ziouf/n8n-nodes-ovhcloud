...
import { description, execute } from './cartIpResellerPOST.operation';
...
describe('cartIpResellerPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/ipReseller', {
