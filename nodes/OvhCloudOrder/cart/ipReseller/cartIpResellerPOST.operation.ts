...
/**
 * Executes the Create Ip Reseller operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/ipReseller
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/ipReseller`, body)) as IDataObject;
