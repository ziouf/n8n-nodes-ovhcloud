...
/**
 * Executes the Create Power Hosting operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/powerHosting
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/powerHosting`, body)) as IDataObject;
