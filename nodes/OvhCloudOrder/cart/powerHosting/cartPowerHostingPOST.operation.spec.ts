...
import { description, execute } from './cartPowerHostingPOST.operation';
...
describe('cartPowerHostingPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/powerHosting', {
