...
import { description, execute } from './cartDomainOptionsPOST.operation';
...
describe('cartDomainOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/domain/options', {
