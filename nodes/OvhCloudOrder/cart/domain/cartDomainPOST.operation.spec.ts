...
import { description, execute } from './cartDomainPOST.operation';
...
describe('cartDomainPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/domain', {
