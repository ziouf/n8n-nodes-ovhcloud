...
/**
 * Executes the Add Videocenter option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/videocenter/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/videocenter/options`, body)) as IDataObject;
