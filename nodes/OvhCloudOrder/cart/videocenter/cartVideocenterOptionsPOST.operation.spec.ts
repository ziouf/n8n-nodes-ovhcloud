...
import { description, execute } from './cartVideocenterOptionsPOST.operation';
...
describe('cartVideocenterOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/videocenter/options', {
