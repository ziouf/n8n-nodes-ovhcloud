...
import { description, execute } from './cartVideocenterPOST.operation';
...
describe('cartVideocenterPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/videocenter', {
