...
/**
 * Executes the Create Videocenter operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/videocenter
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/videocenter`, body)) as IDataObject;
