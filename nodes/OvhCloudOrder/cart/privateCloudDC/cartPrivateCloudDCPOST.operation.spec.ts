...
import { description, execute } from './cartPrivateCloudDCPOST.operation';
...
describe('cartPrivateCloudDCPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudDC', {
