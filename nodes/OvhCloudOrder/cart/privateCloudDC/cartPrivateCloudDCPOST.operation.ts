...
/**
 * Executes the Create Private Cloud D C operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/privateCloudDC
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/privateCloudDC`, body)) as IDataObject;
