...
import { description, execute } from './cartPrivateCloudDCOptionsPOST.operation';
...
describe('cartPrivateCloudDCOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudDC/options', {
