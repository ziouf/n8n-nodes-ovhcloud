...
/**
 * Executes the Add Managed Services option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/managedServices/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/managedServices/options`, body)) as IDataObject;
