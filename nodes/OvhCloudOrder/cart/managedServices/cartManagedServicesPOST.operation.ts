...
/**
 * Executes the Create Managed Services operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/managedServices
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/managedServices`, body)) as IDataObject;
