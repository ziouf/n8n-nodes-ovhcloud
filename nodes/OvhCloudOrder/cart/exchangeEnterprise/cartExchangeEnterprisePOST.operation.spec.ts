...
import { description, execute } from './cartExchangeEnterprisePOST.operation';
...
describe('cartExchangeEnterprisePOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/exchangeEnterprise', {
