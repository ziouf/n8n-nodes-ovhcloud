...
/**
 * Executes the Create Exchange Enterprise operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/exchangeEnterprise
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/exchangeEnterprise`, body)) as IDataObject;
