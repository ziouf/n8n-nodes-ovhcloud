...
import { description, execute } from './cartExchangeEnterpriseOptionsPOST.operation';
...
describe('cartExchangeEnterpriseOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/exchangeEnterprise/options', {
