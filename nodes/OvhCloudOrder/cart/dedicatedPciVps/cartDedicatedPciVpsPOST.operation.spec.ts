...
import { description, execute } from './cartDedicatedPciVpsPOST.operation';
...
describe('cartDedicatedPciVpsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedPciVps', {
