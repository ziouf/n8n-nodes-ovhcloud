...
/**
 * Executes the Add Dedicated Pci Vps option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/dedicatedPciVps/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/dedicatedPciVps/options`, body)) as IDataObject;
