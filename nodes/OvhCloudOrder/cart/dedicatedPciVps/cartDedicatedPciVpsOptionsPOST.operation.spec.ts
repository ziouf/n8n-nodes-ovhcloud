...
import { description, execute } from './cartDedicatedPciVpsOptionsPOST.operation';
...
describe('cartDedicatedPciVpsOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedPciVps/options', {
