...
import { description, execute } from './cartVmwareCloudDirectorPOST.operation';
...
describe('cartVmwareCloudDirectorPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/vmwareCloudDirector', {
