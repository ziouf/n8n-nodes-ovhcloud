...
/**
 * Executes the Create Vmware Cloud Director operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/vmwareCloudDirector
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/vmwareCloudDirector`, body)) as IDataObject;
