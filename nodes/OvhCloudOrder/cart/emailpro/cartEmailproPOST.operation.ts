...
/**
 * Executes the Create Emailpro operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/emailpro
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/emailpro`, body)) as IDataObject;
