...
import { description, execute } from './cartEmailproPOST.operation';
...
describe('cartEmailproPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/emailpro', {
