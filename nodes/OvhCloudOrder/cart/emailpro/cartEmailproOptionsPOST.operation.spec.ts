...
import { description, execute } from './cartEmailproOptionsPOST.operation';
...
describe('cartEmailproOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/emailpro/options', {
