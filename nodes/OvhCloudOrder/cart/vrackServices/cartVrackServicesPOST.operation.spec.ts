...
import { description, execute } from './cartVrackServicesPOST.operation';
...
describe('cartVrackServicesPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/vrackServices', {
