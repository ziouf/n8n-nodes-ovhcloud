...
import { description, execute } from './cartVdiOptionsPOST.operation';
...
describe('cartVdiOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/vdi/options', {
