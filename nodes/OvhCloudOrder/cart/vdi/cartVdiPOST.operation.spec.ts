...
import { description, execute } from './cartVdiPOST.operation';
...
describe('cartVdiPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/vdi', {
