...
/**
 * Executes the Add Vdi option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/vdi/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/vdi/options`, body)) as IDataObject;
