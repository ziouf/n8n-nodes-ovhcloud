...
import { description, execute } from './cartDedicatedResellerPOST.operation';
...
describe('cartDedicatedResellerPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedReseller', {
