...
import { description, execute } from './cartDedicatedResellerOptionsPOST.operation';
...
describe('cartDedicatedResellerOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedReseller/options', {
