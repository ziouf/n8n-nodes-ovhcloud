...
/**
 * Executes the Add Dedicated Reseller option to cart operation.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/dedicatedReseller/options`, body)) as IDataObject;
