...
import { description, execute } from './cartIpLoadbalancingOptionsPOST.operation';
...
describe('cartIpLoadbalancingOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/ipLoadbalancing/options', {
