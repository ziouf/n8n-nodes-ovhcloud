...
import { description, execute } from './cartIpLoadbalancingPOST.operation';
...
describe('cartIpLoadbalancingPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/ipLoadbalancing', {
