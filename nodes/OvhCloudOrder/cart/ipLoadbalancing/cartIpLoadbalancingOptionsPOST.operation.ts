...
/**
 * Executes the Add Ip Loadbalancing option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/ipLoadbalancing/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/ipLoadbalancing/options`, body)) as IDataObject;
