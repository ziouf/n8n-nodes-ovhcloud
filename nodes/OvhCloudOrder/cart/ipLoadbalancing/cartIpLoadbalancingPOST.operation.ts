...
/**
 * Executes the Create Ip Loadbalancing operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/ipLoadbalancing
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/ipLoadbalancing`, body)) as IDataObject;
