...
/**
 * Executes the Add Dedicated Cart Service Option operation.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/dedicated/{serviceName}`, body)) as IDataObject;
