...
/**
 * Executes the Add Privatecloudresellerenterprise Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/privateCloudResellerEnterprise/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/privateCloudResellerEnterprise/{serviceName}`, body)) as IDataObject;
