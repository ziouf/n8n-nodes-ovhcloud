...
/**
 * Executes the Add Privatecloudreseller Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/privateCloudReseller/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/privateCloudReseller/{serviceName}`, body)) as IDataObject;
