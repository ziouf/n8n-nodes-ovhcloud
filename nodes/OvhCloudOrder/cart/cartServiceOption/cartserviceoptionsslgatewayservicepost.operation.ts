...
/**
 * Executes the Add Sslgateway Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/sslGateway/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/sslGateway/{serviceName}`, body)) as IDataObject;
