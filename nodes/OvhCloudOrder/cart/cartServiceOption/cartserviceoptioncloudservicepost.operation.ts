...
/**
 * Executes the Add Cloud Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/cloud/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/cloud/{serviceName}`, body)) as IDataObject;
