...
import { description, execute } from './cartserviceoptionvmwareclouddirectorserviceget.operation';
...
describe('cartServiceOptionvmwareclouddirectorServiceGET operation', () => {
