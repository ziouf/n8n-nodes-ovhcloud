...
/**
 * Executes the Add Webhosting Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/webHosting/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/webHosting/{serviceName}`, body)) as IDataObject;
