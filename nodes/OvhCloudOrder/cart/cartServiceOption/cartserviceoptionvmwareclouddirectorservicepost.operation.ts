...
/**
 * Executes the Add Vmwareclouddirector Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/vmwareCloudDirector/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/vmwareCloudDirector/{serviceName}`, body)) as IDataObject;
