...
import { description, execute } from './cartserviceoptionvmwareclouddirectorbackuplistget.operation';
...
describe('cartServiceOptionvmwareclouddirectorbackupListGET operation', () => {
