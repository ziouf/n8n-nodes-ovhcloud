...
/**
 * Executes the Add Baremetalservers Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/baremetalServers/{serviceName}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/baremetalServers/{serviceName}`, body)) as IDataObject;
