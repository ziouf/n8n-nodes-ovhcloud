...
/**
 * Executes the Add Microsoftexchange Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/microsoftExchange/{serviceName}
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/microsoftExchange/{serviceName}`, body)) as IDataObject;
