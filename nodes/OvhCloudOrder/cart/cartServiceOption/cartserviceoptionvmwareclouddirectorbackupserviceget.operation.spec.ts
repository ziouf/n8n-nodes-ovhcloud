...
import { description, execute } from './cartserviceoptionvmwareclouddirectorbackupserviceget.operation';
...
describe('cartServiceOptionvmwareclouddirectorbackupServiceGET operation', () => {
