...
import { description, execute } from './cartserviceoptionprivatecloudresellerservicepost.operation';
...
describe('cartServiceOptionprivatecloudresellerServicePOST operation', () => {
