...
import { description, execute } from './cartserviceoptionprivatecloudresellerenterpriseserviceget.operation';
...
describe('cartServiceOptionprivatecloudresellerenterpriseServiceGET operation', () => {
