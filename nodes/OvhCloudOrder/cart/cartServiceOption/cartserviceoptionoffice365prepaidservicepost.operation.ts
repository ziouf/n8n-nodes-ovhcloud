...
/**
 * Executes the Add Office365Prepaid Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/office365Prepaid/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/office365Prepaid/{serviceName}`, body)) as IDataObject;
