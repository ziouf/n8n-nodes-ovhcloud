...
import { description, execute } from './cartserviceoptionprivatecloudenterpriselistget.operation';
...
describe('cartServiceOptionprivatecloudenterpriseListGET operation', () => {
