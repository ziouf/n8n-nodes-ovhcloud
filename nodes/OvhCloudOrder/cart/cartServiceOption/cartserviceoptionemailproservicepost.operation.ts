...
/**
 * Executes the Add Emailpro Cart Service Option operation.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/emailpro/{serviceName}`, body)) as IDataObject;
