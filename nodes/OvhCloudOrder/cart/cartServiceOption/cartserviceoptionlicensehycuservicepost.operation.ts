...
/**
 * Executes the Add Licensehycu Cart Service Option operation.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/licenseHycu/{serviceName}`, body)) as IDataObject;
