...
/**
 * Executes the Add Domain Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/domain/{serviceName}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/domain/{serviceName}`, body)) as IDataObject;
