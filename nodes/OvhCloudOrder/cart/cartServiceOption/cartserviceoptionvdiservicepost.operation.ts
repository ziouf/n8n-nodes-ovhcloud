...
/**
 * Executes the Add Vdi Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/vdi/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/vdi/{serviceName}`, body)) as IDataObject;
