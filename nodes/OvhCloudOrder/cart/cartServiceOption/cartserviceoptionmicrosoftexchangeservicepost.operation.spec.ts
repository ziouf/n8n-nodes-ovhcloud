...
import { description, execute } from './cartserviceoptionmicrosoftexchangeservicepost.operation';
...
describe('cartServiceOptionmicrosoftexchangeServicePOST operation', () => {
