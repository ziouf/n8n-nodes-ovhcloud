...
import { description, execute } from './cartserviceoptionprivatecloudresellerenterpriseservicepost.operation';
...
describe('cartServiceOptionprivatecloudresellerenterpriseServicePOST operation', () => {
