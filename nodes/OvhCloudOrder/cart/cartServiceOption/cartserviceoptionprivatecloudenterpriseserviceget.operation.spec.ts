...
import { description, execute } from './cartserviceoptionprivatecloudenterpriseserviceget.operation';
...
describe('cartServiceOptionprivatecloudenterpriseServiceGET operation', () => {
