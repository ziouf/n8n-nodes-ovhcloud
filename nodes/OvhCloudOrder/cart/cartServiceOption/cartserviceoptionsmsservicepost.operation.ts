...
/**
 * Executes the Add Sms Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/sms/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/sms/{serviceName}`, body)) as IDataObject;
