...
/**
 * Executes the Add VPS Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/vps/{serviceName}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/vps/{serviceName}`, body)) as IDataObject;
