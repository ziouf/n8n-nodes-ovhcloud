...
/**
 * Executes the Add Sncnetworkservices Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/sncNetworkServices/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/sncNetworkServices/{serviceName}`, body)) as IDataObject;
