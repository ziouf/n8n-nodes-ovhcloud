...
import { description, execute } from './cartserviceoptionvmwareclouddirectorservicepost.operation';
...
describe('cartServiceOptionvmwareclouddirectorServicePOST operation', () => {
