...
import { description, execute } from './cartserviceoptionprivatecloudresellerenterpriselistget.operation';
...
describe('cartServiceOptionprivatecloudresellerenterpriseListGET operation', () => {
