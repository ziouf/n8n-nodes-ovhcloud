...
import { description, execute } from './cartserviceoptionprivatecloudresellerserviceget.operation';
...
describe('cartServiceOptionprivatecloudresellerServiceGET operation', () => {
