...
import { description, execute } from './cartserviceoptionsncnetworkservicesservicepost.operation';
...
describe('cartServiceOptionsncnetworkservicesServicePOST operation', () => {
