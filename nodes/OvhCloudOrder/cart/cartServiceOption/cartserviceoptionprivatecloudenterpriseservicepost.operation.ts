...
/**
 * Executes the Add Privatecloudenterprise Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/privateCloudEnterprise/{serviceName}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/privateCloudEnterprise/{serviceName}`, body)) as IDataObject;
