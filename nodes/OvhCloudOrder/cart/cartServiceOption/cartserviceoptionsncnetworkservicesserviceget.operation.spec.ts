...
import { description, execute } from './cartserviceoptionsncnetworkservicesserviceget.operation';
...
describe('cartServiceOptionsncnetworkservicesServiceGET operation', () => {
