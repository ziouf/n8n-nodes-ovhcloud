...
import { description, execute } from './cartserviceoptionprivatecloudenterpriseservicepost.operation';
...
describe('cartServiceOptionprivatecloudenterpriseServicePOST operation', () => {
