...
/**
 * Executes the Add Sharepoint Cart Service Option operation.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/sharepoint/{serviceName}`, body)) as IDataObject;
