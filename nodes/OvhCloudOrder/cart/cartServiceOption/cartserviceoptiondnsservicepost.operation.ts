...
/**
 * Executes the Add Dns Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/dns/{serviceName}
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/dns/{serviceName}`, body)) as IDataObject;
