...
/**
 * Executes the Add Nutanix Cart Service Option operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cartServiceOption/nutanix/{serviceName}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cartServiceOption/nutanix/{serviceName}`, body)) as IDataObject;
