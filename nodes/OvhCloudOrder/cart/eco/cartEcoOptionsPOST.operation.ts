...
/**
 * Executes the Add Eco option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/eco/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/eco/options`, body)) as IDataObject;
