...
import { description, execute } from './cartEcoOptionsPOST.operation';
...
describe('cartEcoOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/eco/options', {
