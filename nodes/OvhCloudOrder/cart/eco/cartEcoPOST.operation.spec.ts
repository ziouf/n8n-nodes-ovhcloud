...
import { description, execute } from './cartEcoPOST.operation';
...
describe('cartEcoPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/eco', {
