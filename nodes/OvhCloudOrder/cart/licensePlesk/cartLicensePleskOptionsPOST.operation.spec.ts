...
import { description, execute } from './cartLicensePleskOptionsPOST.operation';
...
describe('cartLicensePleskOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/licensePlesk/options', {
