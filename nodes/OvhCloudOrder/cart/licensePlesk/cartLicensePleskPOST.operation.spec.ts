...
import { description, execute } from './cartLicensePleskPOST.operation';
...
describe('cartLicensePleskPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/licensePlesk', {
