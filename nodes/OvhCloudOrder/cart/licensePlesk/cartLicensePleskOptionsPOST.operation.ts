...
/**
 * Executes the Add License Plesk option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/licensePlesk/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/licensePlesk/options`, body)) as IDataObject;
