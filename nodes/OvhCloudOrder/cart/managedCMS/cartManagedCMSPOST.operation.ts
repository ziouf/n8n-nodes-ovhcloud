...
/**
 * Executes the Create Managed C M S operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/managedCMS
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/managedCMS`, body)) as IDataObject;
