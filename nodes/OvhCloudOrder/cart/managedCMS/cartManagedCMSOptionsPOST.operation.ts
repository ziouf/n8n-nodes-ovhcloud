...
/**
 * Executes the Add Managed C M S option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/managedCMS/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/managedCMS/options`, body)) as IDataObject;
