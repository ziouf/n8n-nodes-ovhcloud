...
import { description, execute } from './cartManagedCMSOptionsPOST.operation';
...
describe('cartManagedCMSOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/managedCMS/options', {
