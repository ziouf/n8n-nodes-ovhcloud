...
import { description, execute } from './cartManagedCMSPOST.operation';
...
describe('cartManagedCMSPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/managedCMS', {
