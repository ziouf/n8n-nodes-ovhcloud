...
import { description, execute } from './cartCdnOptionsPOST.operation';
...
describe('cartCdnOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/cdn/options', {
