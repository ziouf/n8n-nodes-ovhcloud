...
import { description, execute } from './cartCdnPOST.operation';
...
describe('cartCdnPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/cdn', {
