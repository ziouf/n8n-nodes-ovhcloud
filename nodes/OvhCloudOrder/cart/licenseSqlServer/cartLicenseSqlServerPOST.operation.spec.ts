...
import { description, execute } from './cartLicenseSqlServerPOST.operation';
...
describe('cartLicenseSqlServerPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/licenseSqlServer', {
