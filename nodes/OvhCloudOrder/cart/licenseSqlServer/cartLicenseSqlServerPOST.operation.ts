...
/**
 * Executes the Create License Sql Server operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/licenseSqlServer
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/licenseSqlServer`, body)) as IDataObject;
