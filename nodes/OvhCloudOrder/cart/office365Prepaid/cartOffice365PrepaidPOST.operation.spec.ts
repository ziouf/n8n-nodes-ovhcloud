...
import { description, execute } from './cartOffice365PrepaidPOST.operation';
...
describe('cartOffice365PrepaidPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/office365Prepaid', {
