...
/**
 * Executes the Create Office365 Prepaid operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/office365Prepaid
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/office365Prepaid`, body)) as IDataObject;
