...
import { description, execute } from './cartOffice365PrepaidOptionsPOST.operation';
...
describe('cartOffice365PrepaidOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/office365Prepaid/options', {
