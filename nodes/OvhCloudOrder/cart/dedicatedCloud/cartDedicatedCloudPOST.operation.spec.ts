...
import { description, execute } from './cartDedicatedCloudPOST.operation';
...
describe('cartDedicatedCloudPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedCloud', {
