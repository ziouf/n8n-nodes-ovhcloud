...
/**
 * Executes the List Dedicated Cloud offers operation.
 *
 * HTTP method: GET
 * Endpoint: /order/cart/{cartId}/dedicatedCloud
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/order/cart/${cartId}/dedicatedCloud`, qs)) as IDataObject;
