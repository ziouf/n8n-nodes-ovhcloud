...
import { description, execute } from './cartDedicatedCloudOptionsPOST.operation';
...
describe('cartDedicatedCloudOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/dedicatedCloud/options', {
