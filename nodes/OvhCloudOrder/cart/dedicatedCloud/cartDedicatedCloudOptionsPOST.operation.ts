...
/**
 * Executes the Add Dedicated Cloud option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/dedicatedCloud/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/dedicatedCloud/options`, body)) as IDataObject;
