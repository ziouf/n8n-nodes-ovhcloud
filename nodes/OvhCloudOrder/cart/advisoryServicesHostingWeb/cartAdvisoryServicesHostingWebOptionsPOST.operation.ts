...
/**
 * Executes the Add Advisory Services Hosting Web option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/advisoryServicesHostingWeb/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/advisoryServicesHostingWeb/options`, body)) as IDataObject;
