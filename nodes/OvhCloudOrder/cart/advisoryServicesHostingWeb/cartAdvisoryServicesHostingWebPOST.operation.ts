...
/**
 * Executes the Create Advisory Services Hosting Web operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/advisoryServicesHostingWeb
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/advisoryServicesHostingWeb`, body)) as IDataObject;
