...
import { description, execute } from './cartIpPOST.operation';
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/ip', {
