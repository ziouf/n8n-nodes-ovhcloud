...
/**
 * Executes the Add Ip option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/ip/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/ip/options`, body)) as IDataObject;
