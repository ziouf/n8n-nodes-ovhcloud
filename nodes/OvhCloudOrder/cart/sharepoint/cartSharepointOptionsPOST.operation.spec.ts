...
import { description, execute } from './cartSharepointOptionsPOST.operation';
...
describe('cartSharepointOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/sharepoint/options', {
