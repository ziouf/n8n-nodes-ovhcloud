...
/**
 * Executes the Create Sharepoint operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/sharepoint
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/sharepoint`, body)) as IDataObject;
