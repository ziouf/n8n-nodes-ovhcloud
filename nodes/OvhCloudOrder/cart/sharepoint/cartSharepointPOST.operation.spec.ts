...
import { description, execute } from './cartSharepointPOST.operation';
...
describe('cartSharepointPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/sharepoint', {
