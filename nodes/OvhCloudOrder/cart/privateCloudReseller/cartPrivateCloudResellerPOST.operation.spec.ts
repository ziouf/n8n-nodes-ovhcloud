...
import { description, execute } from './cartPrivateCloudResellerPOST.operation';
...
describe('cartPrivateCloudResellerPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudReseller', {
