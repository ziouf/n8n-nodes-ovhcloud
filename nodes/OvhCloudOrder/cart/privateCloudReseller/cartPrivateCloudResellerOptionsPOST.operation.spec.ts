...
import { description, execute } from './cartPrivateCloudResellerOptionsPOST.operation';
...
describe('cartPrivateCloudResellerOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloudReseller/options', {
