...
/**
 * Executes the Add Private Cloud Reseller option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/privateCloudReseller/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/privateCloudReseller/options`, body)) as IDataObject;
