...
/**
 * Executes the Get Private Cloud Reseller options operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/order/cart/${cartId}/privateCloudReseller/options`, qs)) as IDataObject;
