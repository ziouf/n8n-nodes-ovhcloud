...
import { description, execute } from './cartCloudwebPOST.operation';
...
describe('cartCloudwebPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/cloudweb', {
