...
/**
 * Executes the Create Cloudweb operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/cloudweb
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/cloudweb`, body)) as IDataObject;
