...
/**
 * Executes the Add Cloudweb option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/cloudweb/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/cloudweb/options`, body)) as IDataObject;
