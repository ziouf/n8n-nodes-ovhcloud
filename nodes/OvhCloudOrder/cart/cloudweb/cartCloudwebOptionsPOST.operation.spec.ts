...
import { description, execute } from './cartCloudwebOptionsPOST.operation';
...
describe('cartCloudwebOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/cloudweb/options', {
