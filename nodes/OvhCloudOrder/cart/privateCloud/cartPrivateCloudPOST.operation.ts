...
/**
 * Executes the Create Private Cloud operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/privateCloud
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/privateCloud`, body)) as IDataObject;
