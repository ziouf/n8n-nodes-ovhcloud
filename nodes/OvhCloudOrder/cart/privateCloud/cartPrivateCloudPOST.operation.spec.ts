...
import { description, execute } from './cartPrivateCloudPOST.operation';
...
describe('cartPrivateCloudPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloud', {
