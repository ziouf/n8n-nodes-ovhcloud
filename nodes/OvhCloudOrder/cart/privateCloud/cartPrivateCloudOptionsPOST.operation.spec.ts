...
import { description, execute } from './cartPrivateCloudOptionsPOST.operation';
...
describe('cartPrivateCloudOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateCloud/options', {
