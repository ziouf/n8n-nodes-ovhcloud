...
/**
 * Executes the Add Private Cloud option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/privateCloud/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/privateCloud/options`, body)) as IDataObject;
