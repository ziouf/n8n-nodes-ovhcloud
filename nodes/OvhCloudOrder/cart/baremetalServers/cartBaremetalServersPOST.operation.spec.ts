...
import { description, execute } from './cartBaremetalServersPOST.operation';
...
describe('cartBaremetalServersPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/baremetalServers', {
