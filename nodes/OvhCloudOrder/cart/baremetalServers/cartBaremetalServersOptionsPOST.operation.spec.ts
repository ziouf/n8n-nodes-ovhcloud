...
import { description, execute } from './cartBaremetalServersOptionsPOST.operation';
...
describe('cartBaremetalServersOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/baremetalServers/options', {
