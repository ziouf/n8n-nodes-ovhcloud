...
/**
 * Executes the Add Baremetal Servers option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/baremetalServers/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/baremetalServers/options`, body)) as IDataObject;
