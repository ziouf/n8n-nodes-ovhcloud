...
/**
 * Executes the Create Baremetal Servers operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/baremetalServers
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/baremetalServers`, body)) as IDataObject;
