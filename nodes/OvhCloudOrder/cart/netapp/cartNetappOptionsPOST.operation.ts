...
/**
 * Executes the Add Netapp option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/netapp/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/netapp/options`, body)) as IDataObject;
