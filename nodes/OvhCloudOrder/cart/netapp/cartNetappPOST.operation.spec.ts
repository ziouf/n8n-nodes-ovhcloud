...
import { description, execute } from './cartNetappPOST.operation';
...
describe('cartNetappPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/netapp', {
