...
import { description, execute } from './cartNetappOptionsPOST.operation';
...
describe('cartNetappOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/netapp/options', {
