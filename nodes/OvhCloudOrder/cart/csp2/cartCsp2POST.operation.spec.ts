...
import { description, execute } from './cartCsp2POST.operation';
...
describe('cartCsp2POST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/csp2', {
