...
/**
 * Executes the Add Csp2 option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/csp2/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/csp2/options`, body)) as IDataObject;
