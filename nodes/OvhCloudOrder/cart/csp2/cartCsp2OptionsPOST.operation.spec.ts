...
import { description, execute } from './cartCsp2OptionsPOST.operation';
...
describe('cartCsp2OptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/csp2/options', {
