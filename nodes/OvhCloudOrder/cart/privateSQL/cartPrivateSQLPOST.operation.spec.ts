...
import { description, execute } from './cartPrivateSQLPOST.operation';
...
describe('cartPrivateSQLPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/privateSQL', {
