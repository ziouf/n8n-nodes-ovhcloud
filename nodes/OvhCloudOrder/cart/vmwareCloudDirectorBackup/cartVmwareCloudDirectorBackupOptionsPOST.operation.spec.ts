...
import { description, execute } from './cartVmwareCloudDirectorBackupOptionsPOST.operation';
...
describe('cartVmwareCloudDirectorBackupOptionsPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/vmwareCloudDirectorBackup/options', {
