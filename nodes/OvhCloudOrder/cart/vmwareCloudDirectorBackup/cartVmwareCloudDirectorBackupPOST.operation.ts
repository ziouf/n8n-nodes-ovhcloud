...
/**
 * Executes the Create Vmware Cloud Director Backup operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/vmwareCloudDirectorBackup
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/vmwareCloudDirectorBackup`, body)) as IDataObject;
