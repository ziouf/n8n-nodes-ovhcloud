...
/**
 * Executes the Add Vmware Cloud Director Backup option to cart operation.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/vmwareCloudDirectorBackup/options`, body)) as IDataObject;
