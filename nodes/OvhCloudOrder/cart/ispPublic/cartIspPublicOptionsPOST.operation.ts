...
/**
 * Executes the Add Isp Public option to cart operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/ispPublic/options
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/ispPublic/options`, body)) as IDataObject;
