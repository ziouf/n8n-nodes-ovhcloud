...
/**
 * Executes the Create Isp Public operation.
 *
 * HTTP method: POST
 * Endpoint: /order/cart/{cartId}/ispPublic
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/order/cart/${cartId}/ispPublic`, body)) as IDataObject;
