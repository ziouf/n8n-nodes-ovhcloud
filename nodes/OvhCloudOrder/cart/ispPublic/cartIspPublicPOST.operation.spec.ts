...
import { description, execute } from './cartIspPublicPOST.operation';
...
describe('cartIspPublicPOST operation', () => {
...
expect((client.httpPost as jest.Mock).mock.calls[0]).toEqual(['/order/cart/test-cartId/ispPublic', {
