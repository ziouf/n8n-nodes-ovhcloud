...
import { description, execute } from './exchangeAccountGet.operation';
...
describe('exchangeAccountGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockReturnValue((param: string): string | undefined => {
				...
				if (param === 'accountId') return 'test-account';
				return '';
			});
