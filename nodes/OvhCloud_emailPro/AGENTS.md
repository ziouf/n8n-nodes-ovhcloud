...
- **API Spec**: https://eu.api.ovh.com/v1/email/pro.json
- **Base Path**: /email/pro
...
├── list.operation.ts      # GET /email/pro
├── get.operation.ts       # GET /email/pro/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getEmailProServices'`)
