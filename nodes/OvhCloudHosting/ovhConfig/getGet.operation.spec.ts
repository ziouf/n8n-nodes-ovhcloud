...
describe('ovhConfig.getGet.operation', () => {
	describe('execute', () => {
		...
		it('should get the ovhConfig via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/hosting/web/myservice.ovh/ovhConfig/123');
