...
import { execute } from './capabilitiesGet.operation';
...
describe('ovhConfig.capabilitiesGet.operation', () => {
	describe('execute', () => {
		...
		it('should get the ovhConfig capabilities via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/hosting/web/myservice.ovh/ovhConfigCapabilities',
			);
