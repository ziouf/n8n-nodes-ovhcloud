...
import { execute } from './sslReportGet.operation';
...
describe('attachedDomain.sslReportGet.operation', () => {
	describe('execute', () => {
		...
		it('should get the attached domain SSL report via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/hosting/web/myservice.ovh/attachedDomain/example.com/ssl/report',
			);
