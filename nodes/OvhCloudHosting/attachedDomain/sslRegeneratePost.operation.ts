...
/**
 * Regenerate the SSL certificate of an attached domain
 *
 * HTTP method: POST
...
export async function execute(
	...
	const data = (await client.httpPost(
		`/hosting/web/${encodeURIComponent(serviceName)}/attachedDomain/${encodeURIComponent(domainName)}/ssl/regenerate`,
		{} as IDataObject,
	)) as IDataObject;
