...
import { description, execute } from './volumesGet.operation';
...
describe('volumesGet.operation', () => {
		...
		describe('execute', () => {
			it('should call GET /hosting/web/{serviceName}/email/volumes', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(`/hosting/web/myservice.ovh/email/volumes`);
			});
		});
});
