...
import { description, execute } from './subscriptionGetGet.operation';
...
describe('subscriptionGetGet.operation', () => {
		...
		describe('execute', () => {
			it('should call GET /hosting/web/{serviceName}/log/subscription/{subscriptionId}', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(`/hosting/web/myservice.ovh/log/subscription/3f2f1e1e-4a3a-4b4b-8c8c-1d1d1d1d1d1d`);
			});
		});
});
