...
describe('indy.getGet.operation', () => {
	describe('execute', () => {
		...
		it('should get the indy user via GET with the login in the path', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/hosting/web/myservice.ovh/indy/user1');
