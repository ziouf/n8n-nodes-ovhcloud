...
describe('deleteDelete.operation', () => {
		...
		describe('execute', () => {
			it('should call DELETE /hosting/web/{serviceName}/userLogs/{login}', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith(`/hosting/web/myservice.ovh/userLogs/mylog`);
			});
		});
});
