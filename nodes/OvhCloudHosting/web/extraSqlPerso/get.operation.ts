 ...
 *
 * HTTP GET request to `/hosting/web/{serviceName}/extraSqlPerso/{id}` endpoint.
 *
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/hosting/web/${serviceName}/extraSqlPerso/${id}`)) as IDataObject;
	return [{ json: data }];
}
