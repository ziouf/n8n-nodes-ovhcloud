/**
 * @brief Delete CDN Domain Option operation for web hosting
 *
 * HTTP DELETE request to `/hosting/web/{serviceName}/cdn/domain/{domainName}/option/{optionName}` endpoint.
 */
import type {
	IExecuteFunctions,
	INodeExecutionData,
