 ...
 *
 * HTTP GET request to `/hosting/web/{serviceName}/cdn/serviceInfos` endpoint.
 *
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/hosting/web/${serviceName}/cdn/serviceInfos`)) as IDataObject;
	return [{ json: data }];
}
