 ...
 *
 * HTTP PUT request to `/hosting/web/{serviceName}/user/{login}` endpoint.
 *
 ...
 *
 * HTTP method: PUT
 * Endpoint: /hosting/web/{serviceName}/user/{login}
 *
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut(`/hosting/web/${serviceName}/user/${login}`, { body: {} })) as IDataObject;
	return [{ json: data }];
}
