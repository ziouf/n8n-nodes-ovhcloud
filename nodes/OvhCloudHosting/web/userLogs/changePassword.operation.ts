 ...
 *
 * HTTP POST request to `/hosting/web/{serviceName}/userLogs/{login}/changePassword` endpoint.
 *
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/hosting/web/${serviceName}/userLogs/${login}/changePassword`, { body: { password: password } })) as IDataObject;
	return [{ json: data }];
}
