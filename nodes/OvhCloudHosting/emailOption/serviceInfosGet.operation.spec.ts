...
describe('serviceInfosGet.operation', () => {
		...
		describe('execute', () => {
			it('should call GET /hosting/web/{serviceName}/emailOption/7/serviceInfos', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(`/hosting/web/myservice.ovh/emailOption/7/serviceInfos`);
			});
		});
});
