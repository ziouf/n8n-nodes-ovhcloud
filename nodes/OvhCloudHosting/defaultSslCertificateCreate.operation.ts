...
/** Create a default SSL certificate for a web hosting service. */
	...
	return [
		{
			...
			required: true,
			description: 'The hosting web service name to create the default SSL certificate for',
			modes: [
				{
...
export async function execute(
	...
	const data = (await client.httpPost(
		`/hosting/web/${serviceName}/ssl/defaultSslCertificate`,
		{},
	)) as IDataObject;
