...
import { description, execute } from './creationCapabilitiesGet.operation';
...
describe('creationCapabilitiesGet.operation', () => {
		...
		describe('execute', () => {
			it('should call GET /hosting/web/{serviceName}/databaseCreationCapabilities', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(`/hosting/web/myservice.ovh/databaseCreationCapabilities`);
			});
		});
});
