...
import { description, execute } from './typeListGet.operation';
...
describe('typeListGet.operation', () => {
		...
		describe('execute', () => {
			it('should call GET /hosting/web/{serviceName}/databaseAvailableType', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(`/hosting/web/myservice.ovh/databaseAvailableType`);
			});
		});
});
