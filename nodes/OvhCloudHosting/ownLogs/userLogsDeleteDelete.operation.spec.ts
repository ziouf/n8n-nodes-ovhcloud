...
import { description, execute } from './userLogsDeleteDelete.operation';
...
describe('userLogsDeleteDelete.operation', () => {
		...
		describe('execute', () => {
			it('should call DELETE /hosting/web/{serviceName}/ownLogs/3/userLogs/{login}', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith(`/hosting/web/myservice.ovh/ownLogs/3/userLogs/mylog`);
			});
		});
});
