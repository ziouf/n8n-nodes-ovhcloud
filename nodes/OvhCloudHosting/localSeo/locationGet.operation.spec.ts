...
import { execute } from './locationGet.operation';
...
describe('localSeo.locationGet.operation', () => {
	describe('execute', () => {
		...
		it('should get the Local SEO location via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/hosting/web/myservice.ovh/localSeo/location/456',
			);
