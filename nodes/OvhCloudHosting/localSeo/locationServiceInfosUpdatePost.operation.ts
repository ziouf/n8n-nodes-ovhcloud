...
/**
 * Update the service properties of a Local SEO location
 *
 * HTTP method: POST
...
export async function execute(
	...
	const data = (await client.httpPost(
		`/hosting/web/${encodeURIComponent(serviceName)}/localSeo/location/${encodeURIComponent(String(id))}/serviceInfosUpdate`,
