...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const contactType = this.getNodeParameter('contactType', _itemIndex ?? 0) as string;
	const contactEmail = this.getNodeParameter('contactEmail', _itemIndex ?? 0) as string;
