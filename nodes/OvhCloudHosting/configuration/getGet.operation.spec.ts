...
describe('configuration.getGet.operation', () => {
	describe('execute', () => {
		...
		it('should get the configuration via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/hosting/web/myservice.ovh/configuration');
