/**
 * @brief Delete User Grant operation for private database
 *
 * HTTP DELETE request to `/hosting/privateDatabase/{serviceName}/user/{userName}/grant/{databaseName}` endpoint.
 */
import type {
	IExecuteFunctions,
	INodeExecutionData,
...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		...
		},
		{
			...
			default: '',
			required: true,
			description: 'The name of the database to revoke access from',
			displayOptions,
		},
	];
}
