...
import { execute } from './serviceInfosGet.operation';
...
describe('extraSqlPerso.serviceInfosGet.operation', () => {
	describe('execute', () => {
		...
		it('should get the service infos via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/hosting/web/myservice.ovh/extraSqlPerso/12345/serviceInfos',
			);
