...
jest.mock('../../../shared/transport/ApiClient', () => {
	const mockHttpClient = {
		httpGet: jest.fn().mockResolvedValue(['12345']),
...
describe('extraSqlPerso.listGet.operation', () => {
	describe('execute', () => {
		...
		it('should list extra SQL perso options via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/hosting/web/myservice.ovh/extraSqlPerso');
