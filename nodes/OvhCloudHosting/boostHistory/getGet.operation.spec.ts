...
describe('boostHistory.getGet.operation', () => {
	describe('execute', () => {
		...
		it('should get boost history entry via GET with date in the path', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/hosting/web/myservice.ovh/boostHistory/2026-08-01',
			);
