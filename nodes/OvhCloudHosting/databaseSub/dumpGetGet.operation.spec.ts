...
import { description, execute } from './dumpGetGet.operation';
...
describe('dumpGetGet.operation', () => {
		...
		describe('execute', () => {
			it('should call GET /hosting/web/database/{serviceName}/{databaseName}/dump/42', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(`/hosting/web/database/myservice.ovh/mydb/dump/42`);
			});
		});
});
