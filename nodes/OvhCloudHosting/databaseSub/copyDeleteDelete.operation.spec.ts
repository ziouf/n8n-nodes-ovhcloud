...
import { description, execute } from './copyDeleteDelete.operation';
...
describe('copyDeleteDelete.operation', () => {
		...
		describe('execute', () => {
			it('should call DELETE /hosting/web/database/{serviceName}/{databaseName}/copy/{copyId}', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith(`/hosting/web/database/myservice.ovh/mydb/copy/3f2f1e1e-4a3a-4b4b-8c8c-1d1d1d1d1d1d`);
			});
		});
});
