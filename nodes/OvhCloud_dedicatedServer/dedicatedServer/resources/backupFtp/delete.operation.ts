...
/**
 * @brief Delete Backup FTP operation for Dedicated Server
 *
 * Terminates the backup FTP service for a dedicated server.
 *
 * HTTP method: DELETE
 * Endpoint: /dedicated/server/{serviceName}/features/backupFTP
 */
