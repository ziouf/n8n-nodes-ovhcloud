...
/**
 * @brief Reset IPMI Sessions operation for Dedicated Server
 *
 * Resets all IPMI sessions for a dedicated server.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const response = (await client.httpPost(`/dedicated/server/${serviceName}/features/ipmi/resetSessions`)) as IDataObject;
