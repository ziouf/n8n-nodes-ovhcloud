...
/**
 * @brief Get Burst operation for Dedicated Server
 *
 * Retrieves burst settings for a dedicated server.
 *
 * HTTP method: GET
 * Endpoint: /dedicated/server/{serviceName}/burst
 */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicated/server/${serviceName}/burst`)) as IDataObject;
	return [{ json: data }];
}
