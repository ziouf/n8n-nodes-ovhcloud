...
/**
 * @brief List Options operation for Dedicated Server
 *
 * Lists all options for a dedicated server.
 *
 * HTTP method: GET
 * Endpoint: /dedicated/server/{serviceName}/option
 */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicated/server/${serviceName}/option`)) as IDataObject[];
