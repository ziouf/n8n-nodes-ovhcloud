...
/**
 * @brief Get Backup FTP Access operation for Dedicated Server
 *
 * Retrieves details of a specific backup FTP ACL.
 *
 * HTTP method: GET
...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		...
		},
		{
			...
			default: '',
			required: true,
			description: 'The IP block to get ACL details for',
			displayOptions,
		},
	];
}
...
/**
 * Executes the Get Backup FTP Access operation.
 */
