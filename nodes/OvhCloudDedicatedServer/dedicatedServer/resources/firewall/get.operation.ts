...
/**
 * @brief Get Firewall operation for Dedicated Server
 *
 * Retrieves firewall properties for a dedicated server.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicated/server/${serviceName}/features/firewall`)) as IDataObject;
	return [{ json: data }];
}
