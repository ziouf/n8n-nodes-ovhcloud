...
/**
 * @brief Get IPMI operation for Dedicated Server
 *
 * Retrieves IPMI properties for a dedicated server.
 *
 * HTTP method: GET
 * Endpoint: /dedicated/server/{serviceName}/features/ipmi
 */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicated/server/${serviceName}/features/ipmi`)) as IDataObject;
	return [{ json: data }];
}
