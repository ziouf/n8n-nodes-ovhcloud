...
/**
 * @brief List Interventions operation for Dedicated Server
 *
 * Lists intervention history for a dedicated server.
 *
 * HTTP method: GET
 * Endpoint: /dedicated/server/{serviceName}/intervention
 */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicated/server/${serviceName}/intervention`)) as IDataObject[];
