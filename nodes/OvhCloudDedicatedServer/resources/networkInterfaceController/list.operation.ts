...
/**
 * @brief List Network Interface Controllers operation for Dedicated Server
 *
 * Lists all NICs for a dedicated server.
 *
 * HTTP method: GET
 * Endpoint: /dedicated/server/{serviceName}/networkInterfaceController
 */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const linkType = this.getNodeParameter('linkType', 0, '') as string;
