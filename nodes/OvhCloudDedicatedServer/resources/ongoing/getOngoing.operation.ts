...
/**
 * @brief Get Ongoing Tasks operation for Dedicated Server
 *
 * Retrieves ongoing tasks for a dedicated server.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicated/server/${serviceName}/ongoing`)) as IDataObject;
	return [{ json: data }];
}
