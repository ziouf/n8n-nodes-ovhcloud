...
/**
 * Get the properties of a node of a Hadoop cluster.
 *
 * HTTP method: GET
 * Endpoint: /cluster/hadoop/{serviceName}/node/{hostname}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(
		`/cluster/hadoop/${encodeURIComponent(serviceName)}/node/${encodeURIComponent(hostname)}`,
	)) as IDataObject;
