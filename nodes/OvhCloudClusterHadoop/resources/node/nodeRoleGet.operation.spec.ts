...
import { description, execute } from './nodeRoleGet.operation';
...
describe('nodeRoleGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should list node roles via GET', async () => {
			const mockData = ['name_node', 'data_node'];
			...
			expect(result).toEqual([{ type: 'name_node' }, { type: 'data_node' }]);
		});
