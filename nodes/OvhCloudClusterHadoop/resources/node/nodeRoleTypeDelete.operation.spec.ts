...
import { description, execute } from './nodeRoleTypeDelete.operation';
...
describe('nodeRoleTypeDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should remove a role from a node via DELETE with encoded type', async () => {
			const mockData = { type: 'data_node' };
