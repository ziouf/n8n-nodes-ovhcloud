...
import { description, execute } from './orderNewNodeHourlyPost.operation';
...
describe('orderNewNodeHourlyPost.operation', () => {
	describe('description', () => {
		it('should return serviceName and nodeProfile parameters', () => {
	...
	describe('execute', () => {
		...
		it('should order a new node via POST with nodeProfile', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/cluster/hadoop/cluster-12345/orderNewNodeHourly',
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/cluster/hadoop/cluster%201/orderNewNodeHourly',
				{ nodeProfile: 'node-profile-1' },
			);
		});
	});
