...
describe('terminatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should terminate the cluster via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cluster/hadoop/cluster-12345/terminate');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cluster/hadoop/cluster%201/terminate');
		});
	});
});
