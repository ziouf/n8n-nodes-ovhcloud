...
describe('restartPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should restart the cluster via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cluster/hadoop/cluster-12345/restart');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cluster/hadoop/cluster%201/restart');
		});
	});
});
