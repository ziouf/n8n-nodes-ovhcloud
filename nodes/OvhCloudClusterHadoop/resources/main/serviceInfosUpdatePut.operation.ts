...
/**
 * Update the service information of a Hadoop cluster.
 *
 * HTTP method: PUT
 * Endpoint: /cluster/hadoop/{serviceName}/serviceInfos
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	await client.httpPut(`/cluster/hadoop/${encodeURIComponent(serviceName)}/serviceInfos`, body);
