...
import { description, execute } from './stopPost.operation';
...
describe('stopPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should stop the cluster via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cluster/hadoop/cluster-12345/stop');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cluster/hadoop/cluster%201/stop');
		});
	});
});
