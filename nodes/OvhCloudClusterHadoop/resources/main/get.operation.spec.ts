...
describe('get.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get the cluster properties via GET', async () => {
			const mockData = { serviceName: 'cluster-12345', status: 'active' };
			...
			expect(client.httpGet).toHaveBeenCalledWith('/cluster/hadoop/cluster-12345');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/cluster/hadoop/cluster%201');
		});
	});
});
