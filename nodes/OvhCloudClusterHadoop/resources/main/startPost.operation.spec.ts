...
import { description, execute } from './startPost.operation';
...
describe('startPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should start the cluster via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cluster/hadoop/cluster-12345/start');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cluster/hadoop/cluster%201/start');
		});
	});
});
