...
- **API Spec**: https://eu.api.ovh.com/v1/nutanix.json
- **Base Path**: /nutanix
...
├── list.operation.ts      # GET /nutanix
├── get.operation.ts       # GET /nutanix/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getNutanixServices'`)
