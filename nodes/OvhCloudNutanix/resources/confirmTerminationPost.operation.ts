...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const commentaryFutureUse = (this.getNodeParameter('commentaryFutureUse', 0, '') as string) || '';
	const commentaryReason = (this.getNodeParameter('commentaryReason', 0, '') as string) || '';
