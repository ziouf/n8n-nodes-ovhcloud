...
import { description, execute } from './nodesGet.operation';
...
describe('nodesGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/nutanix/svc-1/nodes');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/nutanix/svc%201/nodes');
		});
	});
});
