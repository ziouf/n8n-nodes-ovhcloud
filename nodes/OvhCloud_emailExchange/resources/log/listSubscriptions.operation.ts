...
/** List log subscriptions. GET /email/exchange/{organizationName}/service/{exchangeService}/log/subscription */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/email/exchange/${organizationName}/service/${exchangeService}/log/subscription`)) as IDataObject[];
