...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		destructiveActionNotice('This will permanently confirm the termination of the virtuozzo.', displayOptions),
		{
 ...
 *
 * HTTP method: POST
 * Endpoint: /license/virtuozzo/{serviceName}/confirmTermination
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('/license/virtuozzo/' + encodeURIComponent(serviceName) + '/confirmTermination', body)) as IDataObject;
