 ...
 *
 * HTTP method: POST
 * Endpoint: /license/virtuozzo/{serviceName}/changeIp
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('/license/virtuozzo/' + encodeURIComponent(serviceName) + '/changeIp', body)) as IDataObject;
