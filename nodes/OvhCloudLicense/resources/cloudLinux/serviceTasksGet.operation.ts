 ...
 *
 * HTTP method: GET
 * Endpoint: /license/cloudLinux/{serviceName}/tasks
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('/license/cloudLinux/' + encodeURIComponent(serviceName) + '/tasks', qs)) as IDataObject;
