 ...
 *
 * HTTP method: GET
 * Endpoint: /license/cpanel/{serviceName}/canLicenseBeMovedTo
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('/license/cpanel/' + encodeURIComponent(serviceName) + '/canLicenseBeMovedTo', qs)) as IDataObject;
