...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		destructiveActionNotice('This will permanently confirm the termination of the redhat.', displayOptions),
		{
 ...
 *
 * HTTP method: POST
 * Endpoint: /license/redhat/{serviceName}/confirmTermination
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('/license/redhat/' + encodeURIComponent(serviceName) + '/confirmTermination', body)) as IDataObject;
