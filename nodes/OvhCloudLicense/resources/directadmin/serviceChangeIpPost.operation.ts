 ...
 *
 * HTTP method: POST
 * Endpoint: /license/directadmin/{serviceName}/changeIp
 */
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('/license/directadmin/' + encodeURIComponent(serviceName) + '/changeIp', body)) as IDataObject;
