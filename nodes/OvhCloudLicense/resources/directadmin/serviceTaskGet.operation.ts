 ...
 *
 * HTTP method: GET
 * Endpoint: /license/directadmin/{serviceName}/tasks/{taskId}
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('/license/directadmin/' + encodeURIComponent(serviceName) + '/tasks/' + encodeURIComponent(taskId) + '')) as IDataObject;
