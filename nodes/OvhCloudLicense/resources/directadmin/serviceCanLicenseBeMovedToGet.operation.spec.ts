...
import { description, execute } from './serviceCanLicenseBeMovedToGet.operation';
...
describe('directadmin {serviceName}CanLicenseBeMovedToGET operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string, _idx?: number, def?: any, opts?: any): any => {
				...
				if (param === 'destinationIp') return 'test-destinationIp';
				return def ?? '';
			});
