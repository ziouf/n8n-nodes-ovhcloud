...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		destructiveActionNotice('This will permanently confirm the termination of the directadmin.', displayOptions),
		{
 ...
 *
 * HTTP method: POST
 * Endpoint: /license/directadmin/{serviceName}/confirmTermination
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('/license/directadmin/' + encodeURIComponent(serviceName) + '/confirmTermination', body)) as IDataObject;
