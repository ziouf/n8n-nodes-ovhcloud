...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		destructiveActionNotice('This will terminate the hycu service. This action is irreversible.', displayOptions),
		{
...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('/license/hycu/' + encodeURIComponent(serviceName) + '/terminate', body)) as IDataObject;
