 ...
 *
 * HTTP method: GET
 * Endpoint: /license/windows/{serviceName}/tasks/{taskId}
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('/license/windows/' + encodeURIComponent(serviceName) + '/tasks/' + encodeURIComponent(taskId) + '')) as IDataObject;
