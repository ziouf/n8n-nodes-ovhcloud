...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		destructiveActionNotice('This will permanently confirm the termination of the sqlserver.', displayOptions),
		{
			...
			required: true,
			description: 'The Sqlserver license service name',
			modes: [
				{
 ...
 *
 * HTTP method: POST
 * Endpoint: /license/sqlserver/{serviceName}/confirmTermination
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('/license/sqlserver/' + encodeURIComponent(serviceName) + '/confirmTermination', body)) as IDataObject;
