...
import { description, execute } from './managedCMSresourcewebsiteresetDatabasePasswordCreatePost.operation';
...
describe('managedCMSresourcewebsiteresetDatabasePasswordCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'serviceId') return 'test-serviceId-id';
			if (param === 'websiteId') return 'test-websiteId-id';
				return '';
			});
