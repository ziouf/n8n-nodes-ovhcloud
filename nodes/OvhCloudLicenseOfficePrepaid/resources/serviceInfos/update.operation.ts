...
/**
 * Update service information for a OfficePrepaid license.
 *
 * HTTP method: PUT
	...
	return [
		{
			...
			default: '',
			required: true,
			description: 'The name of the OfficePrepaid license service',
			displayOptions,
		},
		{
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	await client.httpPut(`/license/officePrepaid/${serviceName}/serviceInfos`, { body });
