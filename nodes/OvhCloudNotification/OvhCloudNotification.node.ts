...
export class OvhCloudNotification implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'OVH Cloud V2 Notification',
		name: 'ovhCloudnotification',
		icon: OvhCloudIcon,
		group: ['input'],
		version: 1,
		subtitle: '={{$parameter["notificationOperation"]}}',
		description: 'Manage OVH V2 Notification services',
		defaults: {
			name: 'OVH Cloud V2 Notification',
		},
		usableAsTool: true,
