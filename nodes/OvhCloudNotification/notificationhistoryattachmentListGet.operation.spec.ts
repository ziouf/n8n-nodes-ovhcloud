...
import { description, execute } from './notificationhistoryattachmentListGet.operation';
...
describe('notificationhistoryattachmentListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'notificationId') return 'test-notificationId-id';
			if (param === 'attachmentName') return 'test-attachmentName-id';
				return '';
			});
