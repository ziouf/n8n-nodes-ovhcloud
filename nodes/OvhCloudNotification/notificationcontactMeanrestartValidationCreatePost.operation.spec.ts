...
import { description, execute } from './notificationcontactMeanrestartValidationCreatePost.operation';
...
describe('notificationcontactMeanrestartValidationCreatePost operation', () => {
