...
- **API Spec**: https://eu.api.ovh.com/v1/xdsl.json
- **Base Path**: /xdsl
...
├── list.operation.ts      # GET /xdsl
├── get.operation.ts       # GET /xdsl/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getXdslServices'`)
