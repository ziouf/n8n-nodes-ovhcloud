...
import { description, execute } from './dslamPortChangeProfilePost.operation';
...
describe('dslamPortChangeProfilePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/xdsl/svc-1/lines/sample-value/dslamPort/changeProfile', { profileId: 12345 });
		...
		it('should encode special characters in path parameters', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/xdsl/svc%201/lines/alternate-value/dslamPort/changeProfile', { profileId: 98765 });
		});
	});
});