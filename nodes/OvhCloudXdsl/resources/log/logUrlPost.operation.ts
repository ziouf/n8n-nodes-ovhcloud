...
/**
 * Generate a temporary URL to retrieve the logs of an xDSL service.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/xdsl/${encodeURIComponent(serviceName)}/log/url`, body)) as IDataObject;
