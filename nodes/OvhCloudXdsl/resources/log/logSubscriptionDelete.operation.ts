...
/**
 * Delete a specific log subscription of an xDSL service.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete(`/xdsl/${encodeURIComponent(serviceName)}/log/subscription/${encodeURIComponent(subscriptionId)}`)) as IDataObject;
