...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/xdsl/${encodeURIComponent(serviceName)}/modem/lan/${lanId}/dhcp/${dhcpId}/DHCPStaticAddresses`)) as IDataObject;
