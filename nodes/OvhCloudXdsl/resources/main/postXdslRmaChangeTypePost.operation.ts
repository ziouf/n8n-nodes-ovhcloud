 ...
 *
 * HTTP method: POST
 * Endpoint: /xdsl/{serviceName}/rma/{rmaId}/changeType
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/xdsl/${encodeURIComponent(serviceName)}/rma/${rmaId}/changeType`, {})) as IDataObject;
