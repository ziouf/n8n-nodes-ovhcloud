...
describe('changeContactPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/xdsl/svc-1/changeContact', { contactAdmin: 'sample-value', contactBilling: 'sample-value', contactTech: 'sample-value' });
		...
		it('should encode special characters in path parameters', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/xdsl/svc%201/changeContact', { contactAdmin: 'alternate-value', contactBilling: 'alternate-value', contactTech: 'alternate-value' });
		});
	});
});