...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const staticId = this.getNodeParameter('staticId', 0) as string;

	const data = (await client.httpPut(`/xdsl/${encodeURIComponent(serviceName)}/modem/lan/${lanId}/dhcp/${dhcpId}/DHCPStaticAddresses/${staticId}`, {})) as IDataObject;
