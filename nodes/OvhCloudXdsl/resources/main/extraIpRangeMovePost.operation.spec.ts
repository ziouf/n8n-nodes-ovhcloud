...
import { description, execute } from './extraIpRangeMovePost.operation';
...
describe('extraIpRangeMovePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/xdsl/svc-1/addressMove/extraIpRangeMove', { extraIpRange: 'sample-value' });
		...
		it('should encode special characters in path parameters', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/xdsl/svc%201/addressMove/extraIpRangeMove', { extraIpRange: 'alternate-value' });
		});
	});
});