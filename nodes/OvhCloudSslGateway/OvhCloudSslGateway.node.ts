...
export class OvhCloudSslGateway extends BaseNode implements INodeType {
		...
		return executeTemplate.call(this, execute, {
			perItemConcurrency: {
				classify: (ctx, itemIndex) =>
					classifyOperation(
						String(ctx.getNodeParameter('sslGatewayOperation', itemIndex, { extractValue: true })),
					),
			},
			errorContext: { resource: 'sslgateway', operationParam: 'sslGatewayOperation' },
		});
	}
}
