# HorizonView Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v1/horizonView.json
- **Base Path**: /horizonView
...
├── list.operation.ts      # GET /horizonView
├── get.operation.ts       # GET /horizonView/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getHorizonViewServices'`)
