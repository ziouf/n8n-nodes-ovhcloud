...
/**
 * Disable the storage accelerator option on the dedicated Horizon component.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(
		`/horizonView/${encodeURIComponent(serviceName)}/dedicatedHorizon/disableStorageAccelerator`,
	)) as IDataObject;
