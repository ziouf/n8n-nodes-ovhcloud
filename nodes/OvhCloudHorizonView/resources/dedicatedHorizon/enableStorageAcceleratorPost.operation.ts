...
/**
 * Enable the storage accelerator option on the dedicated Horizon component.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(
		`/horizonView/${encodeURIComponent(serviceName)}/dedicatedHorizon/enableStorageAccelerator`,
	)) as IDataObject;
