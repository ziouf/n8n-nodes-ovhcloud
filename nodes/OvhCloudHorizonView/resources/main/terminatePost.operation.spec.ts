...
describe('terminatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should ask for termination via POST', async () => {
			const mockData = { token: 'terminationToken' };
			...
			expect(client.httpPost).toHaveBeenCalledWith('/horizonView/service1/terminate');
