...
describe('serviceInfosGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get service infos via GET', async () => {
			const mockData = { serviceId: 12345, canDeleteAtExpiration: false };
			...
			expect(client.httpGet).toHaveBeenCalledWith('/horizonView/service1/serviceInfos');
