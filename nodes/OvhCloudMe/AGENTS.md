...
- **API Spec**: https://eu.api.ovh.com/v1/me.json
- **Base Path**: /me
...
├── list.operation.ts      # GET /me
├── get.operation.ts       # GET /me/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getMeServices'`)
