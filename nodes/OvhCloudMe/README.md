...
| [`financial`](./`operations/financial.ts`)                 | GET    | `/me/credit/balance/{...}`             | 1     | ✅ `dateRange`, `ids` (List Deposits) |
| [`notification`](./`operations/notification.ts`)           | GET    | `/me/notification/email/history/{...}` | 0     | —                                     |
| [`partner`](./`operations/partner.ts`)                     | GET    | `/me/sla/{...}`                        | 0     | —                                     |
| [`payment`](./`operations/payment.ts`)                     | GET    | `/me/payment/method/{...}`             | 1     | ✅ `status` (List Bank Accounts)      |
| [`telecom`](./`operations/telecom.ts`)                     | GET    | `/me/fax/customDomains/{...}`          | 0     | —                                     |

**Total:** 12 operations, 3 tests

> **Optional filters**: Three list operations support optional Filters blocks (see [docs/_shared/filtering.md](../../docs/_shared/filtering.md)).
