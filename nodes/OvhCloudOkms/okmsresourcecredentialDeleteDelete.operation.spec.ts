...
import { description, execute } from './okmsresourcecredentialDeleteDelete.operation';
...
describe('okmsresourcecredentialDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'credentialId') return 'test-credentialId-id';
				return '';
			});
