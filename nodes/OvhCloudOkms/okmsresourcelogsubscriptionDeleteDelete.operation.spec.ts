...
import { description, execute } from './okmsresourcelogsubscriptionDeleteDelete.operation';
...
describe('okmsresourcelogsubscriptionDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'subscriptionId') return 'test-subscriptionId-id';
				return '';
			});
