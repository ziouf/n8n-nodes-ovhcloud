...
import { description, execute } from './okmsresourcesecretversionUpdatePut.operation';
...
describe('okmsresourcesecretversionUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'okmsId') return 'test-okmsId-id';
			if (param === 'path') return 'test-path-id';
			if (param === 'version') return 'test-version-id';
				return '';
			});
