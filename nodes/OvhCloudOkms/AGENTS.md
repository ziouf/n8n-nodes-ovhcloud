...
- **API Spec**: https://eu.api.ovh.com/v2/okms.json
- **Base Path**: /v2/okms
...
├── list.operation.ts      # GET /v2/okms
└── get.operation.ts       # GET /v2/okms/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2OkmsServices'`)
