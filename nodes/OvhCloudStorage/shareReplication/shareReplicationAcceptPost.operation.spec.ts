...
import { description, execute } from './shareReplicationAcceptPost.operation';
...
describe('shareReplicationAcceptPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				...
				if (param === 'shareReplicationId') return 'replication-1';
			...
			expect(client.httpPost).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/shareReplication/replication-1/accept', { description: "value", mountPointName: "value", name: "value", protocol: "value", size: 0 });
		});
	});
});
