...
import { description, execute } from './shareReplicationListGet.operation';
...
describe('shareReplicationListGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/shareReplication');
		});
	});
});
