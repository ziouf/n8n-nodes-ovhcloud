...
import { description, execute } from './shareReplicationGetGet.operation';
...
describe('shareReplicationGetGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/shareReplication/replication-1');
		});
	});
});
