...
import { description, execute } from './shareShrinkPost.operation';
...
describe('shareShrinkPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1/shrink', { size: 0 });
		});
	});
});
