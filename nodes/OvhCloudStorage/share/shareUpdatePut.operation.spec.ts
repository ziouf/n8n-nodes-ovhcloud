...
import { description, execute } from './shareUpdatePut.operation';
...
describe('shareUpdatePut.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1', { description: "value", name: "value" });
		});
	});
});
