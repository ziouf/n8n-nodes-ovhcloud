...
import { description, execute } from './shareDeleteDelete.operation';
...
describe('shareDeleteDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1');
		});
	});
});
