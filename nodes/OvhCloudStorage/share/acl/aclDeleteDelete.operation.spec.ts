...
import { description, execute } from './aclDeleteDelete.operation';
...
describe('aclDeleteDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1/acl/acl-1');
		});
	});
});
