...
describe('snapshotCreatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1/snapshot', { description: "value", name: "value", type: "value" });
		});
	});
});
