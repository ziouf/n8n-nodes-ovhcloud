...
import { description, execute } from './shareSnapshotReserveGet.operation';
...
describe('shareSnapshotReserveGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1/snapshotReserve');
		});
	});
});
