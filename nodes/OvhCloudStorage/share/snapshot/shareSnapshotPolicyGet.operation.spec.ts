...
import { description, execute } from './shareSnapshotPolicyGet.operation';
...
describe('shareSnapshotPolicyGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1/snapshotPolicy');
		});
	});
});
