...
import { description, execute } from './snapshotHoldPost.operation';
...
describe('snapshotHoldPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1/snapshot/snapshot-1/hold');
		});
	});
});
