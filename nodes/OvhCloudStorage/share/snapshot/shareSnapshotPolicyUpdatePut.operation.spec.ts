...
import { description, execute } from './shareSnapshotPolicyUpdatePut.operation';
...
describe('shareSnapshotPolicyUpdatePut.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				...
				if (param === 'snapshotPolicyID') return 'value';
				return undefined;
			});
			...
			expect(client.httpPut).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1/snapshotPolicy', { snapshotPolicyID: "value" });
		});
	});
});
