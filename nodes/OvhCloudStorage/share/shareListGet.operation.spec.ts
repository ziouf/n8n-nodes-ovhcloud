...
import { description, execute } from './shareListGet.operation';
...
describe('shareListGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				...
				if (param === 'mountPointName') return '';
				return undefined;
			});
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share', {});
		});
	});
});
