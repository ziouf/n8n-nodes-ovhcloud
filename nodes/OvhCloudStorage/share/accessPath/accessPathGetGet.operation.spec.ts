...
import { description, execute } from './accessPathGetGet.operation';
...
describe('accessPathGetGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				if (param === 'accessPathId') return 'accesspath-1';
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/share/share-1/accessPath/accesspath-1');
		});
	});
});
