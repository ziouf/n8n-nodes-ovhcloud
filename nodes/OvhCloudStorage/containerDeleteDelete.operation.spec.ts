...
import { description, execute } from './containerDeleteDelete.operation';
...
describe('containerDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'containerId') return 'test-containerId-id';
				return '';
			});
