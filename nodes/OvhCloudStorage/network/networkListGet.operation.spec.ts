...
import { description, execute } from './networkListGet.operation';
...
describe('networkListGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/network', {});
		});
	});
});
