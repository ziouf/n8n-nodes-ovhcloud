...
import { description, execute } from './snapshotPolicyGetGet.operation';
...
describe('snapshotPolicyGetGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/snapshotPolicy/snappol-1');
		});
	});
});
