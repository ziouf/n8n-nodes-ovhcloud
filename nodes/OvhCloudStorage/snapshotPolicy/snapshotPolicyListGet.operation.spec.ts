...
import { description, execute } from './snapshotPolicyListGet.operation';
...
describe('snapshotPolicyListGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/snapshotPolicy');
		});
	});
});
