...
import { description, execute } from './snapshotPolicyUpdatePut.operation';
...
describe('snapshotPolicyUpdatePut.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/snapshotPolicy/snappol-1', { description: "value", name: "value" });
		});
	});
});
