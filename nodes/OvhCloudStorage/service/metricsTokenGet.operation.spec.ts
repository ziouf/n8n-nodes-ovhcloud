...
import { description, execute } from './metricsTokenGet.operation';
...
describe('metricsTokenGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/storage/netapp/pcc-123-456-789/metricsToken');
		});
	});
});
