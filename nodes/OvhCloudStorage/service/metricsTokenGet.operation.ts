 ...
 *
 * HTTP method: GET
 * Endpoint: /storage/netapp/{serviceName}/metricsToken
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/storage/netapp/${encodeURIComponent(serviceName)}/metricsToken`)) as IDataObject;
