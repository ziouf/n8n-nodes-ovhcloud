...
- **API Spec**: https://eu.api.ovh.com/v1/startup.json
- **Base Path**: /startup
...
├── list.operation.ts      # GET /startup
├── get.operation.ts       # GET /startup/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getStartupServices'`)
