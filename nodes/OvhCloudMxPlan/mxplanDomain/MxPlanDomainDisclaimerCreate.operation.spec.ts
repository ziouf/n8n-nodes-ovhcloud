...
import { description, execute } from './MxPlanDomainDisclaimerCreate.operation';
...
describe('MxPlanDomainDisclaimerCreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'domainName') return 'domainName-test';
			if (param === 'service') return 'service-test';
			if (param === 'content') return 'content-test';
			if (param === 'outsideOnly') return 'outsideOnly-test';
				return '';
			});
