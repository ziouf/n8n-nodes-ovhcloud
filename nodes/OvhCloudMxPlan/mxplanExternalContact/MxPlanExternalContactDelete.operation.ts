	...
	return [
		{
			...
			displayOptions: {
				show: {
					mxPlanOperation: ['MxPlanExternalContactDelete'],
				},
				...displayOptions,
			},
		},
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete('/email' + '/mxplan/' + encodeURIComponent(service) + '/externalContact/' + encodeURIComponent(externalEmailAddress))) as IDataObject;
