...
import { description, execute } from './MxPlanExternalContactCreate.operation';
...
describe('MxPlanExternalContactCreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'hiddenFromGAL') return 'hiddenFromGAL-test';
			if (param === 'initials') return 'initials-test';
