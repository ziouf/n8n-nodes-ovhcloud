...
import { description, execute } from './MxPlanAccountList.operation';
...
describe('MxPlanAccountList operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'primaryEmailAddress') return 'primaryEmailAddress-test';
				return '';
			});
