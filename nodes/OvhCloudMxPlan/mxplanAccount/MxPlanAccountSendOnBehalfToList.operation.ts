	...
	return [
		{
			...
			displayOptions: {
				show: {
					mxPlanOperation: ['MxPlanAccountSendOnBehalfToList'],
				},
				...displayOptions,
			},
		},
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('/email' + '/mxplan/' + encodeURIComponent(service) + '/account/' + encodeURIComponent(email) + '/sendOnBehalfTo')) as IDataObject;
