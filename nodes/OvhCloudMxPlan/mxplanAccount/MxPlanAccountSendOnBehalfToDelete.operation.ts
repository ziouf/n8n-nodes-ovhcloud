	...
	return [
		{
			...
			displayOptions: {
				show: {
					mxPlanOperation: ['MxPlanAccountSendOnBehalfToDelete'],
				},
				...displayOptions,
			},
		},
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete('/email' + '/mxplan/' + encodeURIComponent(service) + '/account/' + encodeURIComponent(email) + '/sendOnBehalfTo/' + encodeURIComponent(allowedAccountId))) as IDataObject;
