...
import { description, execute } from './MxPlanAccountSendOnBehalfToCreate.operation';
...
describe('MxPlanAccountSendOnBehalfToCreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'allowAccountId') return 'allowAccountId-test';
				return '';
			});
