...
import { description, execute } from './MxPlanAccountSendOnBehalfToDelete.operation';
...
describe('MxPlanAccountSendOnBehalfToDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'allowedAccountId') return 'allowedAccountId-test';
