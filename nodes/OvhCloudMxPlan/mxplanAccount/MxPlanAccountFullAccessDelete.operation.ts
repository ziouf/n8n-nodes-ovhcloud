	...
	return [
		{
			...
			displayOptions: {
				show: {
					mxPlanOperation: ['MxPlanAccountFullAccessDelete'],
				},
				...displayOptions,
			},
		},
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete('/email' + '/mxplan/' + encodeURIComponent(service) + '/account/' + encodeURIComponent(email) + '/fullAccess/' + encodeURIComponent(allowedAccountId))) as IDataObject;
