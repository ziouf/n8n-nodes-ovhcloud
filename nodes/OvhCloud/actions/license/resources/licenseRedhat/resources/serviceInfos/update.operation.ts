...
/**
 * Update service information for a Redhat license.
 *
 * HTTP method: PUT
 * Endpoint: /license/redhat/{serviceName}/serviceInfos
 */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	await client.httpPut(`/license/redhat/${serviceName}/serviceInfos`, { body });
