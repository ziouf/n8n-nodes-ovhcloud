	...
	return [
		{
			...
			default: '',
			required: true,
			description: 'The ID of the eligibility recall to update',
			displayOptions,
		},
		{
...
/**
 * Executes the Update Eligibility Recall operation.
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut(`/connectivity/eligibility/recall/${id}`, {
		body,
	})) as IDataObject;
	return [{ json: data }];
}
