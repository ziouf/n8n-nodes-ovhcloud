...
/**
 * @brief List Glue Records operation
 *
 * Lists glue records for a domain.
 *
 * HTTP method: GET
...
/**
 * Executes the List Glue Records operation.
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/domain/${serviceName}/glueRecord`, qs)) as IDataObject[];
