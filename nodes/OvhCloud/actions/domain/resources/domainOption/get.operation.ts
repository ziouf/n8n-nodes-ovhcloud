...
/**
 * @brief Get Domain Option operation
 *
 * Retrieves a specific domain option.
 *
 * HTTP method: GET
...
/**
 * Executes the Get Domain Option operation.
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/domain/${serviceName}/option/${option}`)) as IDataObject;
	return [{ json: data }];
}
