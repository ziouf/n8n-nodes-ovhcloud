...
/**
 * @brief Delete Name Server operation
 *
 * Deletes a name server from a domain.
 *
 * HTTP method: DELETE
...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		...
		},
		{
			...
			default: '',
			required: true,
			description: 'The ID of the name server to delete',
			displayOptions,
		},
	];
}
...
/**
 * Executes the Delete Name Server operation.
 */
