...
/**
 * @brief Get Name Server operation
 *
 * Retrieves a specific name server by ID.
 *
 * HTTP method: GET
...
/**
 * Executes the Get Name Server operation.
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/domain/${serviceName}/nameServer/${id}`)) as IDataObject;
	return [{ json: data }];
}
