...
- **API Spec**: https://eu.api.ovh.com/v1/vps.json
- **Base Path**: /vps
...
├── list.operation.ts      # GET /vps
├── get.operation.ts       # GET /vps/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getVpsServices'`)
