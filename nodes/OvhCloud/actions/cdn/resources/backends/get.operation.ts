...
/**
 * @brief Get CDN Backend operation
 *
 * Retrieves details of a specific backend for a domain on a CDN Dedicated service.
 *
 * HTTP method: GET
 * Endpoint: /cdn/dedicated/{serviceName}/domains/{domain}/backends/{ip}
 */
export function descriptionBackendsGet(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		{
...
/**
 * Executes the Get CDN Backend operation.
 *
 * @param this - n8n IExecuteFunctions context
 * @returns Array of execution results containing backend details
 */
export async function executeBackendsGet(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
