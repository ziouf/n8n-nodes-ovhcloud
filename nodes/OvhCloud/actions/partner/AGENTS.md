...
- **API Spec**: https://eu.api.ovh.com/v1/partner.json
- **Base Path**: /partner
...
├── list.operation.ts      # GET /partner
├── get.operation.ts       # GET /partner/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getPartnerServices'`)
