/**
 * @brief Enable Database Extension operation for private database
 *
 * HTTP POST request to `/hosting/privateDatabase/{serviceName}/database/{databaseName}/extension/{extensionName}/enable` endpoint.
 */
import type {
	IExecuteFunctions,
	INodeExecutionData,
