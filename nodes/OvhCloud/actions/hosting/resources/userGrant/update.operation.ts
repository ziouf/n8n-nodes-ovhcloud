/**
 * @brief Update User Grant operation for private database
 *
 * HTTP POST request to `/hosting/privateDatabase/{serviceName}/user/{userName}/grant/{databaseName}/update` endpoint.
 */
import type {
	IExecuteFunctions,
	INodeExecutionData,
