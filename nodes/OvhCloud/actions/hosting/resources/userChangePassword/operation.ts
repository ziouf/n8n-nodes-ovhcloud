/**
 * @brief Change User Password operation for private database
 *
 * HTTP POST request to `/hosting/privateDatabase/{serviceName}/user/{userName}/changePassword` endpoint.
 */
import type {
	IExecuteFunctions,
	INodeExecutionData,
