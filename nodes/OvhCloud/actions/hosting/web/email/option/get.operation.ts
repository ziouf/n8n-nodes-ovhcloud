 ...
 *
 * HTTP GET request to `/hosting/web/{serviceName}/emailOption/{id}` endpoint.
 *
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/hosting/web/${serviceName}/emailOption/${id}`)) as IDataObject;
	return [{ json: data }];
}
