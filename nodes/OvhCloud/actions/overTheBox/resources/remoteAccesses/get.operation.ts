...
/** Get remote access details. HTTP: GET /overTheBox/{serviceName}/remoteAccesses/{remoteAccessId} */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/overTheBox/${serviceName}/remoteAccesses/${remoteAccessId}`)) as IDataObject;
	return [{ json: data }];
}
