...
/** List remote accesses for the service. HTTP: GET /overTheBox/{serviceName}/remoteAccesses */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/overTheBox/${serviceName}/remoteAccesses`)) as IDataObject[];
