...
/** Cancel the resiliation of an OverTheBox service. HTTP: POST /overTheBox/{serviceName}/cancelResiliation */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/overTheBox/${serviceName}/cancelResiliation`)) as IDataObject;
	return [{ json: data }];
}
