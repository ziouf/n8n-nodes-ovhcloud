...
/** Delete a backup. HTTP: DELETE /overTheBox/{serviceName}/backups/{backupId} */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete(`/overTheBox/${serviceName}/backups/${backupId}`)) as IDataObject;
	return [{ json: data }];
}
