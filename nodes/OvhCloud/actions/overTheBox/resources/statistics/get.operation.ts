...
/** Get statistics for an OTB device. HTTP: GET /overTheBox/{serviceName}/statistics */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/overTheBox/${serviceName}/statistics`)) as IDataObject;
	return [{ json: data }];
}
