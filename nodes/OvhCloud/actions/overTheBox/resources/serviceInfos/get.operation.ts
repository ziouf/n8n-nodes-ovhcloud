...
/** Get service information for an OverTheBox service. HTTP: GET /overTheBox/{serviceName}/serviceInfos */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/overTheBox/${serviceName}/serviceInfos`)) as IDataObject;
	return [{ json: data }];
}
