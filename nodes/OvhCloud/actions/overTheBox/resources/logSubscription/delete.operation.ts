...
/** Delete a subscription. HTTP: DELETE /overTheBox/{serviceName}/log/subscription/{subscriptionId} */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete(`/overTheBox/${serviceName}/log/subscription/${subscriptionId}`)) as IDataObject;
	return [{ json: data }];
}
