...
/**
 * @brief Change Backup FTP Password operation for Dedicated Server
 *
 * Changes the password for the backup FTP service.
 *
 * HTTP method: POST
 * Endpoint: /dedicated/server/{serviceName}/features/backupFTP/password
 */
