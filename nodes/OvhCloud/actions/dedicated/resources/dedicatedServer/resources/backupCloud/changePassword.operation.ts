...
/**
 * @brief Change Backup Cloud Password operation for Dedicated Server
 *
 * Changes the password for the backup cloud service.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const response = (await client.httpPost(`/dedicated/server/${serviceName}/features/backupCloud/password`)) as IDataObject;
