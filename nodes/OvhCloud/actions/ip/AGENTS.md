...
- **API Spec**: https://eu.api.ovh.com/v1/ip.json
- **Base Path**: /ip
...
├── list.operation.ts      # GET /ip
├── get.operation.ts       # GET /ip/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getIpServices'`)
