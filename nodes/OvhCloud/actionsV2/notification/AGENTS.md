# V2 Notification Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v2/notification.json
- **Base Path**: /v2/notification
...
├── list.operation.ts      # GET /v2/notification
└── get.operation.ts       # GET /v2/notification/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2NotificationServices'`)
