...
- **API Spec**: https://eu.api.ovh.com/v2/zimbra.json
- **Base Path**: /v2/zimbra
...
├── list.operation.ts      # GET /v2/zimbra
└── get.operation.ts       # GET /v2/zimbra/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2ZimbraServices'`)
