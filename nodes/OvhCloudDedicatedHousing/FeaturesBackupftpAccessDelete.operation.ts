...
export async function execute(this: IExecuteFunctions,
	...
	const data = (await client.httpDelete('/dedicated/housing/' + encodeURIComponent(serviceName) + '/features/backupFTP/access/' + encodeURIComponent(ipBlock))) as IDataObject;
