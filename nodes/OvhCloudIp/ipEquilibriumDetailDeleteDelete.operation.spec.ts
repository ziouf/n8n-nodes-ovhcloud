...
import { description, execute } from './ipEquilibriumDetailDeleteDelete.operation';
...
describe('ipEquilibriumDetailDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'ip') return 'test-ip-id';
			if (param === 'equilibrium') return 'test-equilibrium-id';
				return '';
			});
