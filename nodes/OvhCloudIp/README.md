...
| ipFirewallRuleListGet      | GET    | `/ip/{ip}/firewall/{ipOnFirewall}/rule`            | ✅ `state` |
...
> **Optional filters**: The **Firewall Rule List** operation (`ipFirewallRuleListGet`) supports optional Filters (state). See [docs/_shared/filtering.md](../../docs/_shared/filtering.md) for details.
