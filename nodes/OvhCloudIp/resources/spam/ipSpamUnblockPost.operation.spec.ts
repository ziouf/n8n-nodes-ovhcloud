...
import { description, execute } from './ipSpamUnblockPost.operation';
...
describe('ipSpamUnblockPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/spam/5.6.7.13/unblock', {});
