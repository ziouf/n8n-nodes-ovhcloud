...
import { description, execute } from './ipMitigationCreatePost.operation';
...
describe('ipMitigationCreatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/mitigation', {
				ipOnMitigation: '5.6.7.11',
			});
