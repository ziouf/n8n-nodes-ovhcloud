...
import { description, execute } from './ipMitigationUpdatePut.operation';
...
describe('ipMitigationUpdatePut.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/mitigation/5.6.7.11', {
				permanent: true,
			});
