...
import { description, execute } from './ipMitigationGetGet.operation';
...
describe('ipMitigationGetGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/mitigation/5.6.7.11');
