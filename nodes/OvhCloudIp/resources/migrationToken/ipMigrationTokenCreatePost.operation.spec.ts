...
import { description, execute } from './ipMigrationTokenCreatePost.operation';
...
describe('ipMigrationTokenCreatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/migrationToken', {
				customerId: 'xx11111-ovh',
			});
