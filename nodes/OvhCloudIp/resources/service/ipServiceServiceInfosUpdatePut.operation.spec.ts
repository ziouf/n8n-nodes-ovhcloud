...
import { description, execute } from './ipServiceServiceInfosUpdatePut.operation';
...
describe('ipServiceServiceInfosUpdatePut.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/ip/service/ip-12345/serviceInfos', {});
