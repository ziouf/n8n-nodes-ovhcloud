...
import { description, execute } from './ipServiceGetGet.operation';
...
describe('ipServiceGetGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ip/service/ip-12345');
