...
import { description, execute } from './ipServiceConfirmTerminationPost.operation';
...
describe('ipServiceConfirmTerminationPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ip/service/ip-12345/confirmTermination', {
				token: 'abc123',
