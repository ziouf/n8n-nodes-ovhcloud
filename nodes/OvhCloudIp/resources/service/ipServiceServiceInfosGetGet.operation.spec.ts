...
import { description, execute } from './ipServiceServiceInfosGetGet.operation';
...
describe('ipServiceServiceInfosGetGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ip/service/ip-12345/serviceInfos');
