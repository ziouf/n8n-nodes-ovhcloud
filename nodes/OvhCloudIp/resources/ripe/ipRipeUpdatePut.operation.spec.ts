...
import { description, execute } from './ipRipeUpdatePut.operation';
...
describe('ipRipeUpdatePut.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/ripe', {
				description: 'My IP',
				netname: 'MY-NET',
			});
