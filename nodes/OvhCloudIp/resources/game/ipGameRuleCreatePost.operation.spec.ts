...
import { description, execute } from './ipGameRuleCreatePost.operation';
...
describe('ipGameRuleCreatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/game/5.6.7.10/rule', {
				ports: '27015-27030',
				protocol: 'tcp',
			});
