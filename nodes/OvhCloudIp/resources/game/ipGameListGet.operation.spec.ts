...
import { description, execute } from './ipGameListGet.operation';
...
describe('ipGameListGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/game');
