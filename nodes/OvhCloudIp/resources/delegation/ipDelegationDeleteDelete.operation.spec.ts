...
import { description, execute } from './ipDelegationDeleteDelete.operation';
...
describe('ipDelegationDeleteDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/delegation/ns1.ovh.net');
