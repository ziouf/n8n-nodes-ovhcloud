...
import { description, execute } from './ipTerminatePost.operation';
...
describe('ipTerminatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/terminate', {});
