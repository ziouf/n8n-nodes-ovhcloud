...
import { description, execute } from './ipReverseListGet.operation';
...
describe('ipReverseListGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/reverse');
