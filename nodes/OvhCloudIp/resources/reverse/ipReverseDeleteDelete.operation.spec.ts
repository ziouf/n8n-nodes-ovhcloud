...
import { description, execute } from './ipReverseDeleteDelete.operation';
...
describe('ipReverseDeleteDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/reverse/5.6.7.14');
