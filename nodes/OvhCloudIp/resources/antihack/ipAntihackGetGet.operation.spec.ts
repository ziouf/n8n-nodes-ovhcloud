...
import { description, execute } from './ipAntihackGetGet.operation';
...
describe('ipAntihackGetGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/antihack/5.6.7.8');
