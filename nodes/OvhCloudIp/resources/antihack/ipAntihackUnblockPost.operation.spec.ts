...
import { description, execute } from './ipAntihackUnblockPost.operation';
...
describe('ipAntihackUnblockPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/antihack/5.6.7.8/unblock', {});
