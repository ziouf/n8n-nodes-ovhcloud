...
import { description, execute } from './ipMitigationProfilesDeleteDelete.operation';
...
describe('ipMitigationProfilesDeleteDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/mitigationProfiles/5.6.7.12');
