...
import { description, execute } from './ipFirewallGetGet.operation';
...
describe('ipFirewallGetGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/firewall/5.6.7.9');
