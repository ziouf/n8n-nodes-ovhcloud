...
import { description, execute } from './ipFirewallDeleteDelete.operation';
...
describe('ipFirewallDeleteDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/firewall/5.6.7.9');
