...
import { description, execute } from './ipFirewallRuleCreatePost.operation';
...
describe('ipFirewallRuleCreatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/firewall/5.6.7.9/rule', {
				action: 'permit',
				protocol: 'tcp',
				sequence: '5',
			});
