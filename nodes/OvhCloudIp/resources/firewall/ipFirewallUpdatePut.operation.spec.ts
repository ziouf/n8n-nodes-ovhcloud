...
import { description, execute } from './ipFirewallUpdatePut.operation';
...
describe('ipFirewallUpdatePut.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/ip/1.2.3.4%2F32/firewall/5.6.7.9', {
				enabled: true,
			});
