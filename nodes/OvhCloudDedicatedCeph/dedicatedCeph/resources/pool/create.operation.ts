/**
 * @brief Create a pool for a Dedicated Ceph cluster
 *
 * Creates a new pool:
 * - HTTP POST request to `/dedicated/ceph/{serviceName}/pool` endpoint
 * - Body: poolName (string) required
 */
import type {
	IDataObject,
	IDisplayOptions,
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = await client.httpPost(`/dedicated/ceph/${serviceName}/pool`, {
		poolName,
	});
