...
import { description, execute } from './resetPasswordPost.operation';
...
describe('resetPasswordPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/veeamCloudConnect/svc-1/resetPassword');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/veeamCloudConnect/svc%201/resetPassword');
		});
	});
});
