...
import { description, execute } from './backupRepositoryPost.operation';
...
describe('backupRepositoryPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/veeamCloudConnect/svc-1/backupRepository', {
				quota: 100,
			});
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/veeamCloudConnect/svc%201/backupRepository',
				{},
			);
		});
	});
