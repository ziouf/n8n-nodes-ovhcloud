...
import { description, execute } from './backupRepositoryUpgradeQuotaPost.operation';
...
describe('backupRepositoryUpgradeQuotaPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/veeamCloudConnect/svc-1/backupRepository/inventoryName-v/upgradeQuota',
				{ newQuota: 200 },
			);
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/veeamCloudConnect/svc%201/backupRepository/inventoryName-v/upgradeQuota',
				{},
			);
		});
	});
