...
describe('serviceInfosUpdatePut.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via PUT', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/veeamCloudConnect/svc-1/serviceInfos', {
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/veeamCloudConnect/svc%201/serviceInfos', {});
		});
	});
});
