...
import { description, execute } from './capabilitiesGet.operation';
...
describe('capabilitiesGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/veeamCloudConnect/svc-1/capabilities');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/veeamCloudConnect/svc%201/capabilities');
		});
	});
});
