...
- **API Spec**: https://eu.api.ovh.com/v1/allDom.json
- **Base Path**: /allDom
...
├── list.operation.ts      # GET /allDom
├── get.operation.ts       # GET /allDom/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getAllDomServices'`)
