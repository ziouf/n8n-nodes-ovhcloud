 ...
 *
 * Retrieves detailed information for a specific AllDom service:
 * - HTTP GET request to `/allDom/{serviceName}` endpoint
...
/**
 * Executes the Get AllDom Service operation.
 *
 * Retrieves detailed information for a specific AllDom service.
 *
 * HTTP method: GET
 * Endpoint: /allDom/{serviceName.value}
 *
