...
/**
 * Executes the EasyHuntingHuntingQueueAgentDelete operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete('/telephony/' + encodeURIComponent(billingAccount) + '/easyHunting' + '/' + encodeURIComponent(serviceName) + '/hunting' + '/queue' + '/' + encodeURIComponent(queueId) + '/agent' + '/' + encodeURIComponent(agentId))) as IDataObject;
