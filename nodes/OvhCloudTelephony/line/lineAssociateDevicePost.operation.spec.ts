...
import { description, execute } from './lineAssociateDevicePost.operation';
...
describe('lineAssociateDevicePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'ipAddress') return 'ipAddress-value';
			if (param === 'macAddress') return 'macAddress-value';
			if (param === 'slot') return 'slot-value';
				return '';
			});
