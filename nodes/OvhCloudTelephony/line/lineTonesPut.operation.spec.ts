...
import { description, execute } from './lineTonesPut.operation';
...
describe('lineTonesPut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'endCall') return 'endCall-value';
			if (param === 'onHold') return 'onHold-value';
			if (param === 'ringback') return 'ringback-value';
				return '';
			});
