...
import { description, execute } from './lineTrafficExtractsPost.operation';
...
describe('lineTrafficExtractsPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'dateEnd') return 'dateEnd-value';
			if (param === 'dateStart') return 'dateStart-value';
				return '';
			});
