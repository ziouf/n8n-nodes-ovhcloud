...
import { description, execute } from './lineSoftphoneDevicesDelete.operation';
...
describe('lineSoftphoneDevicesDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'deviceId') return 'deviceId-value';
				return '';
			});
