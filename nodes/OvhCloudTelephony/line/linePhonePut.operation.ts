...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const maxSimultaneousCalls = this.getNodeParameter('maxSimultaneousCalls', itemIndex) as string;
	const maxline = this.getNodeParameter('maxline', itemIndex) as string;
	const mgcpIpRestriction = this.getNodeParameter('mgcpIpRestriction', itemIndex) as string;
	const phoneConfiguration = this.getNodeParameter('phoneConfiguration', itemIndex) as string;
