...
/**
 * Executes the Get Line Phone Phonebook Phonebook Contact Get operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('/telephony/' + billingAccount + '/line/' + serviceName + '/phone/phonebook/' + bookKey + '/phonebookContact/' + id)) as IDataObject;
