...
import { description, execute } from './lineRemoveSimultaneousLinesPost.operation';
...
describe('lineRemoveSimultaneousLinesPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'quantityRemove') return 'quantityRemove-value';
				return '';
			});
