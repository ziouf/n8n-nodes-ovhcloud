...
import { description, execute } from './lineAntihackPost.operation';
...
describe('lineAntihackPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'action') return 'action-value';
			if (param === 'restricted') return 'restricted-value';
				return '';
			});
