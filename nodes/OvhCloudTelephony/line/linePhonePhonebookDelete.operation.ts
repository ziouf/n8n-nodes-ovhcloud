...
/**
 * Executes the Delete Line Phone Phonebook Delete operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete('/telephony/' + billingAccount + '/line/' + serviceName + '/phone/phonebook/' + bookKey)) as IDataObject;
