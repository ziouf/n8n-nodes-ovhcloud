...
import { description, execute } from './lineCallsWhisperPost.operation';
...
describe('lineCallsWhisperPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'number') return 'number-value';
			if (param === 'whisperingMode') return 'whisperingMode-value';
				return '';
			});
