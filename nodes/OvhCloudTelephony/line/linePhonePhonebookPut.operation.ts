...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const bookKey1 = this.getNodeParameter('bookKey', _itemIndex) as string;
	const isReadonly = this.getNodeParameter('isReadonly', _itemIndex) as string;
	const name = this.getNodeParameter('name', _itemIndex) as string;
	const phoneKey = this.getNodeParameter('phoneKey', _itemIndex) as string;
