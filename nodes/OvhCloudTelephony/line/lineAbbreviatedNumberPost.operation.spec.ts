...
import { description, execute } from './lineAbbreviatedNumberPost.operation';
...
describe('lineAbbreviatedNumberPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'abbreviatedNumber') return 'abbreviatedNumber-value';
			if (param === 'destinationNumber') return 'destinationNumber-value';
