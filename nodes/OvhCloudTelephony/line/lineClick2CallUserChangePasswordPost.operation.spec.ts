...
import { description, execute } from './lineClick2CallUserChangePasswordPost.operation';
...
describe('lineClick2CallUserChangePasswordPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'password') return 'password-value';
				return '';
			});
