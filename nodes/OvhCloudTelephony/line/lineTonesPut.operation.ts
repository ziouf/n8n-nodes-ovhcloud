...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const endCall = this.getNodeParameter('endCall', itemIndex) as string;
	const onHold = this.getNodeParameter('onHold', itemIndex) as string;
	const ringback = this.getNodeParameter('ringback', itemIndex) as string;
