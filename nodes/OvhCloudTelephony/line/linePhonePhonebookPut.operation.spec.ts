...
import { description, execute } from './linePhonePhonebookPut.operation';
...
describe('linePhonePhonebookPut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'bookKey') return 'bookKey-value';
			if (param === 'isReadonly') return 'isReadonly-value';
			if (param === 'name') return 'name-value';
			if (param === 'phoneKey') return 'phoneKey-value';
				return '';
			});
