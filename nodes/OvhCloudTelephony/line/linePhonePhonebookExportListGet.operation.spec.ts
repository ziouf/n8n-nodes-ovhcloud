...
import { description, execute } from './linePhonePhonebookExportListGet.operation';
...
describe('linePhonePhonebookExportListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'format') return 'format-value';
				return '';
			});
