...
import { description, execute } from './carrierSipSettingsPut.operation';
...
describe('carrierSipSettingsPut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'maxCallsPerSecond') return 'maxCallsPerSecond-value';
			if (param === 'maxConcurrentCalls') return 'maxConcurrentCalls-value';
				return '';
			});
