...
import { description, execute } from './carrierSipVnoRangesPut.operation';
...
describe('carrierSipVnoRangesPut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'contractReference') return 'contractReference-value';
			if (param === 'prefix') return 'prefix-value';
