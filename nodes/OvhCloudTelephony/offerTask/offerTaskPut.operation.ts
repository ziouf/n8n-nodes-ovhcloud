...
/**
 * Executes the OfferTaskPut operation.
 *
 * HTTP method: PUT
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut('/telephony/' + encodeURIComponent(billingAccount) + '/offerTask' + '/' + encodeURIComponent(taskId), body)) as IDataObject;
