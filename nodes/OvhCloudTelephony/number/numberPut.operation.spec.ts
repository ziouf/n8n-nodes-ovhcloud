...
import { description, execute } from './numberPut.operation';
...
describe('numberPut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'featureType') return 'featureType-value';
			if (param === 'partOfPool') return 'partOfPool-value';
			if (param === 'serviceName') return 'serviceName-value';
