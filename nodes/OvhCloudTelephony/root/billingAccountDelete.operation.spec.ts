...
import { description, execute } from './billingAccountDelete.operation';
...
describe('billingAccountDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'details') return 'details-value';
			if (param === 'reason') return 'reason-value';
				return '';
			});
