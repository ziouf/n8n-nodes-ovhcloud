...
import { description, execute } from './billingAccountSitePost.operation';
...
describe('billingAccountSitePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'billingAccountSite') return 'billingAccountSite-value';
				return '';
			});
