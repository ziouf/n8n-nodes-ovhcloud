# EmailMxplan Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v1/email/mxplan.json
- **Base Path**: /email/mxplan
...
├── list.operation.ts      # GET /email/mxplan
├── get.operation.ts       # GET /email/mxplan/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getEmailMxplanServices'`)
