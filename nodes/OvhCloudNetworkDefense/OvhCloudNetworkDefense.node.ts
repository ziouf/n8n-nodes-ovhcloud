		...
		return executeTemplate.call(this, execute, {
			perItemConcurrency: {
				classify: (ctx, itemIndex) =>
					classifyOperation(
						String(ctx.getNodeParameter('networkDefenseOperation', itemIndex, { extractValue: true })),
					),
			},
			errorContext: { resource: 'networkdefense', operationParam: 'networkDefenseOperation' },
		});
	}
}
