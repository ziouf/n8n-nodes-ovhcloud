...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const functionValue = (this.getNodeParameter('function', 0, '') as string) || '';
	const isSsh = this.getNodeParameter('isSsh', 0, false) as boolean;
	const sshKey = (this.getNodeParameter('sshKey', 0, '') as string) || '';
	const sshPort = (this.getNodeParameter('sshPort', 0, 0) as number) ?? 0;
