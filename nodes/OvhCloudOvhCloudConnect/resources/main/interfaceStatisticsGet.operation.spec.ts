...
import { description, execute } from './interfaceStatisticsGet.operation';
...
describe('interfaceStatisticsGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ovhCloudConnect/svc-1/interface/12345/statistics', { period: '1HOUR', type: 'cpu' });
		...
		it('should encode special characters in path parameters', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ovhCloudConnect/svc%201/interface/98765/statistics', { period: '1DAY', type: 'memory' });
		});
	});
});