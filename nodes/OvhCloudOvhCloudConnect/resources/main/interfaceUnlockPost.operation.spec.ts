...
import { description, execute } from './interfaceUnlockPost.operation';
...
describe('interfaceUnlockPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ovhCloudConnect/svc-1/interface/12345/unlock');
		...
		it('should encode special characters in path parameters', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/ovhCloudConnect/svc%201/interface/98765/unlock');
		});
	});
});