...
/**
 * Delete a specific datacenter configuration of a POP configuration.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete(`/ovhCloudConnect/${encodeURIComponent(serviceName)}/config/pop/${encodeURIComponent(popId)}/datacenter/${encodeURIComponent(datacenterId)}`)) as IDataObject;
