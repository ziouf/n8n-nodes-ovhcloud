...
/**
 * Delete a specific POP configuration of an OvhCloud Connect service.
 *
 * HTTP method: DELETE
 * Endpoint: /ovhCloudConnect/{serviceName}/config/pop/{popId}
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete(`/ovhCloudConnect/${encodeURIComponent(serviceName)}/config/pop/${encodeURIComponent(popId)}`)) as IDataObject;
