...
/**
 * Generate a temporary URL to retrieve the logs of an OvhCloud Connect service.
 *
 * HTTP method: POST
 * Endpoint: /ovhCloudConnect/{serviceName}/log/url
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/ovhCloudConnect/${encodeURIComponent(serviceName)}/log/url`, body)) as IDataObject;
