...
import { description, execute } from './logSubscriptionDetailGet.operation';
...
describe('logSubscriptionDetailGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ovhCloudConnect/svc-1/log/subscription/sample-value');
		...
		it('should encode special characters in path parameters', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/ovhCloudConnect/svc%201/log/subscription/alternate-value');
		});
	});
});