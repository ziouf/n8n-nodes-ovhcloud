...
describe('logSubscriptionDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via DELETE', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/ovhCloudConnect/svc-1/log/subscription/sample-value');
		...
		it('should encode special characters in path parameters', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/ovhCloudConnect/svc%201/log/subscription/alternate-value');
		});
	});
});