# OVHCloudConnect Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v1/ovhCloudConnect.json
- **Base Path**: /ovhCloudConnect
...
├── list.operation.ts      # GET /ovhCloudConnect
├── get.operation.ts       # GET /ovhCloudConnect/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getOvhCloudConnectServices'`)
