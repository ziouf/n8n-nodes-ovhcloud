...
import { description, execute } from './vmwareCloudDirectororganizationpasswordCreatePost.operation';
...
describe('vmwareCloudDirectororganizationpasswordCreatePost operation', () => {
