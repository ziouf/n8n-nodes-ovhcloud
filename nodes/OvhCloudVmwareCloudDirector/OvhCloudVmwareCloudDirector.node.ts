...
export class OvhCloudVmwareCloudDirector implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'OVH Cloud V2 VMware Cloud Director',
		name: 'ovhCloudVmwareCloudDirector',
		icon: OvhCloudIcon,
		group: ['input'],
		version: 1,
		subtitle: '={{$parameter["vmwareCloudDirectorOperation"]}}',
		description: 'Manage OVH V2 VMware Cloud Director services',
		defaults: {
			name: 'OVH Cloud V2 VMware Cloud Director',
		},
		usableAsTool: true,
