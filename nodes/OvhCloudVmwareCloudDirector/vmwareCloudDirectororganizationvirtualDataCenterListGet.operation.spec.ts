...
import { description, execute } from './vmwareCloudDirectororganizationvirtualDataCenterListGet.operation';
...
describe('vmwareCloudDirectororganizationvirtualDataCenterListGet operation', () => {
