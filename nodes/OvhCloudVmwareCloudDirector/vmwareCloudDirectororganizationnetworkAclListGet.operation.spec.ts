...
import { description, execute } from './vmwareCloudDirectororganizationnetworkAclListGet.operation';
...
describe('vmwareCloudDirectororganizationnetworkAclListGet operation', () => {
