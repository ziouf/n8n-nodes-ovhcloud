# V2 VMware Cloud Director Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v2/vmwareCloudDirector.json
- **Base Path**: /v2/vmwareCloudDirector
...
├── list.operation.ts      # GET /v2/vmwareCloudDirector
└── get.operation.ts       # GET /v2/vmwareCloudDirector/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2VmwareCloudDirectorServices'`)
