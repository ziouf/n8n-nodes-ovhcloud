...
/**
 * Get a specific VMware Cloud Director VDC vRack segment task.
 *
 * HTTP method: GET
 * Endpoint: /v2/vmwareCloudDirector/organization/{organizationId}/virtualDataCenter/{virtualDataCenterId}/vrackSegment/{id}/task/{taskId}
 */
...
/**
 * Executes the Get VMware Cloud Director Organization VDC vRack Segment Task operation.
 */
