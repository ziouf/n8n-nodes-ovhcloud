...
import { description, execute } from './vmwareCloudDirectororganizationvirtualDataCenterstorageListGet.operation';
...
describe('vmwareCloudDirectororganizationvirtualDataCenterstorageListGet operation', () => {
