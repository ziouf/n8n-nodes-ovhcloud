...
import { description, execute } from './vmwareCloudDirectororganizationnetworkAclUpdatePut.operation';
...
describe('vmwareCloudDirectororganizationnetworkAclUpdatePut operation', () => {
