...
import { description, execute } from './vmwareCloudDirectororganizationnetworkAclListGet2.operation';
...
describe('vmwareCloudDirectororganizationnetworkAclListGet2 operation', () => {
