...
import { description, execute } from './voicemailChangePasswordPost.operation';
...
describe('voicemailChangePasswordPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should change voicemail password via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/freefax/fr12345-ovh/voicemail/changePassword',
				{ password: '1234' },
			);
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/freefax/fr%2012345-ovh/voicemail/changePassword',
				{ password: '1234' },
			);
		});
	});
