...
describe('get.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get Freefax service via GET', async () => {
			const mockData = { number: '0892701020', faxQuality: 'best' };
			...
			expect(client.httpGet).toHaveBeenCalledWith('/freefax/fr12345-ovh');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/freefax/fr%2012345-ovh');
		});
	});
});
