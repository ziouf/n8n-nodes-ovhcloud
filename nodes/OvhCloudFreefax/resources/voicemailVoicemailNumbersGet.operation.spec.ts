...
import { description, execute } from './voicemailVoicemailNumbersGet.operation';
...
describe('voicemailVoicemailNumbersGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get voicemail numbers via GET', async () => {
			const mockData = { external: '+33123456789', internal: '123456789' };
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/freefax/fr12345-ovh/voicemail/voicemailNumbers',
			);
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/freefax/fr%2012345-ovh/voicemail/voicemailNumbers',
			);
		});
	});
});
