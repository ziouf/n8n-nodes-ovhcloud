...
import { description, execute } from './deleteIpLoadbalancingserviceNTcpFarmfarmIdDelete.operation';
...
describe('deleteIpLoadbalancingserviceNTcpFarmfarmIdDelete operation', () => {
