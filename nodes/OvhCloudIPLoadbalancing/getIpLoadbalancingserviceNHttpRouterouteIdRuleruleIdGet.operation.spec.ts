...
import { description, execute } from './getIpLoadbalancingserviceNHttpRouterouteIdRuleruleIdGet.operation';
...
describe('getIpLoadbalancingserviceNHttpRouterouteIdRuleruleIdGet operation', () => {
