...
import { description, execute } from './deleteIpLoadbalancingserviceNHttpRouterouteIdDelete.operation';
...
describe('deleteIpLoadbalancingserviceNHttpRouterouteIdDelete operation', () => {
