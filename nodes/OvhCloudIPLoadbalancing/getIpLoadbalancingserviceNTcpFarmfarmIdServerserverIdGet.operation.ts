...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('/ipLoadbalancing' + '/' + encodeURIComponent(serviceName) + '/' + 'tcp' + '/' + 'farm' + '/' + encodeURIComponent(farmId) + '/' + 'server' + '/' + encodeURIComponent(serverId))) as IDataObject;
