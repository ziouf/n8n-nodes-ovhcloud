...
import { description, execute } from './postIpLoadbalancingserviceNZonenameCancelTerminationPost.operation';
...
describe('postIpLoadbalancingserviceNZonenameCancelTerminationPost operation', () => {
