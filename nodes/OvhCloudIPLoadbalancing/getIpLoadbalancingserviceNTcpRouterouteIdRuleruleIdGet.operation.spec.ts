...
import { description, execute } from './getIpLoadbalancingserviceNTcpRouterouteIdRuleruleIdGet.operation';
...
describe('getIpLoadbalancingserviceNTcpRouterouteIdRuleruleIdGet operation', () => {
