...
import { description, execute } from './deleteIpLoadbalancingserviceNTcpRouterouteIdRuleruleIdDelete.operation';
...
describe('deleteIpLoadbalancingserviceNTcpRouterouteIdRuleruleIdDelete operation', () => {
