...
import { description, execute } from './getIpLoadbalancingserviceNHttpRouterouteIdRuleGet.operation';
...
describe('getIpLoadbalancingserviceNHttpRouterouteIdRuleGet operation', () => {
