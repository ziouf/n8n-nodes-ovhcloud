...
import { description, execute } from './deleteIpLoadbalancingserviceNTcpRouterouteIdDelete.operation';
...
describe('deleteIpLoadbalancingserviceNTcpRouterouteIdDelete operation', () => {
