...
import { description, execute } from './postIpLoadbalancingserviceNVrackNetworkPost.operation';
...
describe('postIpLoadbalancingserviceNVrackNetworkPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'natIp') return 'test-natIp-value';
			if (param === 'subnet') return 'test-subnet-value';
			if (param === 'vlan') return 'test-vlan-value';
