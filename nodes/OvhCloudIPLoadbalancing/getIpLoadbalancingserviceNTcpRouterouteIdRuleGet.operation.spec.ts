...
import { description, execute } from './getIpLoadbalancingserviceNTcpRouterouteIdRuleGet.operation';
...
describe('getIpLoadbalancingserviceNTcpRouterouteIdRuleGet operation', () => {
