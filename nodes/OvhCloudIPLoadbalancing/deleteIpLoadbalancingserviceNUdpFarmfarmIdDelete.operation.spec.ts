...
import { description, execute } from './deleteIpLoadbalancingserviceNUdpFarmfarmIdDelete.operation';
...
describe('deleteIpLoadbalancingserviceNUdpFarmfarmIdDelete operation', () => {
