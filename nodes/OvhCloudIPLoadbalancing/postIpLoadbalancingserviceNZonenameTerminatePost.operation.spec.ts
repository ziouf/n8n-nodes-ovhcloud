...
import { description, execute } from './postIpLoadbalancingserviceNZonenameTerminatePost.operation';
...
describe('postIpLoadbalancingserviceNZonenameTerminatePost operation', () => {
