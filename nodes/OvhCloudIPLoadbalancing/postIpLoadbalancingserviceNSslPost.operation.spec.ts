...
import { description, execute } from './postIpLoadbalancingserviceNSslPost.operation';
...
describe('postIpLoadbalancingserviceNSslPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'certificate') return 'test-certificate-value';
