...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete('/ipLoadbalancing' + '/' + encodeURIComponent(serviceName) + '/' + 'http' + '/' + 'route' + '/' + encodeURIComponent(routeId) + '/' + 'rule' + '/' + encodeURIComponent(ruleId))) as IDataObject;
