...
import { description, execute } from './postIpLoadbalancingserviceNHttpFarmPost.operation';
...
describe('postIpLoadbalancingserviceNHttpFarmPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'balance') return 'test-balance-value';
			...
			if (param === 'stickiness') return 'test-stickiness-value';
			if (param === 'vrackNetworkId') return 'test-vrackNetworkId-value';
