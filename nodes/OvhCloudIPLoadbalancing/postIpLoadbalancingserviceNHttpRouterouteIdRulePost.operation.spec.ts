...
import { description, execute } from './postIpLoadbalancingserviceNHttpRouterouteIdRulePost.operation';
...
describe('postIpLoadbalancingserviceNHttpRouterouteIdRulePost operation', () => {
