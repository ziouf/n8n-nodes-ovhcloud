...
import { description, execute } from './putIpLoadbalancingserviceNHttpRouterouteIdPut.operation';
...
describe('putIpLoadbalancingserviceNHttpRouterouteIdPut operation', () => {
