...
import { description, execute } from './getIpLoadbalancingserviceNHttpRouterouteIdGet.operation';
...
describe('getIpLoadbalancingserviceNHttpRouterouteIdGet operation', () => {
