...
import { description, execute } from './postIpLoadbalancingserviceNHttpFrontendPost.operation';
...
describe('postIpLoadbalancingserviceNHttpFrontendPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'hsts') return 'test-hsts-value';
			if (param === 'httpHeader') return 'test-httpHeader-value';
			if (param === 'port') return 'test-port-value';
			if (param === 'redirectLocation') return 'test-redirectLocation-value';
