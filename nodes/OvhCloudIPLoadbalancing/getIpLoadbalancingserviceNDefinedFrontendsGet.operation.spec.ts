...
import { description, execute } from './getIpLoadbalancingserviceNDefinedFrontendsGet.operation';
...
describe('getIpLoadbalancingserviceNDefinedFrontendsGet operation', () => {
