...
import { description, execute } from './getIpLoadbalancingserviceNUdpFarmfarmIdServerGet.operation';
...
describe('getIpLoadbalancingserviceNUdpFarmfarmIdServerGet operation', () => {
