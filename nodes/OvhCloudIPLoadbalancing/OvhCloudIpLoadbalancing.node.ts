		...
		return executeTemplate.call(this, execute, {
			perItemConcurrency: {
				classify: (ctx, itemIndex) =>
					classifyOperation(
						String(ctx.getNodeParameter('ipLoadbalancingOperation', itemIndex, { extractValue: true })),
					),
			},
			errorContext: { resource: 'iploadbalancing', operationParam: 'ipLoadbalancingOperation' },
		});
	}
}
