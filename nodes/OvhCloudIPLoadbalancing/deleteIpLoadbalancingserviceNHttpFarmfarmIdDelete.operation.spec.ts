...
import { description, execute } from './deleteIpLoadbalancingserviceNHttpFarmfarmIdDelete.operation';
...
describe('deleteIpLoadbalancingserviceNHttpFarmfarmIdDelete operation', () => {
