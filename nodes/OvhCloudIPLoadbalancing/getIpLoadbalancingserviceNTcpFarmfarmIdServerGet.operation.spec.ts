...
import { description, execute } from './getIpLoadbalancingserviceNTcpFarmfarmIdServerGet.operation';
...
describe('getIpLoadbalancingserviceNTcpFarmfarmIdServerGet operation', () => {
