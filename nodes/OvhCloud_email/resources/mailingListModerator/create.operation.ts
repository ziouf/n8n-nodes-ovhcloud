...
/**
 * Create a mailing list moderator.
 *
 * HTTP method: POST
...
/**
 * Executes the Create Mailing List Moderator operation.
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(
		`/email/domain/${domainParam.value}/mailingList/${mailingListName}/moderator`,
		{ email },
	)) as IDataObject;
	return [{ json: data }];
}
