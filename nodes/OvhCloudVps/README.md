...
| [`backupRestoreListGet`](./`backupRestoreListGet`.ts) | GET | `/vps/{...}/automatedBackup/list` | 1 |
...
| [`ipReleasePut`](./`ipReleasePut`.ts) | PUT | `/vps/{...}/ip/release` | 1 |
| [`list`](./`list`.ts) | GET | `...` | 0 |
...
| [`restorePointListGet`](./`restorePointListGet`.ts) | GET | `/vps/{...}/automatedBackup/listRestorePoints` | 1 |
