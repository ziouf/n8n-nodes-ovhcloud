...
import { description, execute } from './publicCloudprojectranchercapabilitiesversionListGet.operation';
...
describe('publicCloudprojectranchercapabilitiesversionListGet operation', () => {
