...
import { description, execute } from './publicCloudprojectrancheradminCredentialsCreatePost.operation';
...
describe('publicCloudprojectrancheradminCredentialsCreatePost operation', () => {
