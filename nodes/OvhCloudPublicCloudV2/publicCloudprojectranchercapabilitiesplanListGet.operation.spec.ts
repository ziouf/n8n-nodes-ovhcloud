...
import { description, execute } from './publicCloudprojectranchercapabilitiesplanListGet.operation';
...
describe('publicCloudprojectranchercapabilitiesplanListGet operation', () => {
