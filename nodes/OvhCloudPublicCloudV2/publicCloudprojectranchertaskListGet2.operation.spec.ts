...
import { description, execute } from './publicCloudprojectranchertaskListGet2.operation';
...
describe('publicCloudprojectranchertaskListGet2 operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'projectId') return 'test-projectId-id';
			if (param === 'rancherId') return 'test-rancherId-id';
