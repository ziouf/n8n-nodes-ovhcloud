...
import { description, execute } from './publicCloudprojectreferencerancherversionListGet.operation';
...
describe('publicCloudprojectreferencerancherversionListGet operation', () => {
