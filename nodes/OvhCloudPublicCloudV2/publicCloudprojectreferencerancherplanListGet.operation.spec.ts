...
import { description, execute } from './publicCloudprojectreferencerancherplanListGet.operation';
...
describe('publicCloudprojectreferencerancherplanListGet operation', () => {
