...
import { description, execute } from './domainnametaskListGet2.operation';
...
describe('domainnametaskListGet2 operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'domainName') return 'test-domainName-id';
