...
import { description, execute } from './domainalldomtaskListGet2.operation';
...
describe('domainalldomtaskListGet2 operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'alldomName') return 'test-alldomName-id';
