...
import { description, execute } from './getCertificateByResourceName.operation';
...
describe('getCertificateByResourceName.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get SSL certificate via GET for webhosting resource', async () => {
			const client = new ApiClient(mockExecuteFunctions) as any;
			client.httpGet.mockResolvedValue({ state: 'active' });
		...
		it('should handle service name with special characters (URL encoding)', async () => {
			const client = new ApiClient(mockExecuteFunctions) as any;
			client.httpGet.mockResolvedValue({ state: 'pending' });
		...
		it('should return certificate data as single-element array', async () => {
			const client = new ApiClient(mockExecuteFunctions) as any;
			client.httpGet.mockResolvedValue({ state: 'active', sslType: 'DV' });
