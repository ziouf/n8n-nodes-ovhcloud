...
import { description, execute } from './postEmailProserviceUpdateFlagsOnAllAccountsPost.operation';
...
describe('postEmailProserviceUpdateFlagsOnAllAccountsPost operation', () => {
