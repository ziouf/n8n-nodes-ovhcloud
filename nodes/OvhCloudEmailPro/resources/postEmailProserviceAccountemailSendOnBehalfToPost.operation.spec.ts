...
import { description, execute } from './postEmailProserviceAccountemailSendOnBehalfToPost.operation';
...
describe('postEmailProserviceAccountemailSendOnBehalfToPost operation', () => {
