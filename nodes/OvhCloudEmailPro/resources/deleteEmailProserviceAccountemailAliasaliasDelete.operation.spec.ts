...
import { description, execute } from './deleteEmailProserviceAccountemailAliasaliasDelete.operation';
...
describe('deleteEmailProserviceAccountemailAliasaliasDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'alias') return 'test-alias-value';
