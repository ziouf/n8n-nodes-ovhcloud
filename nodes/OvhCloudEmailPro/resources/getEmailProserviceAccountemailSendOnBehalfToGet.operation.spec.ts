...
import { description, execute } from './getEmailProserviceAccountemailSendOnBehalfToGet.operation';
...
describe('getEmailProserviceAccountemailSendOnBehalfToGet operation', () => {
