...
import { description, execute } from './postEmailProserviceAccountemailChangePasswordPost.operation';
...
describe('postEmailProserviceAccountemailChangePasswordPost operation', () => {
