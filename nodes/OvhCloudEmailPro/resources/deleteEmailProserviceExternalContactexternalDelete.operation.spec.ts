...
import { description, execute } from './deleteEmailProserviceExternalContactexternalDelete.operation';
...
describe('deleteEmailProserviceExternalContactexternalDelete operation', () => {
