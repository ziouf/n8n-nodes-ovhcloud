...
import { description, execute } from './getEmailProserviceDomainGet.operation';
...
describe('getEmailProserviceDomainGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'state') return 'test-state-value';
