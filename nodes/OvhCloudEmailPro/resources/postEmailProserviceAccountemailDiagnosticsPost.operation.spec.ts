...
import { description, execute } from './postEmailProserviceAccountemailDiagnosticsPost.operation';
...
describe('postEmailProserviceAccountemailDiagnosticsPost operation', () => {
