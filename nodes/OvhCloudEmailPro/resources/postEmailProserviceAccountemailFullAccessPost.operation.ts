...
export function description() {
	return [
		...
		},
		{
			...
			type: 'string',
			default: '',
			description: 'The allowedaccountid value',
		},
	];
}
...
const body: IDataObject = {
	...
	const data = (await client.httpPost('/email' + '/' + 'pro' + '/' + encodeURIComponent(service) + '/' + 'account' + '/' + encodeURIComponent(email) + '/' + 'fullAccess', body)) as IDataObject;
