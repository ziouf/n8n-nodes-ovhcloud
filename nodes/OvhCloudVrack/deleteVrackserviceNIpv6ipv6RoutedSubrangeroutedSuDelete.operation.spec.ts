...
import { description, execute } from './deleteVrackserviceNIpv6ipv6RoutedSubrangeroutedSuDelete.operation';
...
describe('deleteVrackserviceNIpv6ipv6RoutedSubrangeroutedSuDelete operation', () => {
