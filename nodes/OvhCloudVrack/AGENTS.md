...
- **API Spec**: https://eu.api.ovh.com/v1/vrack.json
- **Base Path**: /vrack
...
├── list.operation.ts      # GET /vrack
├── get.operation.ts       # GET /vrack/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getVrackServices'`)
