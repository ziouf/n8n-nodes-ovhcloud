...
import { description, execute } from './getVrackserviceNTasktaskIdGet.operation';
...
describe('getVrackserviceNTasktaskIdGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'taskId') return 'test-taskId-value';
