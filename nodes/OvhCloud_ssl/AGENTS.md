...
- **API Spec**: https://eu.api.ovh.com/v1/ssl.json
- **Base Path**: /ssl
...
├── list.operation.ts      # GET /ssl
├── get.operation.ts       # GET /ssl/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getSslServices'`)
