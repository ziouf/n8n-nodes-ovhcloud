...
import { getStackServices } from '../../shared/methods/getStackServices.method';
		...
		return executeTemplate.call(this, execute, {
			perItemConcurrency: {
				classify: (ctx, itemIndex) =>
					classifyOperation(
						String(ctx.getNodeParameter('stackOperation', itemIndex, { extractValue: true })),
					),
			},
			errorContext: { resource: 'stackMis', operationParam: 'stackOperation' },
		});
	}
}
