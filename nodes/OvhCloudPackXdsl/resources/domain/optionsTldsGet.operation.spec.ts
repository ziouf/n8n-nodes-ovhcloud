...
import { description, execute } from './optionsTldsGet.operation';
...
describe('optionsTldsGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get the available TLDs via GET', async () => {
			const mockData = ['.com', '.fr'];
			...
			expect(client.httpGet).toHaveBeenCalledWith('/pack/xdsl/packabcd-ovh/domain/options/tlds');
			expect(result).toEqual([{ tld: '.com' }, { tld: '.fr' }]);
		});
