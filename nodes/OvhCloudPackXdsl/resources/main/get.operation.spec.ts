...
describe('get.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get the pack properties via GET', async () => {
			const mockData = { packName: 'packabcd-ovh', offerDescription: 'xdsl' };
			...
			expect(client.httpGet).toHaveBeenCalledWith('/pack/xdsl/packabcd-ovh');
		...
		it('should encode special characters in packName', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/pack/xdsl/pack%20abcd');
		});
	});
});
