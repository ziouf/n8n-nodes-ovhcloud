...
import { description, execute } from './contactOwnerGet.operation';
...
describe('contactOwnerGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get the contact owner via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/pack/xdsl/packabcd-ovh/contactOwner');
		...
		it('should encode special characters in packName', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/pack/xdsl/pack%20abcd/contactOwner');
		});
	});
});
