...
import { description, execute } from './servicesDomainGet.operation';
...
describe('servicesDomainGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get a Hosted Email service via GET with encoded domain', async () => {
			const mockData = { domain: 'domain1.com', state: 'ok' };
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/pack/xdsl/packabcd-ovh/hostedEmail/services/domain1.com',
			);
		...
		it('should encode special characters in packName and domain', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/pack/xdsl/pack%20abcd/hostedEmail/services/domain%201.com',
			);
		});
	});
});
