...
/**
 * Get hosted email account information.
 *
 * HTTP method: GET
 * Endpoint: /pack/xdsl/{packName}/hostedEmail/services/{domain}/account
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(
		`/pack/xdsl/${encodeURIComponent(packName)}/hostedEmail/services/${encodeURIComponent(domain)}/account`,
	)) as IDataObject;
