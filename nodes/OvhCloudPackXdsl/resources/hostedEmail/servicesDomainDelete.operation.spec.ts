...
import { description, execute } from './servicesDomainDelete.operation';
...
describe('servicesDomainDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should delete a Hosted Email service via DELETE with encoded domain', async () => {
