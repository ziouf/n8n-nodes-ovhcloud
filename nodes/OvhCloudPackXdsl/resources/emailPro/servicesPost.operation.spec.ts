...
describe('servicesPost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should activate an Email Pro service via POST', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/pack/xdsl/packabcd-ovh/emailPro/services', {
		...
		it('should encode special characters in packName', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/pack/xdsl/pack%20abcd/emailPro/services', {
				email: 'test@example.com',
				password: 'secret123',
			});
		});
