...
describe('servicesToDeleteUnpackTermsPost.operation', () => {
	describe('description', () => {
		it('should return packName, eligibilityReference, offerName and options parameters', () => {
	...
	describe('execute', () => {
		...
		it('should calculate services to delete via POST with options', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/pack/xdsl/packabcd-ovh/addressMove/servicesToDeleteUnpackTerms',
				{
		...
		it('should send no options when not provided', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/pack/xdsl/packabcd-ovh/addressMove/servicesToDeleteUnpackTerms',
				{ eligibilityReference: 'eligibilityRef123', offerName: 'offer-vdsl' },
			);
		});
		...
		it('should encode special characters in packName', async () => {
			...
			await execute.call(mockExecuteFunctions);
			expect(client.httpPost).toHaveBeenCalledWith(
				'/pack/xdsl/pack%20abcd/addressMove/servicesToDeleteUnpackTerms',
				{ eligibilityReference: 'eligibilityRef123', offerName: 'offer-vdsl' },
			);
		});
	});
