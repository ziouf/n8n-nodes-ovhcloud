# IP Loadbalancing Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v1/ipLoadbalancing.json
- **Base Path**: /ipLoadbalancing
...
├── list.operation.ts      # GET /ipLoadbalancing
├── get.operation.ts       # GET /ipLoadbalancing/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getIpLoadbalancingServices'`)
