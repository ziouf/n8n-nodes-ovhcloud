...
export class OvhCloudIpLoadbalancing implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'OVH Cloud IP Load Balancing',
		name: 'ovhCloudIpLoadbalancing',
		icon: OvhCloudIcon,
		group: ['input'],
		version: 1,
		subtitle: '={{$parameter["ipLoadbalancingOperation"]}}',
		description: 'Manage OVH IP Load Balancing services',
		defaults: {
			name: 'OVH Cloud IP Load Balancing',
		},
		usableAsTool: true,
