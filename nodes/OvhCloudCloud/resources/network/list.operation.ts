...
/**
 * Description for List Networks operation.
 */
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		...
		},
		{
			...
			type: 'string',
			default: '',
			description: 'Filter networks by region',
			displayOptions,
		},
	];
}
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/cloud/project/${serviceName}/network`, qs)) as IDataObject[];
