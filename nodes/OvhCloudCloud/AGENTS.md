...
- **API Spec**: https://eu.api.ovh.com/v1/cloud.json
- **Base Path**: /cloud
...
├── list.operation.ts      # GET /cloud
├── get.operation.ts       # GET /cloud/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getCloudServices'`)
