...
export async function execute(this: IExecuteFunctions,
	...
	const data = (await client.httpGet('/dedicated/nasha/' + encodeURIComponent(serviceName) + '/partition/' + encodeURIComponent(partitionName) + '/customSnapshot')) as IDataObject;
