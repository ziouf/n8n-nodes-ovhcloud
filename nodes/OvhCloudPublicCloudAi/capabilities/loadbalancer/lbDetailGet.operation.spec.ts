...
import { description, execute } from './lbDetailGet.operation';
...
describe('capabilities/loadbalancer lbDetailGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get Load Balancer Capability by Region via GET', async () => {
