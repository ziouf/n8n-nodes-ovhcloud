...
export function description(displayOptions: IDisplayOptions = {} as IDisplayOptions): INodeProperties[] {
	return [
		...
		{
			displayName: 'Compatible with editor',
		...
		},
		{
			...
			type: 'string',
			default: '',
			description: 'Only list frameworks of this type',
			displayOptions,
		},
	];
}
...
/**
 * Executes the List AI Solutions Notebook frameworks operation.
 *
 * HTTP method: GET
 * Endpoint: /cloud/project/{serviceName}/ai/capabilities/region/{region}/notebook/framework
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('cloud/project' + serviceName + '/ai/capabilities/region/' + region + '/notebook/framework', qs)) as IDataObject;
