...
/**
 * Executes the Restart an AI Solutions notebook operation.
 *
 * HTTP method: PUT
 * Endpoint: /cloud/project/{serviceName}/ai/notebook/{notebookId}/restart
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut('cloud/project' + serviceName + '/ai/notebook/' + notebookId + '/restart')) as IDataObject;
