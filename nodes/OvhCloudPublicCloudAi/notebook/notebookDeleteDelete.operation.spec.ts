...
import { description, execute } from './notebookDeleteDelete.operation';
...
describe('notebook notebookDeleteDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should delete an existing AI Notebook via DELETE', async () => {
