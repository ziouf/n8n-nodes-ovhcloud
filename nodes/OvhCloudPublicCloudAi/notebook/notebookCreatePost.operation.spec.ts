...
import { description, execute } from './notebookCreatePost.operation';
...
describe('notebook notebookCreatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should create a new AI Notebook via POST', async () => {
