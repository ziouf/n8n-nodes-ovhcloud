...
/**
 * Executes the Update/add an AI Solutions notebook label operation.
 *
 * HTTP method: PUT
 * Endpoint: /cloud/project/{serviceName}/ai/notebook/{notebookId}/label
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut('cloud/project' + serviceName + '/ai/notebook/' + notebookId + '/label', body)) as IDataObject;
