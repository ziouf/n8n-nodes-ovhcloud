...
/**
 * Executes the Get the logs of a notebook operation.
 *
 * HTTP method: GET
 * Endpoint: /cloud/project/{serviceName}/ai/notebook/{notebookId}/log
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('cloud/project' + serviceName + '/ai/notebook/' + notebookId + '/log')) as IDataObject;
