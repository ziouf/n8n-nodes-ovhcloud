...
/**
 * Executes the Start an AI Solutions notebook operation.
 *
 * HTTP method: PUT
 * Endpoint: /cloud/project/{serviceName}/ai/notebook/{notebookId}/start
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut('cloud/project' + serviceName + '/ai/notebook/' + notebookId + '/start')) as IDataObject;
