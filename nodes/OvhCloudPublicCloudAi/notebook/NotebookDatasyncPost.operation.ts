...
/**
 * Executes the Starts a manual data synchronization on an AI Solutions notebook operation.
 *
 * HTTP method: POST
 * Endpoint: /cloud/project/{serviceName}/ai/notebook/{notebookId}/datasync
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('cloud/project' + serviceName + '/ai/notebook/' + notebookId + '/datasync', body)) as IDataObject;
