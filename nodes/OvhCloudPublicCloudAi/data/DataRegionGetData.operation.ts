 ...
 *
 * HTTP method: GET
 * Endpoint: /cloud/project/{serviceName}/ai/data/region/{region}
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('cloud/project' + serviceName + '/ai/data/region/' + region)) as IDataObject;
