...
/**
 * Executes the Get an AI datastore auth in a given region by its alias operation.
 *
 * HTTP method: GET
 * Endpoint: /cloud/project/{serviceName}/ai/data/region/{region}/alias/{alias}/auth
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('cloud/project' + serviceName + '/ai/data/region/' + region + '/alias/' + alias + '/auth')) as IDataObject;
