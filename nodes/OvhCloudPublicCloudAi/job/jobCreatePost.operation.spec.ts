...
import { description, execute } from './jobCreatePost.operation';
...
describe('job jobCreatePost.operation', () => {
	describe('description', () => {
		it('should return all required parameters', () => {
			const result = description({ show: {} });
			expect(result).toHaveLength(1 + 2);
		});
	...
	describe('execute', () => {
		...
		it('should create a new AI Job via POST', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockReturnValue(
				...
				if (param === 'appName') return '';
				if (param === 'modelId') return 'openai-gpt-4o-mini';
