...
/**
 * Executes the Create a new job operation.
 *
 * HTTP method: POST
 * Endpoint: /cloud/project/{serviceName}/ai/job
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('cloud/project' + serviceName + '/ai/job', body)) as IDataObject;
