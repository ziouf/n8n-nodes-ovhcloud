...
/**
 * Executes the List partners and contracts operation.
 *
 * HTTP method: GET
 * Endpoint: /cloud/project/{serviceName}/ai/partners/region/{region}/partner
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet('cloud/project' + serviceName + '/ai/partners/region/' + region + '/partner')) as IDataObject;
