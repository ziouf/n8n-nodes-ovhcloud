...
/**
 * Executes the Stop AI App operation.
 *
 * HTTP method: PUT
 * Endpoint: /publicCloud/project/{projectId}/ai/app/{appId}/stop
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	(await client.httpPut(`/publicCloud/project/${projectId}/ai/app/${appId}/stop`)) as void;
