...
export function description(displayOptions: IDisplayOptions = {} as IDisplayOptions): INodeProperties[] {
	return [
		...
		},
		{
			...
			default: '',
			required: true,
			description: 'The name of the AI application to create',
			displayOptions,
		},
		{
			...
			description: 'The model identifier for the AI application (e.g. openai-gpt-4o-mini)',
			displayOptions,
		},
	];
}
...
/**
 * Executes the Create AI App operation.
 *
 * HTTP method: POST
 * Endpoint: /publicCloud/project/{projectId}/ai/app
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(
		`/publicCloud/project/${projectId}/ai/app`,
		body as IDataObject,
	)) as IDataObject;
