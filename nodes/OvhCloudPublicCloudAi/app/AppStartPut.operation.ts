...
/**
 * Executes the Start an existing AI Solutions app operation.
 *
 * HTTP method: PUT
 * Endpoint: /cloud/project/{serviceName}/ai/app/{appId}/start
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut('cloud/project' + serviceName + '/ai/app/' + appId + '/start')) as IDataObject;
