...
/**
 * Executes the Stop an AI Solutions app operation.
 *
 * HTTP method: PUT
 * Endpoint: /cloud/project/{serviceName}/ai/app/{appId}/stop
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut('cloud/project' + serviceName + '/ai/app/' + appId + '/stop')) as IDataObject;
