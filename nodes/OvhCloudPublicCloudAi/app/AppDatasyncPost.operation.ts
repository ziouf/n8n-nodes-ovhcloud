...
/**
 * Executes the Starts a manual data synchronization on an app operation.
 *
 * HTTP method: POST
 * Endpoint: /cloud/project/{serviceName}/ai/app/{appId}/datasync
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('cloud/project' + serviceName + '/ai/app/' + appId + '/datasync', body)) as IDataObject;
