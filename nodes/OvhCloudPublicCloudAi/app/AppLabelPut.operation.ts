...
/**
 * Executes the Update/add an AI Solutions app label operation.
 *
 * HTTP method: PUT
 * Endpoint: /cloud/project/{serviceName}/ai/app/{appId}/label
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut('cloud/project' + serviceName + '/ai/app/' + appId + '/label', body)) as IDataObject;
