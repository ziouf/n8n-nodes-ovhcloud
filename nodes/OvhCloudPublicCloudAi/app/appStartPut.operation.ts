...
/**
 * Executes the Start AI App operation.
 *
 * HTTP method: PUT
 * Endpoint: /publicCloud/project/{projectId}/ai/app/{appId}/start
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	(await client.httpPut(`/publicCloud/project/${projectId}/ai/app/${appId}/start`)) as void;
