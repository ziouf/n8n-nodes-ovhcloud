...
/**
 * Executes the Set the Docker image of an AI app operation.
 *
 * HTTP method: PUT
 * Endpoint: /cloud/project/{serviceName}/ai/app/{appId}/image
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut('cloud/project' + serviceName + '/ai/app/' + appId + '/image', body)) as IDataObject;
