...
import { description, execute } from './dataCreatePost.operation';
...
describe('dataStore dataCreatePost.operation', () => {
	...
	describe('execute', () => {
		...
		it('should create a new Data Store alias via POST', async () => {
