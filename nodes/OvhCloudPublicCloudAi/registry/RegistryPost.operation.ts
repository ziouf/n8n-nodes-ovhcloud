...
/**
 * Executes the Create a Docker registry operation.
 *
 * HTTP method: POST
 * Endpoint: /cloud/project/{serviceName}/ai/registry
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('cloud/project' + serviceName + '/ai/registry', body)) as IDataObject;
