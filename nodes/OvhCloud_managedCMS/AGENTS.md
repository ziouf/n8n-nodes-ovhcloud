# V2 Managed CMS Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v2/managedCMS.json
- **Base Path**: /v2/managedCMS
...
├── list.operation.ts      # GET /v2/managedCMS
└── get.operation.ts       # GET /v2/managedCMS/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2ManagedCMSServices'`)
