import { description, execute } from './ServiceSendConnectorChangeAuthenticationCreate.operation';
...
describe('ServiceSendConnectorChangeAuthenticationCreate operation', () => {
