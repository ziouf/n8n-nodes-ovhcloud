...
import { description, execute } from './ServiceMailingListMemberAccountMemberAccountIdGet.operation';
...
describe('ServiceMailingListMemberAccountMemberAccountIdGet operation', () => {
