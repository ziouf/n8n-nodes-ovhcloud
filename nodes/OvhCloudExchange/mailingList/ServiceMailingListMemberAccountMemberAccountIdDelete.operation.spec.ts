...
import { description, execute } from './ServiceMailingListMemberAccountMemberAccountIdDelete.operation';
...
describe('ServiceMailingListMemberAccountMemberAccountIdDelete operation', () => {
