...
import { description, execute } from './ServiceMailingListMemberContactMemberContactIdGet.operation';
...
describe('ServiceMailingListMemberContactMemberContactIdGet operation', () => {
