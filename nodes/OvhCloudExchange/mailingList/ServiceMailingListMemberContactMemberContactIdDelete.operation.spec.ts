import { description, execute } from './ServiceMailingListMemberContactMemberContactIdDelete.operation';
...
describe('ServiceMailingListMemberContactMemberContactIdDelete operation', () => {
