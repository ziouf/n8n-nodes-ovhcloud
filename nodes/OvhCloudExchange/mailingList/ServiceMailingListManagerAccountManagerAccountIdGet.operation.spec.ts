import { description, execute } from './ServiceMailingListManagerAccountManagerAccountIdGet.operation';
...
describe('ServiceMailingListManagerAccountManagerAccountIdGet operation', () => {
