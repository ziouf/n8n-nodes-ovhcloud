...
import { description, execute } from './ServiceProtocolActiveSyncMailNotificationList.operation';
...
describe('ServiceProtocolActiveSyncMailNotificationList operation', () => {
