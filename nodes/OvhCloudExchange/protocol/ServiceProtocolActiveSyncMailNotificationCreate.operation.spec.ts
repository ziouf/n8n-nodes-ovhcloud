...
import { description, execute } from './ServiceProtocolActiveSyncMailNotificationCreate.operation';
...
describe('ServiceProtocolActiveSyncMailNotificationCreate operation', () => {
