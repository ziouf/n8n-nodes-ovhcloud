/**
 * @brief Delete Database Dump operation for private database
 *
 * HTTP DELETE request to `/hosting/privateDatabase/{serviceName}/database/{databaseName}/dump/{id}` endpoint.
 */
import type {
	IExecuteFunctions,
	INodeExecutionData,
