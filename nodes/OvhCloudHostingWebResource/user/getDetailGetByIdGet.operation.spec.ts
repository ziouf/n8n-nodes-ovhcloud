...
import { description, execute } from './getDetailGetByIdGet.operation';
...
describe('user/getDetailGetByIdGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should get user detail via GET', async () => {
		...
		it('should return user data wrapped in array', async () => {
			const mockData = { userName: 'user123' };
			(new ApiClient(mockExecuteFunctions) as any).httpGet.mockResolvedValue(mockData);
			mockExecuteFunctions.getNodeParameter.mockReturnValue('myResource');
