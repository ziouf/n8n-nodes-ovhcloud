...
/**
 * Update an account for an MS service.
 *
 * HTTP method: PUT
...
/**
 * Executes the Update Account operation.
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut(`/msServices/${serviceName}/account/${userPrincipalName}`, {
		body: updateFields,
	})) as IDataObject;
	return [{ json: data }];
}
