...
export class OvhCloudHostingPrivateDatabase implements INodeType {
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		return executeTemplate.call(this, execute, { errorContext: { resource: 'hostingPrivatedatabase', operationParam: 'hostingPrivateDatabaseOperation' } });
	}
}
