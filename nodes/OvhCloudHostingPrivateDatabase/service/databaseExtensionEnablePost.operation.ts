 ...
 *
 * HTTP method: POST
 * Endpoint: /hosting/privateDatabase/{serviceName}/database/{databaseName}/extension/{extensionName}/enable
 */
export async function execute(
	...
	const data = (await client.httpPost('/hosting' + '/' + 'privateDatabase' + '/' + encodeURIComponent(serviceName) + '/' + 'database' + '/' + encodeURIComponent(databaseName) + '/' + 'extension' + '/' + encodeURIComponent(extensionName) + '/' + 'enable')) as IDataObject;
