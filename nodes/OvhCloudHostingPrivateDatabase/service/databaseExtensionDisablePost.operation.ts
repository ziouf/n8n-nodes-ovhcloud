 ...
 *
 * HTTP method: POST
 * Endpoint: /hosting/privateDatabase/{serviceName}/database/{databaseName}/extension/{extensionName}/disable
 */
export async function execute(
	...
	const data = (await client.httpPost('/hosting' + '/' + 'privateDatabase' + '/' + encodeURIComponent(serviceName) + '/' + 'database' + '/' + encodeURIComponent(databaseName) + '/' + 'extension' + '/' + encodeURIComponent(extensionName) + '/' + 'disable')) as IDataObject;
