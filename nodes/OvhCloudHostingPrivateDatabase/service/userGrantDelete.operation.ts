...
export async function execute(
	...
	const data = (await client.httpDelete('/hosting' + '/' + 'privateDatabase' + '/' + encodeURIComponent(serviceName) + '/' + 'user' + '/' + encodeURIComponent(userName) + '/' + 'grant' + '/' + encodeURIComponent(databaseName))) as IDataObject;
