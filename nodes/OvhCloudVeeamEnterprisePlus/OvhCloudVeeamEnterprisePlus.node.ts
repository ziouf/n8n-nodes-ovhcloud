...
export class OvhCloudVeeamEnterprisePlus implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'OVH Veeam Enterprise Plus',
		name: 'ovhCloudVeeamEnterprisePlus',
		icon: OvhCloudIcon,
		group: ['input'],
		version: 1,
		subtitle:
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		return executeTemplate.call(this, execute, { errorContext: { resource: 'veeam', operationParam: 'veeamOperation' } });
	}
}
