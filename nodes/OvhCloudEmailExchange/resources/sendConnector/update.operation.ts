...
/**
 * Update a send connector for an Email Exchange service.
 *
 * HTTP method: PUT
...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		...
		},
		{
			...
			type: 'json',
			default: '{}',
			description: 'Send connector fields to update as a JSON object',
			displayOptions,
		},
	];
}
...
/**
 * Executes the Update Send Connector operation.
 */
