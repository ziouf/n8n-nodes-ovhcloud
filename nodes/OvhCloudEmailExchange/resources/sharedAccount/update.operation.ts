...
/**
 * Update a shared account for an Email Exchange service.
 *
 * HTTP method: PUT
...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		...
		},
		{
			...
			type: 'json',
			default: '{}',
			description: 'Shared account fields to update as a JSON object',
			displayOptions,
		},
	];
}
...
/**
 * Executes the Update Shared Account operation.
 */
