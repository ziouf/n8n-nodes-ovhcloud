# EmailExchange Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v1/email/exchange.json
- **Base Path**: /email/exchange
...
├── list.operation.ts      # GET /email/exchange
├── get.operation.ts       # GET /email/exchange/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getEmailExchangeServices'`)
