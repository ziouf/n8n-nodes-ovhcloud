# V2 Webhosting Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v2/webhosting.json
- **Base Path**: /v2/webhosting
...
├── list.operation.ts      # GET /v2/webhosting
└── get.operation.ts       # GET /v2/webhosting/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2WebhostingServices'`)
