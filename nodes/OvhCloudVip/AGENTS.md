...
- **API Spec**: https://eu.api.ovh.com/v1/vip.json
- **Base Path**: /vip
...
├── list.operation.ts      # GET /vip
├── get.operation.ts       # GET /vip/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getVipServices'`)
