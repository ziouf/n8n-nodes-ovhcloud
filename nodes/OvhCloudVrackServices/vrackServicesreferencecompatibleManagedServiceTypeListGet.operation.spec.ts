...
import { description, execute } from './vrackServicesreferencecompatibleManagedServiceTypeListGet.operation';
...
describe('vrackServicesreferencecompatibleManagedServiceTypeListGet operation', () => {
