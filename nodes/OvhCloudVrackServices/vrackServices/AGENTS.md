# V2 vRack Services Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v2/vrackServices.json
- **Base Path**: /v2/vrackServices
...
├── list.operation.ts      # GET /v2/vrackServices
└── get.operation.ts       # GET /v2/vrackServices/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2VrackServicesServices'`)
