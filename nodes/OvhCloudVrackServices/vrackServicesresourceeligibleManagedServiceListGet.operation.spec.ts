...
import { description, execute } from './vrackServicesresourceeligibleManagedServiceListGet.operation';
...
describe('vrackServicesresourceeligibleManagedServiceListGet operation', () => {
