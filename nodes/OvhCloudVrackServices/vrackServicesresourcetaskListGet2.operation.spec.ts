...
import { description, execute } from './vrackServicesresourcetaskListGet2.operation';
...
describe('vrackServicesresourcetaskListGet2 operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'vrackServicesId') return 'test-vrackServicesId-id';
