...
import { description, execute } from './createUserSetAsAdminPost.operation';
...
describe('containerRegistry createUserSetAsAdminPost operation', () => {
    ...
    describe('execute', () => {
        ...
        it('should call the correct API endpoint', async () => {
            ...
            mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): string | undefined => {
                const params = ['publicCloudProjectId', 'registryId', 'userId'];
