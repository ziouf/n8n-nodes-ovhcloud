...
/**
 * Executes the Delete Container Registry User operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
    ...
    await client.httpDelete(`/publicCloud/project/${projectId}/containerRegistry/${registryId}/user/${userId}`);

    return this.helpers.returnJsonArray([{ deleted: userId }]);
}
