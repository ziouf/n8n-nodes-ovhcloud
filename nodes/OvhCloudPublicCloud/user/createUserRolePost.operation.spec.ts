...
import { description, execute } from './createUserRolePost.operation';
...
describe('user createUserRolePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should assign the role to the user via POST', async () => {
