...
import { description, execute } from './deleteUserRoleDelete.operation';
...
describe('user deleteUserRoleDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should delete the user role via DELETE', async () => {
			...
			expect(result).toEqual([{ deleted: 'roleid' }]);
		});
	});
});
