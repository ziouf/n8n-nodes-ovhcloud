...
import { description, execute } from './getContainerDetailGet.operation';
...
describe('storage getContainerDetailGet operation', () => {
    ...
    describe('execute', () => {
        ...
        it('should call the correct API endpoint', async () => {
            ...
            mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): string | undefined => {
                ...
                if (param === 'containerId') return 'containerid';
                return '';
            });
