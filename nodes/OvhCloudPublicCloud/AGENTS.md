# V2 Public Cloud Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v2/publicCloud.json
- **Base Path**: /v2/publicCloud
...
├── list.operation.ts      # GET /v2/publicCloud
└── get.operation.ts       # GET /v2/publicCloud/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2PublicCloudServices'`)
