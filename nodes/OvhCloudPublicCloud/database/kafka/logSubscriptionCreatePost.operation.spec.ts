		...
		it('should call the correct API endpoint, with body', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockImplementation(
				(param: string): string | number | boolean | undefined => {
					...
					if (param === 'outputId') return 'outputId-test-value';
					if (param === 'kind') return 'kind-test-value';
					return undefined;
				},
			);
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/kafka/clusterId-test-value/log/subscription',
				{"outputId":"outputId-test-value", "kind":"kind-test-value"}
			);
