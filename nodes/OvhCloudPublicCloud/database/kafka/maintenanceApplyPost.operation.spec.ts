		...
		it('should call the correct API endpoint', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockImplementation(
				(param: string): string | number | boolean | undefined => {
					...
					if (param === 'maintenanceId') return 'maintenanceId-test-value';
					return undefined;
				},
			);
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/kafka/clusterId-test-value/maintenanceId-test-value/apply',
				undefined
			);
