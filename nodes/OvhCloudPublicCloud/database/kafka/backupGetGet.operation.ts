...
/**
 * Executes the Get Kafka Backup operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/publicCloud/project/${projectId}/kafka/${serviceName}/backup/${backupId}`)) as import('n8n-workflow').IDataObject;
