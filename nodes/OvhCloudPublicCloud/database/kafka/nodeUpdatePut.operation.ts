...
/**
 * Executes the Update Kafka Node operation.
 *
 * HTTP method: PUT
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut(`/publicCloud/project/${projectId}/kafka/${serviceName}/node/${nodeId}`, body)) as IDataObject;
