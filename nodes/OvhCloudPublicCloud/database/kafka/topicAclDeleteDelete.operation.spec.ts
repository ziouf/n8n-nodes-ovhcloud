...
import { description, execute } from './topicAclDeleteDelete.operation';
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/kafka/clusterId-test-value/topicAcl/aclId-test-value',
				undefined
			);
