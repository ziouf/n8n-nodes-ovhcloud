		...
		it('should call the correct API endpoint, with body', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockImplementation(
				(param: string): string | number | boolean | undefined => {
					...
					if (param === 'from') return 'from-test-value';
					if (param === 'to') return 'to-test-value';
					return undefined;
				},
			);
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/kafka/clusterId-test-value/log/url',
				{"from":"from-test-value", "to":"to-test-value"}
			);
