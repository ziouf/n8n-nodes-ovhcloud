...
/**
 * Executes the Get Kafka Node operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/publicCloud/project/${projectId}/kafka/${serviceName}/node/${nodeId}`)) as import('n8n-workflow').IDataObject;
