...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	if (this.getNodeParameter('kind', 0)) body.kind = this.getNodeParameter('kind', 0);
	if (this.getNodeParameter('streamId', 0)) body.streamId = this.getNodeParameter('streamId', 0);
