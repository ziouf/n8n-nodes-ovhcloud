...
/**
 * Executes the Get m3db ip restrictions operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/cloud/project/${serviceName}/database/m3db/${clusterId}/ipRestriction/${ipBlock}`)) as unknown[];
