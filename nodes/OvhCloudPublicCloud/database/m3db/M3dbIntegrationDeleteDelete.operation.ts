...
/**
 * Executes the Delete an integration operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete(`/cloud/project/${serviceName}/database/m3db/${clusterId}/integration/${integrationId}`)) as IDataObject;
