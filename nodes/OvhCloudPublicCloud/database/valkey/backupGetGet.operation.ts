...
/**
 * Executes the Get Valkey backup operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/publicCloud/project/${projectId}/cloud/database/valkey/${serviceName}/backup/${backupId}`)) as import('n8n-workflow').IDataObject;
