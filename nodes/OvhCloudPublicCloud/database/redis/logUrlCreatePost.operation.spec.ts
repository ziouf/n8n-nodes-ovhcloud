...
describe('redis logUrlCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint with body', async () => {
			const mockData = { url: 'https://logs.example.com/foo' };
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/redis/test-cluster-id/log/url',
				{ kind: 'audit' },
			);
