 ...
 *
 * HTTP method: GET
 * Endpoint: /cloud/project/{serviceName}/database/redis/{clusterId}/metric/{metricName}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(
		`/cloud/project/${serviceName}/database/redis/${clusterId}/metric/${encodeURIComponent(metricName)}`,
		qs,
	)) as IDataObject;
