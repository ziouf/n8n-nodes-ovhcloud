...
import { description, execute } from './maintenanceUpdatePut.operation';
...
describe('maintenanceUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/mysql/cluster-123/maintenance',
						expect.any(Object),
