...
/**
 * Executes the List Kafka Connect Certificate operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/publicCloud/project/${projectId}/cloud/database/kafkaConnect/${serviceName}/certificate`)) as import('n8n-workflow').IDataObject;
