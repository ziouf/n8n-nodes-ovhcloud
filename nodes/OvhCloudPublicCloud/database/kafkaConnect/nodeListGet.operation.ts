...
/**
 * Executes the List Kafka Connect Node operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/publicCloud/project/${projectId}/cloud/database/kafkaConnect/${serviceName}/node`)) as import('n8n-workflow').IDataObject;
