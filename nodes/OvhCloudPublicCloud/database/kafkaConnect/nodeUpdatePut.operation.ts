...
/**
 * Executes the Update Kafka Connect Node operation.
 *
 * HTTP method: PUT
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut(`/publicCloud/project/${projectId}/cloud/database/kafkaConnect/${serviceName}/node/${nodeId}`, body)) as IDataObject;
