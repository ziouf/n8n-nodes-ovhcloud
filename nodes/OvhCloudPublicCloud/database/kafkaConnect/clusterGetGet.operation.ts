...
/**
 * Executes the Get Kafka Connect Cluster operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/publicCloud/project/${projectId}/cloud/database/kafkaConnect/${serviceName}`)) as import('n8n-workflow').IDataObject;
