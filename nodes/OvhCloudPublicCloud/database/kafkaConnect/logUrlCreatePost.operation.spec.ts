...
describe('Logurlcreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint, with body', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/cloud/project/12345678-1234-1234-1234-1234567890ab/database/kafkaConnect/12345678-1234-1234-1234-1234567890ab/log/url', { kind: "test-value" });
