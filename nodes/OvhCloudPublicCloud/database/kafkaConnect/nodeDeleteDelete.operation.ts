...
/**
 * Executes the Delete Kafka Connect Node operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	await client.httpDelete(`/publicCloud/project/${projectId}/cloud/database/kafkaConnect/${serviceName}/node/${nodeId}`);
