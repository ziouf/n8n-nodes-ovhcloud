...
/**
 * Executes the Delete Kafka Connect Backup operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	await client.httpDelete(`/publicCloud/project/${projectId}/cloud/database/kafkaConnect/${serviceName}/backup/${backupId}`);
