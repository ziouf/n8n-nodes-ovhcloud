...
/**
 * Executes the Get Cassandra Capabilities Advanced Configuration operation.
 *
 * HTTP method: GET
 * Endpoint: /cloud/project/{serviceName}/database/cassandra/{clusterId}/capabilities/advancedConfiguration
 */
