...
/**
 * Executes the Reset Cassandra Prometheus Credentials operation.
 *
 * HTTP method: POST
 * Endpoint: /cloud/project/{serviceName}/database/cassandra/{clusterId}/prometheus/credentials/reset
 */
