...
describe('metricNameGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'metricName') return 'test-metricName-value';
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/cloud/project/test-publicCloudProjectId-value/database/m3aggregator/test-clusterId-value/metric/test-metricName-value',
				expect.any(Object)
			);
		});
	});
