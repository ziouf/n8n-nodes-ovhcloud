...
import { description, execute } from './PatternListGet.operation';
...
describe('opensearch PatternListGet operation', () => {
	describe('description', () => {
		it('should return all required parameters', () => {
			const result = description({'show': { publicCloudOperation: ['PatternListGet'] }});
