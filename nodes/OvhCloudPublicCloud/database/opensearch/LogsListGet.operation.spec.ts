...
import { description, execute } from './LogsListGet.operation';
...
describe('opensearch LogsListGet operation', () => {
	describe('description', () => {
		it('should return all required parameters', () => {
			const result = description({'show': { publicCloudOperation: ['LogsListGet'] }});
