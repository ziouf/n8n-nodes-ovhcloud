 ...
 *
 * HTTP method: PUT
 * Endpoint: /cloud/project/{serviceName}/database/opensearch/{clusterId}/user/{userId}
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut(`/cloud/project/${serviceName}/database/opensearch/${clusterId}/user/${userId}`, body as IDataObject)) as IDataObject;
