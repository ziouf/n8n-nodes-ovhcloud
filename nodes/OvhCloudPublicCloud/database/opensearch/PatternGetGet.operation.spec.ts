...
import { description, execute } from './PatternGetGet.operation';
...
describe('opensearch PatternGetGet operation', () => {
	describe('description', () => {
		it('should return all required parameters', () => {
			const result = description({'show': { publicCloudOperation: ['PatternGetGet'] }});
