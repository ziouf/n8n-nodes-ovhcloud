...
/**
 * Executes the Update IpRestriction operation.
 *
 * HTTP method: PUT
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut(`/cloud/project/${serviceName}/database/opensearch/${clusterId}/ipRestriction/${ipBlock}`, body as IDataObject)) as IDataObject;
