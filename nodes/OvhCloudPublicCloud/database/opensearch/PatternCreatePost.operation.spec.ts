...
import { description, execute } from './PatternCreatePost.operation';
...
describe('opensearch PatternCreatePost operation', () => {
	describe('description', () => {
		it('should return all required parameters', () => {
			const result = description({'show': { publicCloudOperation: ['PatternCreatePost'] }});
