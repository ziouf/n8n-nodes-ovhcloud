...
/**
 * Executes the List Clickhouse Query Statistics operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/cloud/project/${serviceName}/database/clickhouse/${clusterId}/queryStatistics`)) as import('n8n-workflow').IDataObject;
