...
import { description, execute } from './queryStatisticsResetPost.operation';
...
describe('queryStatisticsResetPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/clickhouse/cluster-123/queryStatistics/reset',
				expect.any(Object),
			);
