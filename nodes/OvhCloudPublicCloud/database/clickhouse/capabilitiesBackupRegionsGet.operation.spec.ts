...
import { description, execute } from './capabilitiesBackupRegionsGet.operation';
...
describe('capabilitiesBackupRegionsGet operation', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockImplementation(
				...
				if (param === 'publicCloudProjectId') return '12345678-1234-1234-1234-1234567890ab';
					...
					if (param === 'ipRestrictionId') return 'ip-001';
					...
					if (param === 'network') return '192.168.1.0/24';
					...
					if (param === 'flavor') return 'essential';
					if (param === 'roles') return 'admin';
					if (param === 'defaultDb') return false;
					if (param === 'comment') return 'test backup';
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/clickhouse/cluster-123/capabilities/backupRegions',
			);
