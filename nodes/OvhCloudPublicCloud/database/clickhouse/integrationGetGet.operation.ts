...
/**
 * Executes the Get Clickhouse Integration operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/cloud/project/${serviceName}/database/clickhouse/${clusterId}/integration/${integrationId}`)) as import('n8n-workflow').IDataObject;
