...
/**
 * Executes the Reset Clickhouse Prometheus Credentials operation.
 *
 * HTTP method: POST
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/cloud/project/${serviceName}/database/clickhouse/${clusterId}/prometheus/credentials/reset`, {})) as IDataObject;
