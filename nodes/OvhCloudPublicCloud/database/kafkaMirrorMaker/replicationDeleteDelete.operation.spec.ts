...
import { description, execute } from './replicationDeleteDelete.operation';
...
describe('replicationDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/kafkaMirrorMaker/cluster-123/replication/rep-001',
			);
