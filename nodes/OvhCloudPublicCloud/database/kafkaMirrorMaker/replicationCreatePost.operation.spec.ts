...
import { description, execute } from './replicationCreatePost.operation';
...
describe('replicationCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/cloud/project/12345678-1234-1234-1234-1234567890ab/database/kafkaMirrorMaker/cluster-123/replication',
				expect.any(Object),
			);
