...
/**
 * Executes the Get Kafka MirrorMaker Cluster operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/publicCloud/project/${projectId}/cloud/database/kafkaMirrorMaker/${serviceName}`)) as import('n8n-workflow').IDataObject;
