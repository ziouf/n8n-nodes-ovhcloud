...
import { description, execute } from './connectionPoolGetGet.operation';
...
describe('postgresql connectionPoolGetGet operation', () => {
	describe('description', () => {
		it('should return all required parameters', () => {
			const result = description({ show: { publicCloudOperation: ['connectionPoolGetGet'] } });
