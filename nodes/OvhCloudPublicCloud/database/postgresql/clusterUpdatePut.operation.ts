...
/**
 * Executes the Update PostgreSQL Cluster operation.
 *
 * HTTP method: PUT
 * Endpoint: /cloud/project/{serviceName}/database/postgresql/{clusterId}
 */
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPut(`/cloud/project/${serviceName}/database/postgresql/${clusterId}`, body as IDataObject)) as IDataObject;
