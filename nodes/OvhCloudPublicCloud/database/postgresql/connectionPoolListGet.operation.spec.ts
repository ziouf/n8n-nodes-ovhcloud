...
import { description, execute } from './connectionPoolListGet.operation';
...
describe('postgresql connectionPoolListGet operation', () => {
	describe('description', () => {
		it('should return all required parameters', () => {
			const result = description({ show: { publicCloudOperation: ['connectionPoolListGet'] } });
