...
/**
 * Executes the Delete PostgreSQL Connection Pool operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	await client.httpDelete(`/cloud/project/${serviceName}/database/postgresql/${clusterId}/connectionPool/${connectionPoolId}`);
