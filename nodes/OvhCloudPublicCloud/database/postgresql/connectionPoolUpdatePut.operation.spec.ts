...
import { description, execute } from './connectionPoolUpdatePut.operation';
...
describe('postgresql connectionPoolUpdatePut operation', () => {
	describe('description', () => {
		it('should return all required parameters', () => {
			const result = description({ show: { publicCloudOperation: ['connectionPoolUpdatePut'] } });
