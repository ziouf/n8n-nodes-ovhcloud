...
/**
 * Executes the Delete PostgreSQL Integration operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	await client.httpDelete(`/cloud/project/${serviceName}/database/postgresql/${clusterId}/integration/${integrationId}`);
