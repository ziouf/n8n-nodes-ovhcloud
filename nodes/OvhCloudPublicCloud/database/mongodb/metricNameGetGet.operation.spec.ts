...
import { description, execute } from './metricNameGetGet.operation';
...
describe('metricNameGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/cloud/project/test-service/database/mongodb/test-cluster-id/metric/cpu',
					expect.any(Object)
			);
