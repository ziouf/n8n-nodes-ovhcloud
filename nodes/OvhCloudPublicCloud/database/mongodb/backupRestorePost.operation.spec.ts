...
import { description, execute } from './backupRestorePost.operation';
...
describe('backupRestorePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/cloud/project/test-service/database/mongodb/test-cluster-id/backup/test-backup-id/restore'
			);
