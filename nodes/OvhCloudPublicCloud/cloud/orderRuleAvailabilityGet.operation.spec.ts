...
import { description, execute } from './orderRuleAvailabilityGet.operation';
...
describe('cloud orderRuleAvailabilityGet operation', () => {
    ...
    describe('execute', () => {
        ...
        it('should call the correct API endpoint', async () => {
            ...
            mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): string | undefined => {
                const params = ['ovhSubsidiary', 'addonFamily', 'planCode'];
