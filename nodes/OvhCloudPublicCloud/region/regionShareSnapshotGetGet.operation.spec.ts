...
import { description, execute } from './regionShareSnapshotGetGet.operation';
...
describe('region regionShareSnapshotGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint with snapshotId', async () => {
