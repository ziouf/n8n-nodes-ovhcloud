...
import { description, execute } from './gatewayDeleteDelete.operation';
...
describe('region gatewayDeleteDelete operation', () => {
...
expect(client.httpDelete).toHaveBeenCalledWith('/publicCloud/project/12345678-1234-1234-1234-1234567890ab/region/GRA63/gateway/test-id');
