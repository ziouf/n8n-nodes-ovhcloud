...
import { description, execute } from './regionGetGet.operation';
...
describe('region regionGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint with regionName', async () => {
			const mockData = { name: 'GRA63', status: 'available' };
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/publicCloud/project/12345678-1234-1234-1234-1234567890ab/region/GRA63',
			);
