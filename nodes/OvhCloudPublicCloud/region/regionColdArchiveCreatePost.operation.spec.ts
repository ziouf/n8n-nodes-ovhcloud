...
import { description, execute } from './regionColdArchiveCreatePost.operation';
...
describe('region regionColdArchiveCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint with body', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/publicCloud/project/12345678-1234-1234-1234-1234567890ab/region/GRA63/coldArchive',
