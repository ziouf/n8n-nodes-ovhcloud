...
/**
 * Executes the loadbalancing Load Balancer Log Subscription Delete Delete operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const loadBalancerIdVal = (this.getNodeParameter('loadBalancerId', 0) || '') as string;
		const subscriptionIdVal = (this.getNodeParameter('subscriptionId', 0) || '') as string;
