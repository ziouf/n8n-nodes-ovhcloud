...
import { description, execute } from './loadbalancingL7PolicyCreatePost.operation';
...
describe('region loadbalancingL7PolicyCreatePost operation', () => {
...
expect(client.httpPost).toHaveBeenCalledWith('/publicCloud/project/12345678-1234-1234-1234-1234567890ab/region/GRA63/loadbalancing/l7Policy', expect.any(Object));
