...
import { description, execute } from './loadbalancingListenerUpdatePut.operation';
...
describe('region loadbalancingListenerUpdatePut operation', () => {
...
expect(client.httpPut).toHaveBeenCalledWith('/publicCloud/project/12345678-1234-1234-1234-1234567890ab/region/GRA63/loadbalancing/listener/test-listenerId', expect.any(Object));
