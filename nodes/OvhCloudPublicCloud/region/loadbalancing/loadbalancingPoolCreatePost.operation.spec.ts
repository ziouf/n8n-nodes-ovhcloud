...
import { description, execute } from './loadbalancingPoolCreatePost.operation';
...
describe('region loadbalancingPoolCreatePost operation', () => {
...
expect(client.httpPost).toHaveBeenCalledWith('/publicCloud/project/12345678-1234-1234-1234-1234567890ab/region/GRA63/loadbalancing/pool', expect.any(Object));
