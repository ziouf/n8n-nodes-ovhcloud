 ...
 *
 * HTTP method: POST
 * Endpoint: /publicCloud/project/${projectId}/region/${regionName}/instance/${instanceId}/snapshot
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	if (this.getNodeParameter('extraLabels', 0)) {
		body.extraLabels = this.getNodeParameter('extraLabels', 0) as string;
	}
	const data = (await client.httpPost(
		`/publicCloud/project/${projectId}/region/${regionName}/instance/${instanceId}/snapshot`, body
	)) as IDataObject;
