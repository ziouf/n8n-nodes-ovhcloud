...
import { description, execute } from './regionListGet.operation';
...
describe('region regionListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			const mockData = [{ id: 'test-id', name: 'GRA63' }];
			...
			expect(result).toMatchObject([{ id: 'test-id', name: 'GRA63' }]);
		});
	});
});
