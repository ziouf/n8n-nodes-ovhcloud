...
import { description, execute } from './regionShareDeleteDelete.operation';
...
describe('region regionShareDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct DELETE API endpoint', async () => {
			...
			expect(result).toMatchObject([{ deleted: 'test-share-id' }]);
		});
	});
});
