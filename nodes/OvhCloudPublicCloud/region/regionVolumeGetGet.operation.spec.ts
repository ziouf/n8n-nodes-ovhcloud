...
import { description, execute } from './regionVolumeGetGet.operation';
...
describe('region regionVolumeGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint with volumeId', async () => {
