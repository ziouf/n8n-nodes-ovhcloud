...
import { description, execute } from './regionVolumeListGet.operation';
...
describe('region regionVolumeListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(result).toMatchObject([{ id: 'vol-id', name: 'test-volume' }]);
		});
	});
});
