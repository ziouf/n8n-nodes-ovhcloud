...
import { description, execute } from './regionShareGetGet.operation';
...
describe('region regionShareGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint with shareId', async () => {
