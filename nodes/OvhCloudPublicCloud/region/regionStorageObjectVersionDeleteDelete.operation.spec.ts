...
import { description, execute } from './regionStorageObjectVersionDeleteDelete.operation';
...
describe('region regionStorageObjectVersionDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith(
				'/publicCloud/project/12345678-1234-1234-1234-1234567890ab/region/GRA63/storage/test-name-value/object/test-key-value/version/test-versionId-value'
			);
