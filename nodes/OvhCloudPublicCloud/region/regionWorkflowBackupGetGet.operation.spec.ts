...
import { description, execute } from './regionWorkflowBackupGetGet.operation';
...
describe('region regionWorkflowBackupGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint with backupWorkflowId', async () => {
			const mockData = { id: 'backup-id', status: 'success' };
