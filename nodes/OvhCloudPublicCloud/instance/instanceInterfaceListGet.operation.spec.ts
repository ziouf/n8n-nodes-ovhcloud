...
import { description, execute } from './instanceInterfaceListGet.operation';
...
describe('instance instanceInterfaceListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should list instance interfaces via GET', async () => {
