...
/**
 * Executes the List Plan Capabilities operation.
 *
 * HTTP method: GET
 * Endpoint: /publicCloud/project/{projectId}/rancher/{rancherServiceId}/capabilities/plan
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(
		`/publicCloud/project/${projectId}/rancher/${rancherServiceId}/capabilities/plan`,
	)) as unknown[];
