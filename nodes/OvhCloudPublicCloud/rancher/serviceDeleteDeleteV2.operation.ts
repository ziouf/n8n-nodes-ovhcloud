...
/**
 * Executes the Delete Delete a managed Rancher service operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpDelete('/publicCloud/project/' + projectId + '/rancher/' + rancherId)) as IDataObject;
