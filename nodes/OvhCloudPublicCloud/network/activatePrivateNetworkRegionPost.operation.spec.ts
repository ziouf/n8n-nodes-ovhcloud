...
import { description, execute } from './activatePrivateNetworkRegionPost.operation';
...
describe('network activatePrivateNetworkRegionPost operation', () => {
    ...
    describe('execute', () => {
        ...
        it('should call the correct API endpoint', async () => {
            ...
            mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): string | undefined => {
                const params = ['publicCloudProjectId', 'pnId'];
