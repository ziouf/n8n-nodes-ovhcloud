...
/**
 * Executes the Delete Backup operation.
 *
 * HTTP method: DELETE
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	await client.httpDelete(`/publicCloud/project/${projectId}/blockStorage/backup/${backupId}`);

	return this.helpers.returnJsonArray([{ deleted: backupId }]);
}
