...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const description = (this.getNodeParameter('backupTargetSpecDescription', 0) || '') as string;
	const region = this.getNodeParameter('backupTargetSpecLocationRegion', 0) as string;
