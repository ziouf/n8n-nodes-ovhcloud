...
import { description, execute } from './encryptionKeyCreatePost.operation';
...
describe('encryptionKeyCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dbaas/logs/test-service/encryptionKey', {});
