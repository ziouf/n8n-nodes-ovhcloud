...
- **API Spec**: https://eu.api.ovh.com/v1/dbaas/logs.json
- **Base Path**: /dbaas/logs
...
├── list.operation.ts      # GET /dbaas/logs
├── get.operation.ts       # GET /dbaas/logs/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getDbaasServices'`)
