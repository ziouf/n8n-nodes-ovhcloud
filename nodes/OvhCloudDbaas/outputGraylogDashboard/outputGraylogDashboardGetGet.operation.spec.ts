...
import { description, execute } from './outputGraylogDashboardGetGet.operation';
...
describe('outputGraylogDashboardGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dbaas/logs/test-service/output/graylog/dashboard/test-dashboardId');
