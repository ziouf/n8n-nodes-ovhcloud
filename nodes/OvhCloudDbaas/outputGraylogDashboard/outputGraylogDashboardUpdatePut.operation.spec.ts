...
import { description, execute } from './outputGraylogDashboardUpdatePut.operation';
...
describe('outputGraylogDashboardUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/dbaas/logs/test-service/output/graylog/dashboard/test-dashboardId', {});
