...
import { description, execute } from './outputGraylogDashboardDuplicatePost.operation';
...
describe('outputGraylogDashboardDuplicatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dbaas/logs/test-service/output/graylog/dashboard/test-dashboardId/duplicate', {});
