...
import { description, execute } from './tokenDeleteDelete.operation';
...
describe('tokenDeleteDelete operation', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				switch (param) {
					...
					case 'tokenId': return 'test-tokenId';
					default:
						return '';
				}
			});
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/dbaas/logs/test-service/token/test-tokenId');
