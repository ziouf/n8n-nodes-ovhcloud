...
import { description, execute } from './rolePermissionListGet.operation';
...
describe('rolePermissionListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId/permission');
