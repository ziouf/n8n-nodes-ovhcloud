...
import { description, execute } from './roleDeleteDelete.operation';
...
describe('roleDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId');
