...
import { description, execute } from './rolePermissionOsdCreatePost.operation';
...
describe('rolePermissionOsdCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId/permission/osd', {});
