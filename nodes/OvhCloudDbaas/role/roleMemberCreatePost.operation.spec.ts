...
import { description, execute } from './roleMemberCreatePost.operation';
...
describe('roleMemberCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId/member', {});
