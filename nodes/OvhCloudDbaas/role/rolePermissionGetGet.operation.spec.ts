...
import { description, execute } from './rolePermissionGetGet.operation';
...
describe('rolePermissionGetGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId/permission/test-permissionId');
