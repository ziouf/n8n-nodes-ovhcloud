...
import { description, execute } from './roleMemberListGet.operation';
...
describe('roleMemberListGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId/member');
