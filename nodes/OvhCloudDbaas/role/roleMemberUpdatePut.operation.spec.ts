...
import { description, execute } from './roleMemberUpdatePut.operation';
...
describe('roleMemberUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId/member/test-username', {});
