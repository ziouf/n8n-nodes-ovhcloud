...
import { description, execute } from './rolePermissionIndexCreatePost.operation';
...
describe('rolePermissionIndexCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId/permission/index', {});
