...
import { description, execute } from './roleMemberDeleteDelete.operation';
...
describe('roleMemberDeleteDelete operation', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				switch (param) {
					...
					case 'username': return 'test-username';
					default:
						return '';
				}
			});
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId/member/test-username');
