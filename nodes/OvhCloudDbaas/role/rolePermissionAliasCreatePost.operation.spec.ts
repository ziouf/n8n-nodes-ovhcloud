...
import { description, execute } from './rolePermissionAliasCreatePost.operation';
...
describe('rolePermissionAliasCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId/permission/alias', {});
