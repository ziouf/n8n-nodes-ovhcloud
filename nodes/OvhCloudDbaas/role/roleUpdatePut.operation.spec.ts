...
import { description, execute } from './roleUpdatePut.operation';
...
describe('roleUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/dbaas/logs/test-service/role/test-roleId', {});
