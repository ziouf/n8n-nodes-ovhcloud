...
import { description, execute } from './serviceServiceInfosGet.operation';
...
describe('serviceServiceInfosGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dbaas/logs/test-service/serviceInfos');
