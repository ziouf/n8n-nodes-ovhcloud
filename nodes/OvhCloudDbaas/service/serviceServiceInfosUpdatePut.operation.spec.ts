...
import { description, execute } from './serviceServiceInfosUpdatePut.operation';
...
describe('serviceServiceInfosUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/dbaas/logs/test-service/serviceInfos', {});
