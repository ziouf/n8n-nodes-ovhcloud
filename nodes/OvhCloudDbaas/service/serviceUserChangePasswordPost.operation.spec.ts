...
import { description, execute } from './serviceUserChangePasswordPost.operation';
...
describe('serviceUserChangePasswordPost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dbaas/logs/test-service/user/changePassword', {});
