...
import { description, execute } from './serviceUrlGet.operation';
...
describe('serviceUrlGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dbaas/logs/test-service/url');
