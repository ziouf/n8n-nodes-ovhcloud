...
import { description, execute } from './outputOpenSearchOsdCreatePost.operation';
...
describe('outputOpenSearchOsdCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dbaas/logs/test-service/output/opensearch/osd', {});
