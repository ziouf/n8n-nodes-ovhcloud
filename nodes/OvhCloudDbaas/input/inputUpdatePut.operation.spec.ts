...
import { description, execute } from './inputUpdatePut.operation';
...
describe('inputUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/dbaas/logs/test-service/input/test-inputId', {});
