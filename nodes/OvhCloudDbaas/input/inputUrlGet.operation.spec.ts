...
import { description, execute } from './inputUrlGet.operation';
...
describe('inputUrlGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dbaas/logs/test-service/input/test-inputId/url');
