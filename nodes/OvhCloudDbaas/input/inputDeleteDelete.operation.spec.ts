...
import { description, execute } from './inputDeleteDelete.operation';
...
describe('inputDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/dbaas/logs/test-service/input/test-inputId');
