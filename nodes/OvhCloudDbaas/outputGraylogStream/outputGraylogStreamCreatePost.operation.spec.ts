...
import { description, execute } from './outputGraylogStreamCreatePost.operation';
...
describe('outputGraylogStreamCreatePost operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dbaas/logs/test-service/output/graylog/stream', {});
