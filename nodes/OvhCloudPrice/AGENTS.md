...
- **API Spec**: https://eu.api.ovh.com/v1/price.json
- **Base Path**: /price
...
├── list.operation.ts      # GET /price
├── get.operation.ts       # GET /price/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getPriceServices'`)
