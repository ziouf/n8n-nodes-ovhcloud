 ...
 *
 * HTTP method: GET
 * Endpoint: /price/dedicatedCloud/2013v1/bhs1a/host/monthly/{hostProfile}
 */
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
    const client = new ApiClient(this);
    const hostProfile = this.getNodeParameter('hostProfile', 0) as string;
    const data = (await client.httpGet(`/price/dedicatedCloud/2013v1/bhs1a/host/monthly/${hostProfile}`)) as IDataObject;
