...
import { description, execute } from './iamresourcetagDeleteDelete.operation';
...
describe('iamresourcetagDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'resourceURN') return 'test-resourceURN-id';
			if (param === 'key') return 'test-key-id';
				return '';
			});
