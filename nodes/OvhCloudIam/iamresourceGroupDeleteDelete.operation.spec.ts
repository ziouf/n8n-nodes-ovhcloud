...
import { description, execute } from './iamresourceGroupDeleteDelete.operation';
...
describe('iamresourceGroupDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'groupId') return 'test-groupId-id';
				return '';
			});
