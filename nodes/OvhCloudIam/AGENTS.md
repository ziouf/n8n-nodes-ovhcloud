...
- **API Spec**: https://eu.api.ovh.com/v2/iam.json
- **Base Path**: /v2/iam
...
├── list.operation.ts      # GET /v2/iam
└── get.operation.ts       # GET /v2/iam/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2IamServices'`)
