...
import { description, execute } from './iampermissionsGroupDeleteDelete.operation';
...
describe('iampermissionsGroupDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'permissionsGroupURN') return 'test-permissionsGroupURN-id';
				return '';
			});
