...
import { description, execute } from './workPlannedPartnersGet.operation';
...
describe('workPlannedPartnersGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via GET', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/connectivity/maintenance/workPlanned/partners');
