...
- **API Spec**: https://eu.api.ovh.com/v1/connectivity.json
- **Base Path**: /connectivity
...
├── list.operation.ts      # GET /connectivity
├── get.operation.ts       # GET /connectivity/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getConnectivityServices'`)
