...
import { description, execute } from './zimbraplatformaccountDeleteDelete.operation';
...
describe('zimbraplatformaccountDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'accountId') return 'test-accountId-id';
				return '';
			});
