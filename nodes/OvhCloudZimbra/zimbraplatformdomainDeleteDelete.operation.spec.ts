...
import { description, execute } from './zimbraplatformdomainDeleteDelete.operation';
...
describe('zimbraplatformdomainDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'domainId') return 'test-domainId-id';
				return '';
			});
