...
import { description, execute } from './zimbraplatformslotListGet2.operation';
...
describe('zimbraplatformslotListGet2 operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'slotId') return 'test-slotId-id';
				return '';
			});
