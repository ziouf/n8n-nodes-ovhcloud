...
import { description, execute } from './zimbraplatformredirectionDeleteDelete.operation';
...
describe('zimbraplatformredirectionDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'redirectionId') return 'test-redirectionId-id';
				return '';
			});
