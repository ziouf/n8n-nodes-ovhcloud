...
import { description, execute } from './zimbraplatformaliasDeleteDelete.operation';
...
describe('zimbraplatformaliasDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'aliasId') return 'test-aliasId-id';
				return '';
			});
