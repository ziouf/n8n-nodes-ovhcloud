...
import { description, execute } from './zimbraplatformorganizationDeleteDelete.operation';
...
describe('zimbraplatformorganizationDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'platformId') return 'test-platformId-id';
