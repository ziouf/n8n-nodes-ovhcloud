...
- **API Spec**: https://eu.api.ovh.com/v1/contact.json
- **Base Path**: /contact
...
├── list.operation.ts      # GET /contact
├── get.operation.ts       # GET /contact/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getContactServices'`)
