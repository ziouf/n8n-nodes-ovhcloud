...
import { description, execute } from './vendorObjectTypeList.operation';
...
describe('vendorObjectTypeList.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vendor/objectType');
		});
	});
});
