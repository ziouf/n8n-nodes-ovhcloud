...
import { description, execute } from './ipTaskResetTaskState.operation';
...
describe('ipTaskResetTaskState.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/ip/213.186.33.34%2F24/task/1/resetTaskState', { reason: "value" });
		});
	});
});
