...
import { description, execute } from './ipDetails.operation';
...
describe('ipDetails.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/ip/213.186.33.34%2F24/details');
		});
	});
});
