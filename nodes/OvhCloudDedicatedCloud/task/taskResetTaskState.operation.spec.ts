...
import { description, execute } from './taskResetTaskState.operation';
...
describe('taskResetTaskState.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/task/1/resetTaskState', { reason: "value" });
		});
	});
});
