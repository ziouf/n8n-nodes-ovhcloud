...
import { description, execute } from './taskChangeMaintenanceExecutionDate.operation';
...
describe('taskChangeMaintenanceExecutionDate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/task/1/changeMaintenanceExecutionDate', { executionDate: "value" });
		});
	});
});
