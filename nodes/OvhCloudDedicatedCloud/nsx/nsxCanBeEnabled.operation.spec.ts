...
import { description, execute } from './nsxCanBeEnabled.operation';
...
describe('nsxCanBeEnabled.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/nsx/canBeEnabled');
		});
	});
});
