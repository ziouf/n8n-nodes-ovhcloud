...
import { description, execute } from './nsxGet.operation';
...
describe('nsxGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/nsx');
		});
	});
});
