...
import { description, execute } from './hdsCanBeDisabled.operation';
...
describe('hdsCanBeDisabled.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/hds/canBeDisabled');
		});
	});
});
