...
import { description, execute } from './hdsGet.operation';
...
describe('hdsGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/hds');
		});
	});
});
