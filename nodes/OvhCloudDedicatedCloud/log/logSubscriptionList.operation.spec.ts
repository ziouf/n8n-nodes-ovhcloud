...
import { description, execute } from './logSubscriptionList.operation';
...
describe('logSubscriptionList.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/log/subscription', { kind: 'value' });
		});
	});
});
