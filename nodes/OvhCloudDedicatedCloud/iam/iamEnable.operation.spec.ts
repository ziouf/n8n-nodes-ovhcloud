...
import { description, execute } from './iamEnable.operation';
...
describe('iamEnable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/iam/enable');
		});
	});
});
