...
import { description, execute } from './iamCanBeDisabled.operation';
...
describe('iamCanBeDisabled.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/iam/canBeDisabled');
		});
	});
});
