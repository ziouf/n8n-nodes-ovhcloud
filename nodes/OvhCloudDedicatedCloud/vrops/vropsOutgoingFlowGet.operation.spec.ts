...
import { description, execute } from './vropsOutgoingFlowGet.operation';
...
describe('vropsOutgoingFlowGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vrops/outgoingFlow/1');
		});
	});
});
