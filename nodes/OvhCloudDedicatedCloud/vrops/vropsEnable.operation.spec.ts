...
import { description, execute } from './vropsEnable.operation';
...
describe('vropsEnable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vrops/enable');
		});
	});
});
