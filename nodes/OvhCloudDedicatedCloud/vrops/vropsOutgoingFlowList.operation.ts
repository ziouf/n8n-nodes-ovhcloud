...
/**
 * Executes the List Aria Operations Outgoing Flows operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicatedCloud/${serviceName}/vrops/outgoingFlow`)) as IDataObject;
