...
import { description, execute } from './vropsOutgoingFlowCreate.operation';
...
describe('vropsOutgoingFlowCreate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vrops/outgoingFlow', { description: 'value', ip: 'value', servicePort: 1 });
		});
	});
});
