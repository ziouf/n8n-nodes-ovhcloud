...
import { description, execute } from './vropsOutgoingFlowList.operation';
...
describe('vropsOutgoingFlowList.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vrops/outgoingFlow');
		});
	});
});
