...
import { description, execute } from './vropsUpgrade.operation';
...
describe('vropsUpgrade.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vrops/upgrade', { version: 'value' });
		});
	});
});
