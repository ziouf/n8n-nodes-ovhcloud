...
import { description, execute } from './vropsDisable.operation';
...
describe('vropsDisable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vrops/disable');
		});
	});
});
