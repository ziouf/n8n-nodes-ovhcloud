...
import { description, execute } from './userObjectRightList.operation';
...
describe('userObjectRightList.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/user/1/objectRight');
		});
	});
});
