...
import { description, execute } from './userTaskChangeMaintenanceExecutionDate.operation';
...
describe('userTaskChangeMaintenanceExecutionDate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/user/1/task/1/changeMaintenanceExecutionDate', { executionDate: "value" });
		});
	});
});
