...
import { description, execute } from './userTaskResetTaskState.operation';
...
describe('userTaskResetTaskState.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/user/1/task/1/resetTaskState', { reason: "value" });
		});
	});
});
