...
import { description, execute } from './userTaskGet.operation';
...
describe('userTaskGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/user/1/task/1');
		});
	});
});
