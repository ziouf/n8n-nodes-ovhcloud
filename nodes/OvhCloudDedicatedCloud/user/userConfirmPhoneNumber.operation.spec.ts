...
import { description, execute } from './userConfirmPhoneNumber.operation';
...
describe('userConfirmPhoneNumber.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/user/1/confirmPhoneNumber', { token: "value" });
		});
	});
});
