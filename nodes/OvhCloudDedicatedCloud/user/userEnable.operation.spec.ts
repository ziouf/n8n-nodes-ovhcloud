...
import { description, execute } from './userEnable.operation';
...
describe('userEnable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/user/1/enable');
		});
	});
});
