...
import { description, execute } from './hostResilienceDisable.operation';
...
describe('hostResilienceDisable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/host/1/resilience/disable');
		});
	});
});
