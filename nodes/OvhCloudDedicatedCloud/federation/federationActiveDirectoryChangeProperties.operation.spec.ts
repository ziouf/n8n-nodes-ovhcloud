...
import { description, execute } from './federationActiveDirectoryChangeProperties.operation';
...
describe('federationActiveDirectoryChangeProperties.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				if (param === 'activeDirectoryId') return 1;
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/federation/activeDirectory/1/changeProperties', { description: 'value', password: 'value', sslThumbprint: 'value', username: 'value' });
		});
	});
});
