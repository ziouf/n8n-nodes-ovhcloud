...
import { description, execute } from './federationActiveDirectoryGet.operation';
...
describe('federationActiveDirectoryGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/federation/activeDirectory/1');
		});
	});
});
