...
import { description, execute } from './twoFAWhitelistChangeProperties.operation';
...
describe('twoFAWhitelistChangeProperties.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/twoFAWhitelist/1/changeProperties', { description: 'value' });
		});
	});
});
