...
/**
 * Executes the List Two Factor Authentication Whitelisted Networks operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicatedCloud/${serviceName}/twoFAWhitelist`)) as IDataObject;
