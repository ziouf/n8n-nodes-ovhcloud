...
import { description, execute } from './twoFAWhitelistCreate.operation';
...
describe('twoFAWhitelistCreate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/twoFAWhitelist', { description: 'value', ip: 'value' });
		});
	});
});
