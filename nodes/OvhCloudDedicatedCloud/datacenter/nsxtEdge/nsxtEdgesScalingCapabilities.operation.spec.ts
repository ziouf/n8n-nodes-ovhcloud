...
import { description, execute } from './nsxtEdgesScalingCapabilities.operation';
...
describe('nsxtEdgesScalingCapabilities.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			client.httpGet.mockResolvedValue({ number: 4 });
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/dedicatedCloud/pcc-123-456-789/datacenter/1/nsxtEdgesScalingCapabilities',
			);
		});
	});
});
