...
import { description, execute } from './nsxtEdgeRelocateEdge.operation';
...
describe('nsxtEdgeRelocateEdge.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				...
				if (param === 'datastore') return 'value';
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/nsxtEdge/1/relocateEdge', { datastore: 'value', hostId: 1 });
		});
	});
});
