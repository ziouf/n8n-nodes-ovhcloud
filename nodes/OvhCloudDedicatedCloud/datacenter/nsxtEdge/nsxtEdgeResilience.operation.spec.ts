...
import { description, execute } from './nsxtEdgeResilience.operation';
...
describe('nsxtEdgeResilience.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/nsxtEdge/1/resilience');
		});
	});
});
