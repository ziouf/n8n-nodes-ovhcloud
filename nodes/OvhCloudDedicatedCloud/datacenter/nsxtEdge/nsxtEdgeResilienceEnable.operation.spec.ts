...
import { description, execute } from './nsxtEdgeResilienceEnable.operation';
...
describe('nsxtEdgeResilienceEnable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/nsxtEdge/1/resilience/enable', { duration: 1 });
		});
	});
});
