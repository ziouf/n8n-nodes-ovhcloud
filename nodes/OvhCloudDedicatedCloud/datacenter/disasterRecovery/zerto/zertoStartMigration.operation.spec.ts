...
import { description, execute } from './zertoStartMigration.operation';
...
describe('zertoStartMigration.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/disasterRecovery/zerto/startMigration');
		});
	});
});
