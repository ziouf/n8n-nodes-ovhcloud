...
import { description, execute } from './zertoSingleVraResourcesUpdate.operation';
...
describe('zertoSingleVraResourcesUpdate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				...
				if (param === 'resourcesSize') return 'L';
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/disasterRecovery/zertoSingle/vraResources', { resourcesSize: 'L', vmId: 1 });
		});
	});
});
