...
import { description, execute } from './zertoSingleRequestPairingToken.operation';
...
describe('zertoSingleRequestPairingToken.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/disasterRecovery/zertoSingle/requestPairingToken');
		});
	});
});
