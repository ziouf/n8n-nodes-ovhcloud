...
import { description, execute } from './datacenterOrderNewHostHourly.operation';
...
describe('datacenterOrderNewHostHourly.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				...
				if (param === 'vmwareClusterId') return 'value';
				return undefined;
			});
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/orderNewHostHourly', { name: "value", vmwareClusterId: "value" });
		});
	});
});
