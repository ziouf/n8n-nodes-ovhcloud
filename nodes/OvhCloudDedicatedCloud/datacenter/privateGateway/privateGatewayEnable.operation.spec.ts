...
import { description, execute } from './privateGatewayEnable.operation';
...
describe('privateGatewayEnable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/privateGateway/enable', { ip: 'value', netmask: 'value', portgroup: 'value' });
		});
	});
});
