...
import { description, execute } from './datacenterBackupOfferCapabilities.operation';
...
describe('datacenterBackupOfferCapabilities.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/backup/offerCapabilities');
		});
	});
});
