...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const backupJobName = this.getNodeParameter('backupJobName', itemIndex, '') as string; if (backupJobName !== '') { body.backupJobName = backupJobName; }
	body.backupRepositoryName = this.getNodeParameter('backupRepositoryName', itemIndex) as string;
