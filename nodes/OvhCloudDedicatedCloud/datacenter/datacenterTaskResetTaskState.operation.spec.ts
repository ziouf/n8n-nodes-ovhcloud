...
import { description, execute } from './datacenterTaskResetTaskState.operation';
...
describe('datacenterTaskResetTaskState.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/task/1/resetTaskState', { reason: "value" });
		});
	});
});
