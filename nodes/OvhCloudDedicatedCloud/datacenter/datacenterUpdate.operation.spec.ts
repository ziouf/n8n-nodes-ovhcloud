...
import { description, execute } from './datacenterUpdate.operation';
...
describe('datacenterUpdate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1', { description: "value" });
		});
	});
});
