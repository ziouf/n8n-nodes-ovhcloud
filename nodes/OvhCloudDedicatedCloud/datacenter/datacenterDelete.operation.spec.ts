...
import { description, execute } from './datacenterDelete.operation';
...
describe('datacenterDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1');
		});
	});
});
