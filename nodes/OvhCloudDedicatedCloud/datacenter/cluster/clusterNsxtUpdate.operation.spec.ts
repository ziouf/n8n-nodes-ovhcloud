...
import { description, execute } from './clusterNsxtUpdate.operation';
...
describe('clusterNsxtUpdate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/cluster/1/nsxt');
		});
	});
});
