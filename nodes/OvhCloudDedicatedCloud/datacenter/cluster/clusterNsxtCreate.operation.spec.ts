...
import { description, execute } from './clusterNsxtCreate.operation';
...
describe('clusterNsxtCreate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/cluster/1/nsxt');
		});
	});
});
