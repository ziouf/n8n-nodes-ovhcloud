...
import { description, execute } from './datacenterBackupRepositoryGet.operation';
...
describe('datacenterBackupRepositoryGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			mockExecuteFunctions.getNodeParameter.mockImplementation((param: string): any => {
				...
				if (param === 'repositoryId') return 1;
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/backupRepository/1');
		});
	});
});
