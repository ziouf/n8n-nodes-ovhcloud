...
import { description, execute } from './confirmTermination.operation';
...
describe('confirmTermination.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/confirmTermination', { commentary: "value", futureUse: "value", reason: "value", token: "value" });
		});
	});
});
