...
import { description, execute } from './passwordPolicyGet.operation';
...
describe('passwordPolicyGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/passwordPolicy');
		});
	});
});
