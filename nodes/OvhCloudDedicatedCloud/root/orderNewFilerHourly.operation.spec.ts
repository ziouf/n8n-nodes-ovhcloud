...
import { description, execute } from './orderNewFilerHourly.operation';
...
describe('orderNewFilerHourly.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/orderNewFilerHourly', { name: 'value' });
		});
	});
});
