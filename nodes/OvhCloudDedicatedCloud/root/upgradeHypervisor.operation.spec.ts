...
import { description, execute } from './upgradeHypervisor.operation';
...
describe('upgradeHypervisor.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/upgradeHypervisor');
		});
	});
});
