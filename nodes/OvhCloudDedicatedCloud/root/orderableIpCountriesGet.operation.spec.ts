...
import { description, execute } from './orderableIpCountriesGet.operation';
...
describe('orderableIpCountriesGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/orderableIpCountries');
		});
	});
});
