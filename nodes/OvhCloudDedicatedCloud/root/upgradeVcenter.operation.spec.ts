...
import { description, execute } from './upgradeVcenter.operation';
...
describe('upgradeVcenter.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/upgradeVcenter', { release: 'major' });
		});
	});
});
