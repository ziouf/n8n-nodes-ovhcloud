...
import { description, execute } from './vmwareCloudDirectorEligibility.operation';
...
describe('vmwareCloudDirectorEligibility.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vmwareCloudDirectorEligibility');
		});
	});
});
