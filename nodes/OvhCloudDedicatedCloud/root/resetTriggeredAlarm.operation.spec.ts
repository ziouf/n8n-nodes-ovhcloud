...
import { description, execute } from './resetTriggeredAlarm.operation';
...
describe('resetTriggeredAlarm.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/resetTriggeredAlarm');
		});
	});
});
