...
import { description, execute } from './generateNsxvInventory.operation';
...
describe('generateNsxvInventory.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/generateNsxvInventory');
		});
	});
});
