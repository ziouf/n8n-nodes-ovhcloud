...
/**
 * Executes the List networks allowed on infrastructure firewall operation.
 *
 * HTTP method: GET
...
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/dedicatedCloud/${serviceName}/allowedNetwork`)) as IDataObject;
