...
import { description, execute } from './allowedNetworkDelete.operation';
...
describe('allowedNetworkDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/allowedNetwork/1');
		});
	});
});
