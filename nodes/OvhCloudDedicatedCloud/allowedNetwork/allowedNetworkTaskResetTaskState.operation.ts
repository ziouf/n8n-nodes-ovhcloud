...
export function description(displayOptions: IDisplayOptions): INodeProperties[] {
	return [
		destructiveActionNotice('This will reset the allowed network task reset task state. This action is irreversible.', displayOptions),
		{
			...SERVICE_NAME_2,
			displayOptions,
		},
 ...
 *
 * HTTP method: POST
 * Endpoint: /dedicatedCloud/{serviceName}/allowedNetwork/{networkAccessId}/task/{taskId}/resetTaskState
 */
export async function execute(this: IExecuteFunctions, _itemIndex: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost(`/dedicatedCloud/${serviceName}/allowedNetwork/${networkAccessId}/task/${taskId}/resetTaskState`, body)) as IDataObject;
