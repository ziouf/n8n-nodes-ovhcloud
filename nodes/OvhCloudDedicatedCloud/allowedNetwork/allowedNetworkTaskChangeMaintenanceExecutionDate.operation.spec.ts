...
import { description, execute } from './allowedNetworkTaskChangeMaintenanceExecutionDate.operation';
...
describe('allowedNetworkTaskChangeMaintenanceExecutionDate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/allowedNetwork/1/task/1/changeMaintenanceExecutionDate', { executionDate: "value" });
		});
	});
});
