...
import { description, execute } from './allowedNetworkTaskGet.operation';
...
describe('allowedNetworkTaskGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/allowedNetwork/1/task/1');
		});
	});
});
