...
import { description, execute } from './allowedNetworkGet.operation';
...
describe('allowedNetworkGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/allowedNetwork/1');
		});
	});
});
