...
import { description, execute } from './allowedNetworkCreate.operation';
...
describe('allowedNetworkCreate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/allowedNetwork', { description: "value", network: "value" });
		});
	});
});
