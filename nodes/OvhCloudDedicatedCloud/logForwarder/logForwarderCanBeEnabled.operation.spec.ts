...
import { description, execute } from './logForwarderCanBeEnabled.operation';
...
describe('logForwarderCanBeEnabled.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/logForwarder/canBeEnabled');
		});
	});
});
