...
import { description, execute } from './logForwarderCanBeDisabled.operation';
...
describe('logForwarderCanBeDisabled.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/logForwarder/canBeDisabled');
		});
	});
});
