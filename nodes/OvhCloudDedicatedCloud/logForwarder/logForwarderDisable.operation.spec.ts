...
import { description, execute } from './logForwarderDisable.operation';
...
describe('logForwarderDisable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/logForwarder/disable');
		});
	});
});
