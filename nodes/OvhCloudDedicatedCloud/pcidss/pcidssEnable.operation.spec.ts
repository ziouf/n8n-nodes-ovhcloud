...
import { description, execute } from './pcidssEnable.operation';
...
describe('pcidssEnable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/pcidss/enable');
		});
	});
});
