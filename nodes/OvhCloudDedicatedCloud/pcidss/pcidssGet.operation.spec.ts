...
import { description, execute } from './pcidssGet.operation';
...
describe('pcidssGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/pcidss');
		});
	});
});
