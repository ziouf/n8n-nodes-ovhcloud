...
import { description, execute } from './pcidssCanBeDisabled.operation';
...
describe('pcidssCanBeDisabled.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/pcidss/canBeDisabled');
		});
	});
});
