...
import { description, execute } from './vmRestorePointRestore.operation';
...
describe('vmRestorePointRestore.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/vm/1/backupJob/restorePoints/1/restore', { filerId: 0 });
		});
	});
});
