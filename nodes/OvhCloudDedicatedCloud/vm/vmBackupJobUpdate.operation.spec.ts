...
import { description, execute } from './vmBackupJobUpdate.operation';
...
describe('vmBackupJobUpdate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/vm/1/backupJob', { backupDays: ["Monday", "Friday"] });
		});
	});
});
