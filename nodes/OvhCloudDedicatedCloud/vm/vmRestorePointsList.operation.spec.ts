...
import { description, execute } from './vmRestorePointsList.operation';
...
describe('vmRestorePointsList.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/vm/1/backupJob/restorePoints');
		});
	});
});
