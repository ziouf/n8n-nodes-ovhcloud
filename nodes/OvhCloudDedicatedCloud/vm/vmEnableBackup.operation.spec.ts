...
import { description, execute } from './vmEnableBackup.operation';
...
describe('vmEnableBackup.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/vm/1/enableBackup', { backupDays: ["Monday", "Friday"] });
		});
	});
});
