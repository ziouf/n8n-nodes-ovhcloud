...
import { description, execute } from './securityOptionsResumePendingEnabling.operation';
...
describe('securityOptionsResumePendingEnabling.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/securityOptions/resumePendingEnabling', { option: 'accessNetworkFiltered' });
		});
	});
});
