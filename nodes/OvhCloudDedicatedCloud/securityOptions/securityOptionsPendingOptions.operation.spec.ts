...
import { description, execute } from './securityOptionsPendingOptions.operation';
...
describe('securityOptionsPendingOptions.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/securityOptions/pendingOptions');
		});
	});
});
