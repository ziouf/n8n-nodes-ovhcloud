...
import { description, execute } from './robotGet.operation';
...
describe('robotGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/robot/value');
		});
	});
});
