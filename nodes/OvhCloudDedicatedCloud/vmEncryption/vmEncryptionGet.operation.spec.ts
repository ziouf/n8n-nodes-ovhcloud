...
import { description, execute } from './vmEncryptionGet.operation';
...
describe('vmEncryptionGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vmEncryption');
		});
	});
});
