...
import { description, execute } from './vmEncryptionKmsChangeProperties.operation';
...
describe('vmEncryptionKmsChangeProperties.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/vmEncryption/kms/1/changeProperties', { description: 'value', sslThumbprint: 'value' });
		});
	});
});
