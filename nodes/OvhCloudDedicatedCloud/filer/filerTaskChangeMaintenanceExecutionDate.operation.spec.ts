...
import { description, execute } from './filerTaskChangeMaintenanceExecutionDate.operation';
...
describe('filerTaskChangeMaintenanceExecutionDate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/filer/1/task/1/changeMaintenanceExecutionDate', { executionDate: "value" });
		});
	});
});
