...
import { description, execute } from './filerConvertToGlobal.operation';
...
describe('filerConvertToGlobal.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/datacenter/1/filer/1/convertToGlobal');
		});
	});
});
