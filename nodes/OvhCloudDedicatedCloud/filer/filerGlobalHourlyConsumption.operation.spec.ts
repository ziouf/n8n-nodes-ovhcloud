...
import { description, execute } from './filerGlobalHourlyConsumption.operation';
...
describe('filerGlobalHourlyConsumption.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			client.httpGet.mockResolvedValue({ value: 42 });
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/dedicatedCloud/pcc-123-456-789/filer/1/hourlyConsumption',
			);
		});
	});
});
