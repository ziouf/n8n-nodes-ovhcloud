...
import { description, execute } from './filerGlobalConvertToGlobal.operation';
...
describe('filerGlobalConvertToGlobal.operation', () => {
	...
	describe('execute', () => {
		...
		it('should POST to the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith(
				'/dedicatedCloud/pcc-123-456-789/filer/1/convertToGlobal',
			);
		});
	});
});
