...
import { description, execute } from './filerGlobalCheckGlobalCompatible.operation';
...
describe('filerGlobalCheckGlobalCompatible.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			client.httpGet.mockResolvedValue(true);
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/dedicatedCloud/pcc-123-456-789/filer/1/checkGlobalCompatible',
			);
		});
	});
});
