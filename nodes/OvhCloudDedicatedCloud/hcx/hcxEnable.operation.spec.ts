...
import { description, execute } from './hcxEnable.operation';
...
describe('hcxEnable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/hcx/enable');
		});
	});
});
