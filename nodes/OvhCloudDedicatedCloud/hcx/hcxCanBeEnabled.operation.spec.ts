...
import { description, execute } from './hcxCanBeEnabled.operation';
...
describe('hcxCanBeEnabled.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/hcx/canBeEnabled');
		});
	});
});
