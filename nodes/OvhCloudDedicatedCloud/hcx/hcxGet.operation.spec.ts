...
import { description, execute } from './hcxGet.operation';
...
describe('hcxGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/hcx');
		});
	});
});
