...
import { description, execute } from './hostProfileServiceList.operation';
...
describe('hostProfileServiceList.operation', () => {
	...
	describe('execute', () => {
		...
		it('should list host profiles via GET and respect limit', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/dedicatedCloud/pcc-123-456-789/location/hostProfile',
			);
