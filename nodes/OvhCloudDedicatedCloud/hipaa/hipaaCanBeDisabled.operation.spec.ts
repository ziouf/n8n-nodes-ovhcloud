...
import { description, execute } from './hipaaCanBeDisabled.operation';
...
describe('hipaaCanBeDisabled.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/hipaa/canBeDisabled');
		});
	});
});
