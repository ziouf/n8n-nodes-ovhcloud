...
import { description, execute } from './hipaaEnable.operation';
...
describe('hipaaEnable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/hipaa/enable');
		});
	});
});
