...
import { description, execute } from './hipaaDisable.operation';
...
describe('hipaaDisable.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPost).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/hipaa/disable');
		});
	});
});
