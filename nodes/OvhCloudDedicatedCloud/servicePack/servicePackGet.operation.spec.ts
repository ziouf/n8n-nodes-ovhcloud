...
import { description, execute } from './servicePackGet.operation';
...
describe('servicePackGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/servicePack');
		});
	});
});
