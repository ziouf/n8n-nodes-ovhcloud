...
import { description, execute } from './serviceInfosUpdate.operation';
...
describe('serviceInfosUpdate.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/serviceInfos', { canDeleteAtExpiration: true });
		});
	});
});
