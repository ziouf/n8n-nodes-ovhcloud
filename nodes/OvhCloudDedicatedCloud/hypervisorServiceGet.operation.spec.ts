...
import { description, execute } from './hypervisorServiceGet.operation';
...
describe('hypervisorServiceGet.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			client.httpGet.mockResolvedValue({ name: 'hgr-01' });
			...
			expect(client.httpGet).toHaveBeenCalledWith(
				'/dedicatedCloud/pcc-123-456-789/location/hypervisor/hgr-01',
			);
		});
	});
});
