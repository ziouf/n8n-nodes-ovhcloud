...
import { description, execute } from './servicePacksList.operation';
...
describe('servicePacksList.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/servicePacks');
		});
	});
});
