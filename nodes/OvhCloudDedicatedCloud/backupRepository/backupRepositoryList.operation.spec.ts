...
import { description, execute } from './backupRepositoryList.operation';
...
describe('backupRepositoryList.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct endpoint', async () => {
			...
			expect(client.httpGet).toHaveBeenCalledWith('/dedicatedCloud/pcc-123-456-789/backupRepository');
		});
	});
});
