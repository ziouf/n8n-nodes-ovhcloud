# V2 Commercial Catalog Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v2/commercialCatalog.json
- **Base Path**: /v2/commercialCatalog
...
├── list.operation.ts      # GET /v2/commercialCatalog
└── get.operation.ts       # GET /v2/commercialCatalog/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2CommercialCatalogServices'`)
