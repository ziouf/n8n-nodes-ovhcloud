...
import { description, execute } from './DomainChangeContactCreate.operation';
...
describe('DomainChangeContactCreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'contactAdmin') return 'contactAdmin-test';
			if (param === 'contactBilling') return 'contactBilling-test';
			if (param === 'contactTech') return 'contactTech-test';
				return '';
			});
