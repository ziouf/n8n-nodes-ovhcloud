...
import { description, execute } from './DomainAccountMigrateDestinationEmailList.operation';
...
describe('DomainAccountMigrateDestinationEmailList operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'quota') return 'quota-test';
				return '';
			});
