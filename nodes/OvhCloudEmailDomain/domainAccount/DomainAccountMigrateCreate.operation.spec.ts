...
import { description, execute } from './DomainAccountMigrateCreate.operation';
...
describe('DomainAccountMigrateCreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'destinationEmailAddress') return 'destinationEmailAddress-test';
			if (param === 'destinationServiceName') return 'destinationServiceName-test';
			if (param === 'domain') return 'domain-test';
			if (param === 'password') return 'password-test';
				return '';
			});
