	...
	return [
		{
			...
			displayOptions: {
				show: {
					emailDomainOperation: ['DomainAccountDelegationCreate'],
				},
				...displayOptions,
			},
		},
...
export async function execute(this: IExecuteFunctions, _itemIndex?: number): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpPost('/email' + '/domain/' + encodeURIComponent(domain) + '/account/' + encodeURIComponent(accountName) + '/delegation', body)) as IDataObject;
