...
import { description, execute } from './DomainAccountCreate.operation';
...
describe('DomainAccountCreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'description') return 'description-test';
			if (param === 'password') return 'password-test';
			if (param === 'size') return 'size-test';
				return '';
			});
