...
import { description, execute } from './DomainMailingListCreate.operation';
...
describe('DomainMailingListCreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'language') return 'language-test';
			if (param === 'name') return 'name-test';
			if (param === 'options') return 'options-test';
			if (param === 'ownerEmail') return 'ownerEmail-test';
			if (param === 'replyTo') return 'replyTo-test';
				return '';
			});
