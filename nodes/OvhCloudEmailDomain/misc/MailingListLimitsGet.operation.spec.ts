...
import { description, execute } from './MailingListLimitsGet.operation';
...
describe('MailingListLimitsGet operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'moderatorMessage') return 'moderatorMessage-test';
				return '';
			});
