...
import { description, execute } from './DelegatedAccountFilterChangeActivityCreate.operation';
...
describe('DelegatedAccountFilterChangeActivityCreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'activity') return 'activity-test';
				return '';
			});
