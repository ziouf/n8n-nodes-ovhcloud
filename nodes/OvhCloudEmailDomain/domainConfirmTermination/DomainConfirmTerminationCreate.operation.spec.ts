...
import { description, execute } from './DomainConfirmTerminationCreate.operation';
...
describe('DomainConfirmTerminationCreate operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'commentary') return 'commentary-test';
			if (param === 'reason') return 'reason-test';
			if (param === 'token') return 'token-test';
				return '';
			});
