# V2 Network Defense Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v2/networkDefense.json
- **Base Path**: /v2/networkDefense
...
├── list.operation.ts      # GET /v2/networkDefense
└── get.operation.ts       # GET /v2/networkDefense/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2NetworkDefenseServices'`)
