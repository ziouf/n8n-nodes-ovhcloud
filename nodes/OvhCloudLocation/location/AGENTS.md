# V2 Location Resource

## API Documentation

- **API Spec**: https://eu.api.ovh.com/v2/location.json
- **Base Path**: /v2/location
...
├── list.operation.ts      # GET /v2/location
└── get.operation.ts       # GET /v2/location/{serviceName}
```
...
4. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getV2LocationServices'`)
