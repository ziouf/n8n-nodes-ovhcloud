...
describe('updatePut.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via PUT', async () => {
				...
				(param: string, _idx?: number, def?: any, opts?: any): any => {
					...
					switch (param) {
						...
						case 'customerDescription':
							return 'customerDescription-v';
						case 'releaseChannel':
							return 'releaseChannel-v';
						default:
			...
			expect(client.httpPut).toHaveBeenCalledWith('/overTheBox/svc-1', {
				autoUpgrade: false,
				customerDescription: 'customerDescription-v',
				releaseChannel: 'releaseChannel-v',
			});
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpPut).toHaveBeenCalledWith('/overTheBox/svc%201', {});
		});
	});
});
