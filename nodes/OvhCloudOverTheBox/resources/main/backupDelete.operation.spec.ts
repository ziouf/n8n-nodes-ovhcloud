...
import { description, execute } from './backupDelete.operation';
...
describe('backupDelete.operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint via DELETE', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/overTheBox/svc-1/backups/backupId-v');
		...
		it('should encode special characters in serviceName', async () => {
			...
			expect(client.httpDelete).toHaveBeenCalledWith('/overTheBox/svc%201/backups/backupId-v');
		});
	});
});
