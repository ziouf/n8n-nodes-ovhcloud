...
/** List all available offers one can migrate to. HTTP: GET /overTheBox/{serviceName}/migration/offers */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	const data = (await client.httpGet(`/overTheBox/${serviceName}/migration/offers`)) as IDataObject[];
