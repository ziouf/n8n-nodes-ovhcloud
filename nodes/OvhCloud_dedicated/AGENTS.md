...
- **API Specs**:
  - https://eu.api.ovh.com/v1/dedicated/server.json
  - https://eu.api.ovh.com/v1/dedicated/ceph.json
  - https://eu.api.ovh.com/v1/dedicated/cluster.json
  - https://eu.api.ovh.com/v1/dedicated/housing.json
  - https://eu.api.ovh.com/v1/dedicated/installationTemplate.json
  - https://eu.api.ovh.com/v1/dedicatedCloud.json
- **Base Path**: /dedicated/server
...
├── list.operation.ts      # GET /dedicated/server
├── get.operation.ts       # GET /dedicated/server/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getDedicatedServices'`)
