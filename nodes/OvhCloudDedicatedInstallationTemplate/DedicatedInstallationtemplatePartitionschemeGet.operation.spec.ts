import { description, execute } from './DedicatedInstallationtemplatePartitionschemeGet.operation';
...
describe('DedicatedInstallationtemplatePartitionschemeGet operation', () => {
