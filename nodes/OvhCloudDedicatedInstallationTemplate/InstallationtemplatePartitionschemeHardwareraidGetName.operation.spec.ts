import { description, execute } from './InstallationtemplatePartitionschemeHardwareraidGetName.operation';
...
describe('InstallationtemplatePartitionschemeHardwareraidGetName operation', () => {
