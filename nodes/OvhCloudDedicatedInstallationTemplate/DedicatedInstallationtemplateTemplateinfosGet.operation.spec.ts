import { description, execute } from './DedicatedInstallationtemplateTemplateinfosGet.operation';
...
describe('DedicatedInstallationtemplateTemplateinfosGet operation', () => {
