...
import { description, execute } from './InstallationtemplatePartitionschemePartitionGet.operation';
...
describe('InstallationtemplatePartitionschemePartitionGet operation', () => {
