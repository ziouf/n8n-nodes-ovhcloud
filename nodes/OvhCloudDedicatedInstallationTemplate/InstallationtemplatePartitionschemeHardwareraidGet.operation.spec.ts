...
import { description, execute } from './InstallationtemplatePartitionschemeHardwareraidGet.operation';
...
describe('InstallationtemplatePartitionschemeHardwareraidGet operation', () => {
