...
import { description, execute } from './backupServicestenantvspcbackupPoliciesListGet.operation';
...
describe('backupServicestenantvspcbackupPoliciesListGet operation', () => {
