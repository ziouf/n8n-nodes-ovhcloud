...
import { description, execute } from './backupServicestenantvaultUpdatePut.operation';
...
describe('backupServicestenantvaultUpdatePut operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'vaultId') return 'test-vaultId-id';
				return '';
			});
