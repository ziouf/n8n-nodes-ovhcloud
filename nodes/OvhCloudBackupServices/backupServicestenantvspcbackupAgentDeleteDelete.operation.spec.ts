...
import { description, execute } from './backupServicestenantvspcbackupAgentDeleteDelete.operation';
...
describe('backupServicestenantvspcbackupAgentDeleteDelete operation', () => {
	...
	describe('execute', () => {
		...
		it('should call the correct API endpoint', async () => {
			...
			if (param === 'backupServicesId') return 'test-backupServicesId-id';
			if (param === 'vspcTenantId') return 'test-vspcTenantId-id';
			if (param === 'backupAgentId') return 'test-backupAgentId-id';
				return '';
			});
