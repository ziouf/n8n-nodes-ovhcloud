...
import { description, execute } from './backupServicestenantvspcbackupAgentCreatePost.operation';
...
describe('backupServicestenantvspcbackupAgentCreatePost operation', () => {
