...
export class OvhCloudBackupServices implements INodeType {
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		return executeTemplate.call(this, execute, { errorContext: { resource: 'backupservices', operationParam: 'backupServicesOperation' } });
	}
}
