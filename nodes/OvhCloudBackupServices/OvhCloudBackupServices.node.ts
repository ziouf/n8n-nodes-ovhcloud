		...
		return executeTemplate.call(this, execute, {
			perItemConcurrency: {
				classify: (ctx, itemIndex) =>
					classifyOperation(
						String(ctx.getNodeParameter('backupServicesOperation', itemIndex, { extractValue: true })),
					),
			},
			errorContext: { resource: 'backupservices', operationParam: 'backupServicesOperation' },
		});
	}
}
