...
import { description, execute } from './backupServicestenantvspcmanagementAgentListGet.operation';
...
describe('backupServicestenantvspcmanagementAgentListGet operation', () => {
