...
/**
 * Update service information for a Directadmin license.
 *
 * HTTP method: PUT
 * Endpoint: /license/directadmin/{serviceName}/serviceInfos
 */
...
export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[]> {
	...
	await client.httpPut(`/license/directadmin/${serviceName}/serviceInfos`, { body });
