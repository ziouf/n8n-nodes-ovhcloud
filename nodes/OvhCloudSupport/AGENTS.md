...
- **API Spec**: https://eu.api.ovh.com/v1/support.json
- **Base Path**: /support
...
├── list.operation.ts      # GET /support
├── get.operation.ts       # GET /support/{serviceName}
└── resources/
...
6. **serviceName**: `resourceLocator` with modes `str` and `list` (searchListMethod: `'getSupportServices'`)
