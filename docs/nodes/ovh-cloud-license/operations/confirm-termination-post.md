# OVH Cloud License — Confirm License Termination

> Opération `confirmTerminationPost` · Fichier source : `nodes/OvhCloudLicense/resources/confirmTerminationPost.operation.ts`

## Requête HTTP

| Méthode | Endpoint |
| --- | --- |
| POST | `/license/worklight/{param}` |
