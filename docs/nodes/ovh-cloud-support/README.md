...
Les pages détaillées de chaque opération sont générées automatiquement dans [`operations/`](operations/) par `scripts/generate-node-docs.js`.
...
- [Spécifications API (JSON)](../../api-specs/v2/_index.json)
