# OVH Cloud Domain — Update a Contact

> Opération `domainContactUpdatePut` · Fichier source : `nodes/OvhCloudDomain/resources/root/domainContactUpdatePut.operation.ts`

## Requête HTTP

| Méthode | Endpoint |
| --- | --- |
| PUT | `/domain/contact/{param}` |
