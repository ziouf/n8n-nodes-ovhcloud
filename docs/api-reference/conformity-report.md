...
> Généré par `scripts/audit-conformity.js` le 2026-08-05T22:34:12.381Z. Document généré automatiquement — ne pas éditer à la main.
...
- **Opérations auditées** : 5717
- **Conformes** : 3433
- **Non conformes** : 2284
- **Sans correspondance spec** (informatif) : 1992
