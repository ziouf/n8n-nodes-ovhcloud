...
> Généré par `scripts/audit-conformity.js` le 2026-08-07T19:36:37.171Z. Document généré automatiquement — ne pas éditer à la main.
...
| license (v1) | GET | `/license/cloudLinux` | OvhCloudLicense/resources/cloudLinux/GET.operation.ts |
| license (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| license (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| license (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| license (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| license (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| license (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| license (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| license (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| license (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| license (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| license (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| license (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| license (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| license (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| license (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| license (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| license (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| license (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| license (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| license (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| license (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| license (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| license (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| license (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| license (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| license (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| license (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| license (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| license (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| license (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| license (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| license (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| license (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| license (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| license (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| license (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| license (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| license (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| license (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| license (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| license (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| license (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| license (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| license (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| license (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| license (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| license (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| license (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| license (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| license (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| license (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| license (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| license (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| license (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| license (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| license (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| license (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| license (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| license (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| license (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| license (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| license (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| license (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| license (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| license (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| license (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| license (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| license (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| license (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| license (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| license (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| license (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| license (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| license (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| license (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| license (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| license (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| license (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| license (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| license (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| license (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| license (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| license (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| license (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| license (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| license (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| license (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| license (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| license (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| license (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| license (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| license (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| license (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| license (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| license (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| license (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| license (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| license (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| license (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| license (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| license (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| license (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| license (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| license (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseCloudLinux (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| licenseCloudLinux (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licenseCloudLinux (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseCloudLinux (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licenseCloudLinux (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licenseCloudLinux (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licenseCloudLinux (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licenseCloudLinux (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseCpanel (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licenseCpanel (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licenseCpanel (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licenseCpanel (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licenseCpanel (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licenseCpanel (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| licenseCpanel (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licenseCpanel (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licenseCpanel (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| licenseCpanel (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licenseCpanel (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseCpanel (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseCpanel (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseCpanel (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseCpanel (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licenseCpanel (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licenseCpanel (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licenseCpanel (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licenseCpanel (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licenseCpanel (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licenseCpanel (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licenseCpanel (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| licenseCpanel (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licenseCpanel (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licenseCpanel (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licenseCpanel (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licenseCpanel (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licenseCpanel (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licenseCpanel (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licenseCpanel (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseDirectadmin (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
...
| licenseDirectadmin (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licenseDirectadmin (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseDirectadmin (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licenseDirectadmin (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licenseDirectadmin (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licenseDirectadmin (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licenseDirectadmin (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseHycu (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licenseHycu (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licenseHycu (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licenseHycu (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licenseHycu (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licenseHycu (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licenseHycu (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licenseHycu (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licenseHycu (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licenseHycu (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licenseHycu (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseHycu (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licenseHycu (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licenseHycu (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licenseHycu (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licenseHycu (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licenseHycu (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| licenseHycu (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| licenseHycu (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licenseHycu (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licenseHycu (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licenseHycu (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseHycu (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licenseHycu (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licenseHycu (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licenseHycu (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licenseHycu (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licenseHycu (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licenseHycu (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
| licenseHycu (v1) | GET | `/license/directadmin/orderableVersions` | OvhCloudLicense/resources/directadmin/OrderableVersionsGET.operation.ts |
| licenseHycu (v1) | GET | `/license/office` | OvhCloudLicense/resources/office/GET.operation.ts |
| licenseHycu (v1) | GET | `/license/office/{x}` | OvhCloudLicense/resources/office/serviceGet.operation.ts |
| licenseHycu (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licenseHycu (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licenseHycu (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licenseHycu (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licenseHycu (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licenseHycu (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licenseHycu (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licenseHycu (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licenseHycu (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licenseHycu (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| licenseHycu (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| licenseHycu (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licenseHycu (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licenseHycu (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licenseHycu (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licenseHycu (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licenseHycu (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licenseHycu (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licenseHycu (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licenseHycu (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseHycu (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseHycu (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseHycu (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseHycu (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseHycu (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseHycu (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licenseHycu (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licenseHycu (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licenseHycu (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licenseHycu (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licenseHycu (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licenseHycu (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licenseHycu (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licenseHycu (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licenseHycu (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licenseHycu (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licenseHycu (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licenseHycu (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licenseHycu (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licenseHycu (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseHycu (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licenseHycu (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licenseHycu (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licenseHycu (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licenseHycu (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| licenseHycu (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licenseHycu (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licenseHycu (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licenseHycu (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licenseHycu (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licenseHycu (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licenseHycu (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licenseHycu (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licenseHycu (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licenseHycu (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licenseHycu (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licenseHycu (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseOffice (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licenseOffice (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licenseOffice (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licenseOffice (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licenseOffice (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licenseOffice (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licenseOffice (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licenseOffice (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licenseOffice (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licenseOffice (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licenseOffice (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseOffice (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licenseOffice (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licenseOffice (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licenseOffice (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licenseOffice (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licenseOffice (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| licenseOffice (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| licenseOffice (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licenseOffice (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licenseOffice (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licenseOffice (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseOffice (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licenseOffice (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licenseOffice (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licenseOffice (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licenseOffice (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licenseOffice (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licenseOffice (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| licenseOffice (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licenseOffice (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licenseOffice (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licenseOffice (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licenseOffice (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licenseOffice (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licenseOffice (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licenseOffice (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licenseOffice (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseOffice (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseOffice (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseOffice (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseOffice (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseOffice (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseOffice (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licenseOffice (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licenseOffice (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licenseOffice (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licenseOffice (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licenseOffice (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licenseOffice (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licenseOffice (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licenseOffice (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licenseOffice (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licenseOffice (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licenseOffice (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licenseOffice (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licenseOffice (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licenseOffice (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseOffice (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licenseOffice (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licenseOffice (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licenseOffice (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licenseOffice (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| licenseOffice (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licenseOffice (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licenseOffice (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licenseOffice (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licenseOffice (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licenseOffice (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licenseOffice (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licenseOffice (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licenseOffice (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licenseOffice (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licenseOffice (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licenseOffice (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseOfficePrepaid (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| licenseOfficePrepaid (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licenseOfficePrepaid (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseOfficePrepaid (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licenseOfficePrepaid (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licenseOfficePrepaid (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licenseOfficePrepaid (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licenseOfficePrepaid (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licensePlesk (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licensePlesk (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licensePlesk (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licensePlesk (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licensePlesk (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licensePlesk (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licensePlesk (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licensePlesk (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licensePlesk (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licensePlesk (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licensePlesk (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licensePlesk (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licensePlesk (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licensePlesk (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licensePlesk (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licensePlesk (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licensePlesk (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| licensePlesk (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| licensePlesk (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licensePlesk (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licensePlesk (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licensePlesk (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licensePlesk (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licensePlesk (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licensePlesk (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licensePlesk (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licensePlesk (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licensePlesk (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licensePlesk (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| licensePlesk (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licensePlesk (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licensePlesk (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licensePlesk (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licensePlesk (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licensePlesk (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licensePlesk (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licensePlesk (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licensePlesk (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licensePlesk (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| licensePlesk (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| licensePlesk (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licensePlesk (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licensePlesk (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licensePlesk (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licensePlesk (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licensePlesk (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licensePlesk (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licensePlesk (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licensePlesk (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licensePlesk (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licensePlesk (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licensePlesk (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licensePlesk (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licensePlesk (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licensePlesk (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licensePlesk (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licensePlesk (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licensePlesk (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licensePlesk (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licensePlesk (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licensePlesk (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licensePlesk (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licensePlesk (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licensePlesk (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licensePlesk (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licensePlesk (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licensePlesk (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licensePlesk (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licensePlesk (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| licensePlesk (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licensePlesk (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licensePlesk (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licensePlesk (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licensePlesk (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licensePlesk (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licensePlesk (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licensePlesk (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licensePlesk (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licensePlesk (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licensePlesk (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licensePlesk (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseRedhat (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licenseRedhat (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licenseRedhat (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licenseRedhat (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licenseRedhat (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| licenseRedhat (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| licenseRedhat (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licenseRedhat (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licenseRedhat (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licenseRedhat (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| licenseRedhat (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licenseRedhat (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licenseRedhat (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| licenseRedhat (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licenseRedhat (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseRedhat (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseRedhat (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseRedhat (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseRedhat (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licenseRedhat (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licenseRedhat (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licenseRedhat (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licenseRedhat (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licenseRedhat (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| licenseRedhat (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licenseRedhat (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licenseRedhat (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licenseRedhat (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licenseRedhat (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licenseRedhat (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licenseRedhat (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licenseRedhat (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseSqlserver (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licenseSqlserver (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licenseSqlserver (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licenseSqlserver (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| licenseSqlserver (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licenseSqlserver (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licenseSqlserver (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licenseSqlserver (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseSqlserver (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseSqlserver (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licenseSqlserver (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licenseSqlserver (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licenseSqlserver (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licenseSqlserver (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licenseSqlserver (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licenseSqlserver (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licenseSqlserver (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licenseSqlserver (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseVirtuozzo (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| licenseVirtuozzo (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licenseVirtuozzo (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseVirtuozzo (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/windows` | OvhCloudLicense/resources/windows/GET.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/windows/{x}` | OvhCloudLicense/resources/windows/serviceGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/windows/{x}/confirmTermination` | OvhCloudLicense/resources/windows/serviceConfirmTerminationPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/windows/{x}/option` | OvhCloudLicense/resources/windows/optionsListGet.operation.ts |
| licenseVirtuozzo (v1) | DELETE | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionDelete.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/windows/{x}/option/{x}` | OvhCloudLicense/resources/windows/optionGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/windows/{x}/serviceInfos` | OvhCloudLicense/resources/windows/serviceInfosGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/windows/{x}/sqlServer` | OvhCloudLicense/resources/windows/sqlServerPost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/windows/{x}/tasks` | OvhCloudLicense/resources/windows/serviceTasksGet.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/windows/{x}/tasks/{x}` | OvhCloudLicense/resources/windows/serviceTaskGet.operation.ts |
| licenseVirtuozzo (v1) | POST | `/license/windows/{x}/terminate` | OvhCloudLicense/resources/windows/serviceTerminatePost.operation.ts |
| licenseVirtuozzo (v1) | GET | `/license/windows/orderableVersions` | OvhCloudLicense/resources/windows/OrderableVersionsGET.operation.ts |
...
| licenseWindows (v1) | GET | `/license/cloudLinux/{x}` | OvhCloudLicense/resources/cloudLinux/serviceGet.operation.ts |
| licenseWindows (v1) | POST | `/license/cloudLinux/{x}/confirmTermination` | OvhCloudLicense/resources/cloudLinux/serviceConfirmTerminationPost.operation.ts |
| licenseWindows (v1) | GET | `/license/cloudLinux/{x}/serviceInfos` | OvhCloudLicense/resources/cloudLinux/serviceInfosGet.operation.ts |
| licenseWindows (v1) | GET | `/license/cloudLinux/{x}/tasks` | OvhCloudLicense/resources/cloudLinux/serviceTasksGet.operation.ts |
| licenseWindows (v1) | GET | `/license/cloudLinux/{x}/tasks/{x}` | OvhCloudLicense/resources/cloudLinux/serviceTaskGet.operation.ts |
| licenseWindows (v1) | POST | `/license/cloudLinux/{x}/terminate` | OvhCloudLicense/resources/cloudLinux/serviceTerminatePost.operation.ts |
| licenseWindows (v1) | GET | `/license/cloudLinux/orderableVersions` | OvhCloudLicense/resources/cloudLinux/OrderableVersionsGET.operation.ts |
| licenseWindows (v1) | GET | `/license/cpanel` | OvhCloudLicense/resources/cpanel/GET.operation.ts |
| licenseWindows (v1) | GET | `/license/cpanel/{x}` | OvhCloudLicense/resources/cpanel/serviceGet.operation.ts |
| licenseWindows (v1) | GET | `/license/cpanel/{x}/allowedDestinationIp` | OvhCloudLicense/resources/cpanel/serviceAllowedDestinationIpGet.operation.ts |
| licenseWindows (v1) | GET | `/license/cpanel/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/cpanel/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseWindows (v1) | POST | `/license/cpanel/{x}/changeIp` | OvhCloudLicense/resources/cpanel/serviceChangeIpPost.operation.ts |
| licenseWindows (v1) | POST | `/license/cpanel/{x}/confirmTermination` | OvhCloudLicense/resources/cpanel/serviceConfirmTerminationPost.operation.ts |
| licenseWindows (v1) | GET | `/license/cpanel/{x}/serviceInfos` | OvhCloudLicense/resources/cpanel/serviceInfosGet.operation.ts |
| licenseWindows (v1) | GET | `/license/cpanel/{x}/tasks` | OvhCloudLicense/resources/cpanel/serviceTasksGet.operation.ts |
| licenseWindows (v1) | GET | `/license/cpanel/{x}/tasks/{x}` | OvhCloudLicense/resources/cpanel/serviceTaskGet.operation.ts |
| licenseWindows (v1) | POST | `/license/cpanel/{x}/terminate` | OvhCloudLicense/resources/cpanel/serviceTerminatePost.operation.ts |
| licenseWindows (v1) | GET | `/license/cpanel/orderableVersions` | OvhCloudLicense/resources/cpanel/OrderableVersionsGET.operation.ts |
| licenseWindows (v1) | GET | `/license/directadmin` | OvhCloudLicense/resources/directadmin/GET.operation.ts |
| licenseWindows (v1) | GET | `/license/directadmin/{x}` | OvhCloudLicense/resources/directadmin/serviceGet.operation.ts |
| licenseWindows (v1) | GET | `/license/directadmin/{x}/allowedDestinationIp` | OvhCloudLicense/resources/directadmin/serviceAllowedDestinationIpGet.operation.ts |
| licenseWindows (v1) | GET | `/license/directadmin/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/directadmin/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseWindows (v1) | POST | `/license/directadmin/{x}/changeIp` | OvhCloudLicense/resources/directadmin/serviceChangeIpPost.operation.ts |
| licenseWindows (v1) | POST | `/license/directadmin/{x}/changeOs` | OvhCloudLicense/resources/directadmin/serviceChangeOsPost.operation.ts |
| licenseWindows (v1) | POST | `/license/directadmin/{x}/confirmTermination` | OvhCloudLicense/resources/directadmin/serviceConfirmTerminationPost.operation.ts |
| licenseWindows (v1) | GET | `/license/directadmin/{x}/serviceInfos` | OvhCloudLicense/resources/directadmin/serviceInfosGet.operation.ts |
| licenseWindows (v1) | GET | `/license/directadmin/{x}/tasks` | OvhCloudLicense/resources/directadmin/serviceTasksGet.operation.ts |
| licenseWindows (v1) | GET | `/license/directadmin/{x}/tasks/{x}` | OvhCloudLicense/resources/directadmin/serviceTaskGet.operation.ts |
| licenseWindows (v1) | POST | `/license/directadmin/{x}/terminate` | OvhCloudLicense/resources/directadmin/serviceTerminatePost.operation.ts |
...
| licenseWindows (v1) | GET | `/license/office/{x}/domain` | OvhCloudLicense/resources/office/domainsListGet.operation.ts |
| licenseWindows (v1) | GET | `/license/office/{x}/domain/{x}` | OvhCloudLicense/resources/office/domainGet.operation.ts |
| licenseWindows (v1) | GET | `/license/office/{x}/pendingTask` | OvhCloudLicense/resources/office/tasksListGet.operation.ts |
| licenseWindows (v1) | GET | `/license/office/{x}/pendingTask/{x}` | OvhCloudLicense/resources/office/taskGet.operation.ts |
| licenseWindows (v1) | GET | `/license/office/{x}/serviceInfos` | OvhCloudLicense/resources/office/serviceInfosGet.operation.ts |
| licenseWindows (v1) | GET | `/license/office/{x}/usageStatistics` | OvhCloudLicense/resources/office/usageStatisticsGet.operation.ts |
| licenseWindows (v1) | GET | `/license/office/{x}/user` | OvhCloudLicense/resources/office/usersListGet.operation.ts |
| licenseWindows (v1) | DELETE | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userDelete.operation.ts |
| licenseWindows (v1) | GET | `/license/office/{x}/user/{x}` | OvhCloudLicense/resources/office/userGet.operation.ts |
| licenseWindows (v1) | GET | `/license/officePrepaid` | OvhCloudLicense/resources/officePrepaid/GET.operation.ts |
| licenseWindows (v1) | GET | `/license/officePrepaid/{x}` | OvhCloudLicense/resources/officePrepaid/serviceGet.operation.ts |
| licenseWindows (v1) | POST | `/license/officePrepaid/{x}/confirmTermination` | OvhCloudLicense/resources/officePrepaid/serviceConfirmTerminationPost.operation.ts |
| licenseWindows (v1) | GET | `/license/officePrepaid/{x}/parentTenant` | OvhCloudLicense/resources/officePrepaid/parentTenantGet.operation.ts |
| licenseWindows (v1) | POST | `/license/officePrepaid/{x}/parentTenant/acceptAgreement` | OvhCloudLicense/resources/officePrepaid/parentTenantAcceptAgreementPost.operation.ts |
| licenseWindows (v1) | GET | `/license/officePrepaid/{x}/serviceInfos` | OvhCloudLicense/resources/officePrepaid/serviceInfosGet.operation.ts |
| licenseWindows (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask` | OvhCloudLicense/resources/officePrepaid/tenantTasksListGet.operation.ts |
| licenseWindows (v1) | GET | `/license/officePrepaid/{x}/tenantPendingTask/{x}` | OvhCloudLicense/resources/officePrepaid/tenantTaskGet.operation.ts |
| licenseWindows (v1) | GET | `/license/officePrepaid/{x}/tenantUsageStatistics` | OvhCloudLicense/resources/officePrepaid/tenantUsageStatisticsGet.operation.ts |
| licenseWindows (v1) | POST | `/license/officePrepaid/{x}/terminate` | OvhCloudLicense/resources/officePrepaid/serviceTerminatePost.operation.ts |
| licenseWindows (v1) | POST | `/license/officePrepaid/{x}/unconfigure` | OvhCloudLicense/resources/officePrepaid/serviceUnconfigurePost.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk` | OvhCloudLicense/resources/plesk/GET.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk/{x}` | OvhCloudLicense/resources/plesk/serviceGet.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk/{x}/allowedDestinationIp` | OvhCloudLicense/resources/plesk/serviceAllowedDestinationIpGet.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/plesk/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseWindows (v1) | POST | `/license/plesk/{x}/changeIp` | OvhCloudLicense/resources/plesk/serviceChangeIpPost.operation.ts |
| licenseWindows (v1) | POST | `/license/plesk/{x}/confirmTermination` | OvhCloudLicense/resources/plesk/serviceConfirmTerminationPost.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk/{x}/option` | OvhCloudLicense/resources/plesk/optionsListGet.operation.ts |
| licenseWindows (v1) | DELETE | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionDelete.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk/{x}/option/{x}` | OvhCloudLicense/resources/plesk/optionGet.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk/{x}/serviceInfos` | OvhCloudLicense/resources/plesk/serviceInfosGet.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk/{x}/tasks` | OvhCloudLicense/resources/plesk/serviceTasksGet.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk/{x}/tasks/{x}` | OvhCloudLicense/resources/plesk/serviceTaskGet.operation.ts |
| licenseWindows (v1) | POST | `/license/plesk/{x}/terminate` | OvhCloudLicense/resources/plesk/serviceTerminatePost.operation.ts |
| licenseWindows (v1) | GET | `/license/plesk/orderableVersions` | OvhCloudLicense/resources/plesk/OrderableVersionsGET.operation.ts |
| licenseWindows (v1) | GET | `/license/redhat` | OvhCloudLicense/resources/redhat/GET.operation.ts |
| licenseWindows (v1) | GET | `/license/redhat/{x}` | OvhCloudLicense/resources/redhat/serviceGet.operation.ts |
| licenseWindows (v1) | POST | `/license/redhat/{x}/confirmTermination` | OvhCloudLicense/resources/redhat/serviceConfirmTerminationPost.operation.ts |
| licenseWindows (v1) | GET | `/license/redhat/{x}/serviceInfos` | OvhCloudLicense/resources/redhat/serviceInfosGet.operation.ts |
| licenseWindows (v1) | GET | `/license/redhat/{x}/tasks` | OvhCloudLicense/resources/redhat/serviceTasksGet.operation.ts |
| licenseWindows (v1) | GET | `/license/redhat/{x}/tasks/{x}` | OvhCloudLicense/resources/redhat/serviceTaskGet.operation.ts |
| licenseWindows (v1) | POST | `/license/redhat/{x}/terminate` | OvhCloudLicense/resources/redhat/serviceTerminatePost.operation.ts |
| licenseWindows (v1) | GET | `/license/sqlserver` | OvhCloudLicense/resources/sqlserver/GET.operation.ts |
| licenseWindows (v1) | GET | `/license/sqlserver/{x}` | OvhCloudLicense/resources/sqlserver/serviceGet.operation.ts |
| licenseWindows (v1) | POST | `/license/sqlserver/{x}/confirmTermination` | OvhCloudLicense/resources/sqlserver/serviceConfirmTerminationPost.operation.ts |
| licenseWindows (v1) | GET | `/license/sqlserver/{x}/serviceInfos` | OvhCloudLicense/resources/sqlserver/serviceInfosGet.operation.ts |
| licenseWindows (v1) | GET | `/license/sqlserver/{x}/tasks` | OvhCloudLicense/resources/sqlserver/serviceTasksGet.operation.ts |
| licenseWindows (v1) | GET | `/license/sqlserver/{x}/tasks/{x}` | OvhCloudLicense/resources/sqlserver/serviceTaskGet.operation.ts |
| licenseWindows (v1) | POST | `/license/sqlserver/{x}/terminate` | OvhCloudLicense/resources/sqlserver/serviceTerminatePost.operation.ts |
| licenseWindows (v1) | GET | `/license/sqlserver/orderableVersions` | OvhCloudLicense/resources/sqlserver/OrderableVersionsGET.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo` | OvhCloudLicense/resources/virtuozzo/GET.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo/{x}` | OvhCloudLicense/resources/virtuozzo/serviceGet.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo/{x}/allowedDestinationIp` | OvhCloudLicense/resources/virtuozzo/serviceAllowedDestinationIpGet.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo/{x}/canLicenseBeMovedTo` | OvhCloudLicense/resources/virtuozzo/serviceCanLicenseBeMovedToGet.operation.ts |
| licenseWindows (v1) | POST | `/license/virtuozzo/{x}/changeIp` | OvhCloudLicense/resources/virtuozzo/serviceChangeIpPost.operation.ts |
| licenseWindows (v1) | POST | `/license/virtuozzo/{x}/confirmTermination` | OvhCloudLicense/resources/virtuozzo/serviceConfirmTerminationPost.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo/{x}/option` | OvhCloudLicense/resources/virtuozzo/optionsListGet.operation.ts |
| licenseWindows (v1) | DELETE | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionDelete.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo/{x}/option/{x}` | OvhCloudLicense/resources/virtuozzo/optionGet.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo/{x}/serviceInfos` | OvhCloudLicense/resources/virtuozzo/serviceInfosGet.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo/{x}/tasks` | OvhCloudLicense/resources/virtuozzo/serviceTasksGet.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo/{x}/tasks/{x}` | OvhCloudLicense/resources/virtuozzo/serviceTaskGet.operation.ts |
| licenseWindows (v1) | POST | `/license/virtuozzo/{x}/terminate` | OvhCloudLicense/resources/virtuozzo/serviceTerminatePost.operation.ts |
| licenseWindows (v1) | GET | `/license/virtuozzo/orderableVersions` | OvhCloudLicense/resources/virtuozzo/OrderableVersionsGET.operation.ts |
