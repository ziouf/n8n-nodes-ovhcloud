...
> Généré par `scripts/compare-coverage.js` le 2026-08-05T13:07:00.876Z. Document généré automatiquement — ne pas éditer à la main.
...
- **Endpoints couverts par les nodes** : 3292
- **Couverture globale** : **49.7%**
