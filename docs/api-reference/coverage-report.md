...
> Généré par `scripts/compare-coverage.js` le 2026-08-04T14:06:50.245Z. Document généré automatiquement — ne pas éditer à la main.
...
- **Endpoints déclarés (specs avec endpoints)** : 5939
- **Endpoints couverts par les nodes** : 3199
- **Couverture globale** : **53.9%**
- **Specs sans node associé** : 1
- **Specs placeholder (aucun endpoint)** : 22
...
- **dedicatedCeph** (`/dedicated/ceph`, v1)
- **dedicatedCluster** (`/dedicated/cluster`, v1)
- **dedicatedHousing** (`/dedicated/housing`, v1)
- **dedicatedInstallationTemplate** (`/dedicated/installationTemplate`, v1)
- **dedicatedNasha** (`/dedicated/nasha`, v1)
- **emailDomain** (`/email/domain`, v1)
- **emailExchange** (`/email/exchange`, v1)
- **emailMxplan** (`/email/mxplan`, v1)
- **hostingPrivateDatabase** (`/hosting/privateDatabase`, v1)
- **licenseCloudLinux** (`/license/cloudLinux`, v1)
- **licenseCpanel** (`/license/cpanel`, v1)
- **licenseDirectadmin** (`/license/directadmin`, v1)
- **licenseHycu** (`/license/hycu`, v1)
- **licenseOffice** (`/license/office`, v1)
- **licenseOfficePrepaid** (`/license/officePrepaid`, v1)
- **licensePlesk** (`/license/plesk`, v1)
- **licenseRedhat** (`/license/redhat`, v1)
- **licenseSqlserver** (`/license/sqlserver`, v1)
- **licenseVirtuozzo** (`/license/virtuozzo`, v1)
- **licenseWindows** (`/license/windows`, v1)
- **packSiptrunk** (`/pack/siptrunk`, v1)
