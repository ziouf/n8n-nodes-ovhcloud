...
const SPEC_TO_NODES = {
	...
	dedicatedCeph: ['OvhCloudDedicatedCeph'],
	dedicatedNasha: ['OvhCloudDedicatedNasha'],
	dedicatedHousing: ['OvhCloudDedicatedHousing'],
	dedicatedCluster: ['OvhCloudDedicatedCluster'],
	dedicatedInstallationTemplate: ['OvhCloudDedicatedInstallationTemplate'],
	dedicatedCloud: ['OvhCloudDedicatedCloud'],
	domain: ['OvhCloudDomain'],
	email: ['OvhCloudEmailPro', 'OvhCloudMxPlan'],
	emailDomain: ['OvhCloudEmailDomain'],
	emailExchange: ['OvhCloudExchange'],
	emailMxplan: ['OvhCloudMxPlan'],
	...
	licenseCloudLinux: ['OvhCloudLicense'],
	licenseCpanel: ['OvhCloudLicense'],
	licenseDirectadmin: ['OvhCloudLicense'],
	licenseHycu: ['OvhCloudLicense'],
	licenseOffice: ['OvhCloudLicense'],
	licenseOfficePrepaid: ['OvhCloudLicense'],
	licensePlesk: ['OvhCloudLicense'],
	licenseRedhat: ['OvhCloudLicense'],
	licenseSqlserver: ['OvhCloudLicense'],
	licenseVirtuozzo: ['OvhCloudLicense'],
	licenseWindows: ['OvhCloudLicense'],
	me: ['OvhCloudMe'],
